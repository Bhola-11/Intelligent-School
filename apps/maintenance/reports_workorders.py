"""
Operational Reporting Engine for EduFlow Technician Allocations & Maintenance Costs (WorkOrders).
...
try:
    from .models import WorkOrdersMaster, WorkOrdersItem, WorkOrdersAllocation
except ImportError:
    pass

class WorkOrdersReportGenerator:
    """Generates analytical reports and summary matrices for WorkOrders."""
