"""Django Admin configuration for EduFlow Technician Allocations & Maintenance Costs (WorkOrders)."""
...
if 'WorkOrdersMaster' in globals():
    @admin.register(WorkOrdersMaster)
    class WorkOrdersMasterAdmin(admin.ModelAdmin):
...
if 'WorkOrdersItem' in globals():
    @admin.register(WorkOrdersItem)
    class WorkOrdersItemAdmin(admin.ModelAdmin):
...
if 'WorkOrdersAllocation' in globals():
    @admin.register(WorkOrdersAllocation)
    class WorkOrdersAllocationAdmin(admin.ModelAdmin):
...
if 'WorkOrdersMetricRecord' in globals():
    @admin.register(WorkOrdersMetricRecord)
    class WorkOrdersMetricRecordAdmin(admin.ModelAdmin):
...
if 'WorkOrdersPolicyRule' in globals():
    @admin.register(WorkOrdersPolicyRule)
    class WorkOrdersPolicyRuleAdmin(admin.ModelAdmin):
...
if 'WorkOrdersSchedulePeriod' in globals():
    @admin.register(WorkOrdersSchedulePeriod)
    class WorkOrdersSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'WorkOrdersFeedbackReview' in globals():
    @admin.register(WorkOrdersFeedbackReview)
    class WorkOrdersFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'WorkOrdersWorkflowTransition' in globals():
    @admin.register(WorkOrdersWorkflowTransition)
    class WorkOrdersWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'WorkOrdersAccessRule' in globals():
    @admin.register(WorkOrdersAccessRule)
    class WorkOrdersAccessRuleAdmin(admin.ModelAdmin):
...
if 'WorkOrdersConfigurationParameter' in globals():
    @admin.register(WorkOrdersConfigurationParameter)
    class WorkOrdersConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'WorkOrdersDocumentAttachment' in globals():
    @admin.register(WorkOrdersDocumentAttachment)
    class WorkOrdersDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'WorkOrdersAuditTrail' in globals():
    @admin.register(WorkOrdersAuditTrail)
    class WorkOrdersAuditTrailAdmin(admin.ModelAdmin):
