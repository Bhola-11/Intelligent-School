"""
Serializers for EduFlow Technician Allocations & Maintenance Costs (WorkOrders).
...
class WorkOrdersMasterSerializer:
    """Serializes WorkOrdersMaster instances to and from JSON/dict structures."""
...
class WorkOrdersItemSerializer:
    @classmethod
...
class WorkOrdersAllocationSerializer:
    @classmethod
...
class WorkOrdersMetricSerializer:
    @classmethod
...
class WorkOrdersPolicyRuleSerializer:
    @classmethod
...
class WorkOrdersSchedulePeriodSerializer:
    @classmethod
...
class WorkOrdersFeedbackReviewSerializer:
    @classmethod
...
class WorkOrdersWorkflowTransitionSerializer:
    @classmethod
...
class WorkOrdersAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class WorkOrdersConfigurationParameterSerializer:
    @classmethod
...
class WorkOrdersDocumentAttachmentSerializer:
    @classmethod
...
class WorkOrdersAuditTrailSerializer:
    @classmethod
