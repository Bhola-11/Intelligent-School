"""
Serializers for EduFlow Maintenance Tickets & Work Orders (MaintenanceTickets).
...
class MaintenanceTicketsMasterSerializer:
    """Serializes MaintenanceTicketsMaster instances to and from JSON/dict structures."""
...
class MaintenanceTicketsItemSerializer:
    @classmethod
...
class MaintenanceTicketsAllocationSerializer:
    @classmethod
...
class MaintenanceTicketsMetricSerializer:
    @classmethod
...
class MaintenanceTicketsPolicyRuleSerializer:
    @classmethod
...
class MaintenanceTicketsSchedulePeriodSerializer:
    @classmethod
...
class MaintenanceTicketsFeedbackReviewSerializer:
    @classmethod
...
class MaintenanceTicketsWorkflowTransitionSerializer:
    @classmethod
...
class MaintenanceTicketsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class MaintenanceTicketsConfigurationParameterSerializer:
    @classmethod
...
class MaintenanceTicketsDocumentAttachmentSerializer:
    @classmethod
...
class MaintenanceTicketsAuditTrailSerializer:
    @classmethod
