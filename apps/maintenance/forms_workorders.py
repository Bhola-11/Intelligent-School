"""
Forms for EduFlow Technician Allocations & Maintenance Costs (WorkOrders).
...
class WorkOrdersMasterForm(forms.ModelForm):
    """Primary form for creating and updating WorkOrders master records."""
    class Meta:
        try:
            model = WorkOrdersMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. WORK-001'}),
...
class WorkOrdersItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = WorkOrdersItem
...
class WorkOrdersAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = WorkOrdersAllocation
...
class WorkOrdersMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = WorkOrdersMetricRecord
...
class WorkOrdersPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = WorkOrdersPolicyRule
...
class WorkOrdersSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = WorkOrdersSchedulePeriod
...
class WorkOrdersFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = WorkOrdersFeedbackReview
...
class WorkOrdersWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = WorkOrdersWorkflowTransition
...
class WorkOrdersAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = WorkOrdersAccessRule
...
class WorkOrdersConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = WorkOrdersConfigurationParameter
...
class WorkOrdersDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = WorkOrdersDocumentAttachment
...
class WorkOrdersFilterForm(forms.Form):
...
class WorkOrdersBulkActionForm(forms.Form):
