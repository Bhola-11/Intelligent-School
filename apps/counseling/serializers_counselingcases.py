"""
Serializers for EduFlow Counseling Cases & Student Support Plans (CounselingCases).
...
class CounselingCasesMasterSerializer:
    """Serializes CounselingCasesMaster instances to and from JSON/dict structures."""
...
class CounselingCasesItemSerializer:
    @classmethod
...
class CounselingCasesAllocationSerializer:
    @classmethod
...
class CounselingCasesMetricSerializer:
    @classmethod
...
class CounselingCasesPolicyRuleSerializer:
    @classmethod
...
class CounselingCasesSchedulePeriodSerializer:
    @classmethod
...
class CounselingCasesFeedbackReviewSerializer:
    @classmethod
...
class CounselingCasesWorkflowTransitionSerializer:
    @classmethod
...
class CounselingCasesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CounselingCasesConfigurationParameterSerializer:
    @classmethod
...
class CounselingCasesDocumentAttachmentSerializer:
    @classmethod
...
class CounselingCasesAuditTrailSerializer:
    @classmethod
