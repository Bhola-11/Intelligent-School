"""
Forms for EduFlow Counseling Cases & Student Support Plans (CounselingCases).
...
class CounselingCasesMasterForm(forms.ModelForm):
    """Primary form for creating and updating CounselingCases master records."""
    class Meta:
        try:
            model = CounselingCasesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. COUN-001'}),
...
class CounselingCasesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = CounselingCasesItem
...
class CounselingCasesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = CounselingCasesAllocation
...
class CounselingCasesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = CounselingCasesMetricRecord
...
class CounselingCasesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = CounselingCasesPolicyRule
...
class CounselingCasesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = CounselingCasesSchedulePeriod
...
class CounselingCasesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = CounselingCasesFeedbackReview
...
class CounselingCasesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = CounselingCasesWorkflowTransition
...
class CounselingCasesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = CounselingCasesAccessRule
...
class CounselingCasesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = CounselingCasesConfigurationParameter
...
class CounselingCasesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = CounselingCasesDocumentAttachment
...
class CounselingCasesFilterForm(forms.Form):
...
class CounselingCasesBulkActionForm(forms.Form):
