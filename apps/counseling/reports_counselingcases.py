"""
Operational Reporting Engine for EduFlow Counseling Cases & Student Support Plans (CounselingCases).
...
try:
    from .models import CounselingCasesMaster, CounselingCasesItem, CounselingCasesAllocation
except ImportError:
    pass

class CounselingCasesReportGenerator:
    """Generates analytical reports and summary matrices for CounselingCases."""
