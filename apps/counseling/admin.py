"""Django Admin configuration for EduFlow Counseling Cases & Student Support Plans (CounselingCases)."""
...
if 'CounselingCasesMaster' in globals():
    @admin.register(CounselingCasesMaster)
    class CounselingCasesMasterAdmin(admin.ModelAdmin):
...
if 'CounselingCasesItem' in globals():
    @admin.register(CounselingCasesItem)
    class CounselingCasesItemAdmin(admin.ModelAdmin):
...
if 'CounselingCasesAllocation' in globals():
    @admin.register(CounselingCasesAllocation)
    class CounselingCasesAllocationAdmin(admin.ModelAdmin):
...
if 'CounselingCasesMetricRecord' in globals():
    @admin.register(CounselingCasesMetricRecord)
    class CounselingCasesMetricRecordAdmin(admin.ModelAdmin):
...
if 'CounselingCasesPolicyRule' in globals():
    @admin.register(CounselingCasesPolicyRule)
    class CounselingCasesPolicyRuleAdmin(admin.ModelAdmin):
...
if 'CounselingCasesSchedulePeriod' in globals():
    @admin.register(CounselingCasesSchedulePeriod)
    class CounselingCasesSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'CounselingCasesFeedbackReview' in globals():
    @admin.register(CounselingCasesFeedbackReview)
    class CounselingCasesFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'CounselingCasesWorkflowTransition' in globals():
    @admin.register(CounselingCasesWorkflowTransition)
    class CounselingCasesWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'CounselingCasesAccessRule' in globals():
    @admin.register(CounselingCasesAccessRule)
    class CounselingCasesAccessRuleAdmin(admin.ModelAdmin):
...
if 'CounselingCasesConfigurationParameter' in globals():
    @admin.register(CounselingCasesConfigurationParameter)
    class CounselingCasesConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'CounselingCasesDocumentAttachment' in globals():
    @admin.register(CounselingCasesDocumentAttachment)
    class CounselingCasesDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'CounselingCasesAuditTrail' in globals():
    @admin.register(CounselingCasesAuditTrail)
    class CounselingCasesAuditTrailAdmin(admin.ModelAdmin):
