"""
Domain Validators for EduFlow Reception & Front Office Desk (ReceptionDesk).
...
class ReceptionDeskValidator:
    """Domain validator implementing enterprise business rules for ReceptionDesk."""
