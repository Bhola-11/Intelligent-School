"""
Operational Reporting Engine for EduFlow Parent & Guardian Multi-Child Portal (ParentPortal).
...
try:
    from .models import ParentPortalMaster, ParentPortalItem, ParentPortalAllocation
except ImportError:
    pass

class ParentPortalReportGenerator:
    """Generates analytical reports and summary matrices for ParentPortal."""
