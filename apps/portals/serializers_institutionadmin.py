"""
Serializers for EduFlow Institution Administrator Portal (InstitutionAdmin).
...
class InstitutionAdminMasterSerializer:
    """Serializes InstitutionAdminMaster instances to and from JSON/dict structures."""
...
class InstitutionAdminItemSerializer:
    @classmethod
...
class InstitutionAdminAllocationSerializer:
    @classmethod
...
class InstitutionAdminMetricSerializer:
    @classmethod
...
class InstitutionAdminPolicyRuleSerializer:
    @classmethod
...
class InstitutionAdminSchedulePeriodSerializer:
    @classmethod
...
class InstitutionAdminFeedbackReviewSerializer:
    @classmethod
...
class InstitutionAdminWorkflowTransitionSerializer:
    @classmethod
...
class InstitutionAdminAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class InstitutionAdminConfigurationParameterSerializer:
    @classmethod
...
class InstitutionAdminDocumentAttachmentSerializer:
    @classmethod
...
class InstitutionAdminAuditTrailSerializer:
    @classmethod
