"""
Serializers for EduFlow Parent & Guardian Multi-Child Portal (ParentPortal).
...
class ParentPortalMasterSerializer:
    """Serializes ParentPortalMaster instances to and from JSON/dict structures."""
...
class ParentPortalItemSerializer:
    @classmethod
...
class ParentPortalAllocationSerializer:
    @classmethod
...
class ParentPortalMetricSerializer:
    @classmethod
...
class ParentPortalPolicyRuleSerializer:
    @classmethod
...
class ParentPortalSchedulePeriodSerializer:
    @classmethod
...
class ParentPortalFeedbackReviewSerializer:
    @classmethod
...
class ParentPortalWorkflowTransitionSerializer:
    @classmethod
...
class ParentPortalAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ParentPortalConfigurationParameterSerializer:
    @classmethod
...
class ParentPortalDocumentAttachmentSerializer:
    @classmethod
...
class ParentPortalAuditTrailSerializer:
    @classmethod
