"""
Serializers for EduFlow Department Head (HOD) Overview (HODDesk).
...
class HODDeskMasterSerializer:
    """Serializes HODDeskMaster instances to and from JSON/dict structures."""
...
class HODDeskAllocationSerializer:
    @classmethod
...
class HODDeskPolicyRuleSerializer:
    @classmethod
...
class HODDeskSchedulePeriodSerializer:
    @classmethod
...
class HODDeskFeedbackReviewSerializer:
    @classmethod
...
class HODDeskWorkflowTransitionSerializer:
    @classmethod
...
class HODDeskAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class HODDeskConfigurationParameterSerializer:
    @classmethod
...
class HODDeskDocumentAttachmentSerializer:
    @classmethod
...
class HODDeskAuditTrailSerializer:
    @classmethod
