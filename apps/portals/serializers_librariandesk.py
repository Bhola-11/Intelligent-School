"""
Serializers for EduFlow Librarian Operations Center (LibrarianDesk).
...
class LibrarianDeskMasterSerializer:
    """Serializes LibrarianDeskMaster instances to and from JSON/dict structures."""
...
class LibrarianDeskItemSerializer:
    @classmethod
...
class LibrarianDeskAllocationSerializer:
    @classmethod
...
class LibrarianDeskMetricSerializer:
    @classmethod
...
class LibrarianDeskPolicyRuleSerializer:
    @classmethod
...
class LibrarianDeskSchedulePeriodSerializer:
    @classmethod
...
class LibrarianDeskFeedbackReviewSerializer:
    @classmethod
...
class LibrarianDeskWorkflowTransitionSerializer:
    @classmethod
...
class LibrarianDeskAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class LibrarianDeskConfigurationParameterSerializer:
    @classmethod
...
class LibrarianDeskDocumentAttachmentSerializer:
    @classmethod
...
class LibrarianDeskAuditTrailSerializer:
    @classmethod
