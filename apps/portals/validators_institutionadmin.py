"""
Domain Validators for EduFlow Institution Administrator Portal (InstitutionAdmin).
...
class InstitutionAdminValidator:
    """Domain validator implementing enterprise business rules for InstitutionAdmin."""
