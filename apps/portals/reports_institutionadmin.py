"""
Operational Reporting Engine for EduFlow Institution Administrator Portal (InstitutionAdmin).
...
try:
    from .models import InstitutionAdminMaster, InstitutionAdminItem, InstitutionAdminAllocation
except ImportError:
    pass

class InstitutionAdminReportGenerator:
    """Generates analytical reports and summary matrices for InstitutionAdmin."""
