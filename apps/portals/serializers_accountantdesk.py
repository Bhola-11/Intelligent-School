"""
Serializers for EduFlow Accountant Financial Operations Desk (AccountantDesk).
...
class AccountantDeskMasterSerializer:
    """Serializes AccountantDeskMaster instances to and from JSON/dict structures."""
...
class AccountantDeskItemSerializer:
    @classmethod
...
class AccountantDeskAllocationSerializer:
    @classmethod
...
class AccountantDeskMetricSerializer:
    @classmethod
...
class AccountantDeskPolicyRuleSerializer:
    @classmethod
...
class AccountantDeskSchedulePeriodSerializer:
    @classmethod
...
class AccountantDeskFeedbackReviewSerializer:
    @classmethod
...
class AccountantDeskWorkflowTransitionSerializer:
    @classmethod
...
class AccountantDeskAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AccountantDeskConfigurationParameterSerializer:
    @classmethod
...
class AccountantDeskDocumentAttachmentSerializer:
    @classmethod
...
class AccountantDeskAuditTrailSerializer:
    @classmethod
