"""Django Admin configuration for EduFlow Super Administrator Executive Portal (SuperAdmin)."""
...
if 'SuperAdminMaster' in globals():
    @admin.register(SuperAdminMaster)
    class SuperAdminMasterAdmin(admin.ModelAdmin):
...
if 'SuperAdminItem' in globals():
    @admin.register(SuperAdminItem)
    class SuperAdminItemAdmin(admin.ModelAdmin):
...
if 'SuperAdminAllocation' in globals():
    @admin.register(SuperAdminAllocation)
    class SuperAdminAllocationAdmin(admin.ModelAdmin):
...
if 'SuperAdminMetricRecord' in globals():
    @admin.register(SuperAdminMetricRecord)
    class SuperAdminMetricRecordAdmin(admin.ModelAdmin):
...
if 'SuperAdminPolicyRule' in globals():
    @admin.register(SuperAdminPolicyRule)
    class SuperAdminPolicyRuleAdmin(admin.ModelAdmin):
...
if 'SuperAdminSchedulePeriod' in globals():
    @admin.register(SuperAdminSchedulePeriod)
    class SuperAdminSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'SuperAdminFeedbackReview' in globals():
    @admin.register(SuperAdminFeedbackReview)
    class SuperAdminFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'SuperAdminWorkflowTransition' in globals():
    @admin.register(SuperAdminWorkflowTransition)
    class SuperAdminWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'SuperAdminAccessRule' in globals():
    @admin.register(SuperAdminAccessRule)
    class SuperAdminAccessRuleAdmin(admin.ModelAdmin):
...
if 'SuperAdminConfigurationParameter' in globals():
    @admin.register(SuperAdminConfigurationParameter)
    class SuperAdminConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'SuperAdminDocumentAttachment' in globals():
    @admin.register(SuperAdminDocumentAttachment)
    class SuperAdminDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'SuperAdminAuditTrail' in globals():
    @admin.register(SuperAdminAuditTrail)
    class SuperAdminAuditTrailAdmin(admin.ModelAdmin):
