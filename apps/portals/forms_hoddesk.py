"""
Forms for EduFlow Department Head (HOD) Overview (HODDesk).
...
class HODDeskMasterForm(forms.ModelForm):
    """Primary form for creating and updating HODDesk master records."""
    class Meta:
        try:
            model = HODDeskMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. HODD-001'}),
...
class HODDeskItemForm(forms.ModelForm):
...
class HODDeskAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = HODDeskAllocation
...
class HODDeskMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = HODDeskMetricRecord
...
class HODDeskPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = HODDeskPolicyRule
...
class HODDeskSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = HODDeskSchedulePeriod
...
class HODDeskFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = HODDeskFeedbackReview
...
class HODDeskWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = HODDeskWorkflowTransition
...
class HODDeskAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = HODDeskAccessRule
...
class HODDeskConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = HODDeskConfigurationParameter
...
class HODDeskDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = HODDeskDocumentAttachment
...
class HODDeskFilterForm(forms.Form):
...
class HODDeskBulkActionForm(forms.Form):
