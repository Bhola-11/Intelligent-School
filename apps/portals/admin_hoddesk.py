"""Django Admin configuration for EduFlow Department Head (HOD) Overview (HODDesk)."""
...
if 'HODDeskMaster' in globals():
    @admin.register(HODDeskMaster)
    class HODDeskMasterAdmin(admin.ModelAdmin):
...
if 'HODDeskItem' in globals():
    @admin.register(HODDeskItem)
    class HODDeskItemAdmin(admin.ModelAdmin):
...
if 'HODDeskAllocation' in globals():
    @admin.register(HODDeskAllocation)
    class HODDeskAllocationAdmin(admin.ModelAdmin):
...
if 'HODDeskMetricRecord' in globals():
    @admin.register(HODDeskMetricRecord)
    class HODDeskMetricRecordAdmin(admin.ModelAdmin):
        list_display = ['master', 'metric_name', 'target_value', 'actual_value', 'score_percentage', 'is_passing']
        list_filter = ['is_passing']

if 'HODDeskPolicyRule' in globals():
    @admin.register(HODDeskPolicyRule)
    class HODDeskPolicyRuleAdmin(admin.ModelAdmin):
...
if 'HODDeskSchedulePeriod' in globals():
    @admin.register(HODDeskSchedulePeriod)
    class HODDeskSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'HODDeskFeedbackReview' in globals():
    @admin.register(HODDeskFeedbackReview)
    class HODDeskFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'HODDeskWorkflowTransition' in globals():
    @admin.register(HODDeskWorkflowTransition)
    class HODDeskWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'HODDeskAccessRule' in globals():
    @admin.register(HODDeskAccessRule)
    class HODDeskAccessRuleAdmin(admin.ModelAdmin):
...
if 'HODDeskConfigurationParameter' in globals():
    @admin.register(HODDeskConfigurationParameter)
    class HODDeskConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'HODDeskDocumentAttachment' in globals():
    @admin.register(HODDeskDocumentAttachment)
    class HODDeskDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'HODDeskAuditTrail' in globals():
    @admin.register(HODDeskAuditTrail)
    class HODDeskAuditTrailAdmin(admin.ModelAdmin):
