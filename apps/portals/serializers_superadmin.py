"""
Serializers for EduFlow Super Administrator Executive Portal (SuperAdmin).
...
class SuperAdminMasterSerializer:
    """Serializes SuperAdminMaster instances to and from JSON/dict structures."""
...
class SuperAdminItemSerializer:
    @classmethod
...
class SuperAdminAllocationSerializer:
    @classmethod
...
class SuperAdminMetricSerializer:
    @classmethod
...
class SuperAdminPolicyRuleSerializer:
    @classmethod
...
class SuperAdminSchedulePeriodSerializer:
    @classmethod
...
class SuperAdminFeedbackReviewSerializer:
    @classmethod
...
class SuperAdminWorkflowTransitionSerializer:
    @classmethod
...
class SuperAdminAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class SuperAdminConfigurationParameterSerializer:
    @classmethod
...
class SuperAdminDocumentAttachmentSerializer:
    @classmethod
...
class SuperAdminAuditTrailSerializer:
    @classmethod
