"""
Forms for EduFlow Librarian Operations Center (LibrarianDesk).
...
class LibrarianDeskMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibrarianDesk master records."""
    class Meta:
        try:
            model = LibrarianDeskMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. LIBR-001'}),
...
class LibrarianDeskItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = LibrarianDeskItem
...
class LibrarianDeskAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = LibrarianDeskAllocation
...
class LibrarianDeskMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = LibrarianDeskMetricRecord
...
class LibrarianDeskPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = LibrarianDeskPolicyRule
...
class LibrarianDeskSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = LibrarianDeskSchedulePeriod
...
class LibrarianDeskFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = LibrarianDeskFeedbackReview
...
class LibrarianDeskWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = LibrarianDeskWorkflowTransition
...
class LibrarianDeskAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = LibrarianDeskAccessRule
...
class LibrarianDeskConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = LibrarianDeskConfigurationParameter
...
class LibrarianDeskDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = LibrarianDeskDocumentAttachment
...
class LibrarianDeskFilterForm(forms.Form):
...
class LibrarianDeskBulkActionForm(forms.Form):
