"""
Serializers for EduFlow Reception & Front Office Desk (ReceptionDesk).
...
class ReceptionDeskMasterSerializer:
    """Serializes ReceptionDeskMaster instances to and from JSON/dict structures."""
...
class ReceptionDeskItemSerializer:
    @classmethod
...
class ReceptionDeskAllocationSerializer:
    @classmethod
...
class ReceptionDeskMetricSerializer:
    @classmethod
...
class ReceptionDeskPolicyRuleSerializer:
    @classmethod
...
class ReceptionDeskSchedulePeriodSerializer:
    @classmethod
...
class ReceptionDeskFeedbackReviewSerializer:
    @classmethod
...
class ReceptionDeskWorkflowTransitionSerializer:
    @classmethod
...
class ReceptionDeskAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ReceptionDeskConfigurationParameterSerializer:
    @classmethod
...
class ReceptionDeskDocumentAttachmentSerializer:
    @classmethod
...
class ReceptionDeskAuditTrailSerializer:
    @classmethod
