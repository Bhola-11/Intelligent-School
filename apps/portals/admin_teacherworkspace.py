"""Django Admin configuration for EduFlow Teacher Workspace & Daily Register (TeacherWorkspace)."""
...
if 'TeacherWorkspaceMaster' in globals():
    @admin.register(TeacherWorkspaceMaster)
    class TeacherWorkspaceMasterAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceItem' in globals():
    @admin.register(TeacherWorkspaceItem)
    class TeacherWorkspaceItemAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceAllocation' in globals():
    @admin.register(TeacherWorkspaceAllocation)
    class TeacherWorkspaceAllocationAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceMetricRecord' in globals():
    @admin.register(TeacherWorkspaceMetricRecord)
    class TeacherWorkspaceMetricRecordAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspacePolicyRule' in globals():
    @admin.register(TeacherWorkspacePolicyRule)
    class TeacherWorkspacePolicyRuleAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceSchedulePeriod' in globals():
    @admin.register(TeacherWorkspaceSchedulePeriod)
    class TeacherWorkspaceSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceFeedbackReview' in globals():
    @admin.register(TeacherWorkspaceFeedbackReview)
    class TeacherWorkspaceFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceWorkflowTransition' in globals():
    @admin.register(TeacherWorkspaceWorkflowTransition)
    class TeacherWorkspaceWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceAccessRule' in globals():
    @admin.register(TeacherWorkspaceAccessRule)
    class TeacherWorkspaceAccessRuleAdmin(admin.ModelAdmin):
...
if 'TeacherWorkspaceConfigurationParameter' in globals():
    @admin.register(TeacherWorkspaceConfigurationParameter)
    class TeacherWorkspaceConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'TeacherWorkspaceDocumentAttachment' in globals():
    @admin.register(TeacherWorkspaceDocumentAttachment)
    class TeacherWorkspaceDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'TeacherWorkspaceAuditTrail' in globals():
    @admin.register(TeacherWorkspaceAuditTrail)
    class TeacherWorkspaceAuditTrailAdmin(admin.ModelAdmin):
