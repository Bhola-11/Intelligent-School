"""
Serializers for EduFlow Examination Coordinator Suite (ExamDesk).
...
class ExamDeskMasterSerializer:
    """Serializes ExamDeskMaster instances to and from JSON/dict structures."""
...
class ExamDeskAllocationSerializer:
    @classmethod
...
class ExamDeskMetricSerializer:
    @classmethod
...
class ExamDeskPolicyRuleSerializer:
    @classmethod
...
class ExamDeskSchedulePeriodSerializer:
    @classmethod
...
class ExamDeskFeedbackReviewSerializer:
    @classmethod
...
class ExamDeskWorkflowTransitionSerializer:
    @classmethod
...
class ExamDeskAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ExamDeskConfigurationParameterSerializer:
    @classmethod
...
class ExamDeskDocumentAttachmentSerializer:
    @classmethod
...
class ExamDeskAuditTrailSerializer:
    @classmethod
