"""
Forms for EduFlow Institution Administrator Portal (InstitutionAdmin).
...
class InstitutionAdminMasterForm(forms.ModelForm):
    """Primary form for creating and updating InstitutionAdmin master records."""
    class Meta:
        try:
            model = InstitutionAdminMaster
            fields = [
...
class InstitutionAdminItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = InstitutionAdminItem
...
class InstitutionAdminAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = InstitutionAdminAllocation
...
class InstitutionAdminMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = InstitutionAdminMetricRecord
...
class InstitutionAdminPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = InstitutionAdminPolicyRule
...
class InstitutionAdminSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = InstitutionAdminSchedulePeriod
...
class InstitutionAdminFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = InstitutionAdminFeedbackReview
...
class InstitutionAdminWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = InstitutionAdminWorkflowTransition
...
class InstitutionAdminAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = InstitutionAdminAccessRule
...
class InstitutionAdminConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = InstitutionAdminConfigurationParameter
...
class InstitutionAdminDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = InstitutionAdminDocumentAttachment
...
class InstitutionAdminFilterForm(forms.Form):
...
class InstitutionAdminBulkActionForm(forms.Form):
