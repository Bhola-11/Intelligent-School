"""
Forms for EduFlow Principal & Director Portal (Principal).
...
class PrincipalMasterForm(forms.ModelForm):
    """Primary form for creating and updating Principal master records."""
    class Meta:
        try:
            model = PrincipalMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PRIN-001'}),
...
class PrincipalAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = PrincipalAllocation
...
class PrincipalMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = PrincipalMetricRecord
...
class PrincipalPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = PrincipalPolicyRule
...
class PrincipalSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = PrincipalSchedulePeriod
...
class PrincipalFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = PrincipalFeedbackReview
...
class PrincipalWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = PrincipalWorkflowTransition
...
class PrincipalAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = PrincipalAccessRule
...
class PrincipalConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = PrincipalConfigurationParameter
...
class PrincipalDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = PrincipalDocumentAttachment
...
class PrincipalBulkActionForm(forms.Form):
