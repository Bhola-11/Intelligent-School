"""
Domain Validators for EduFlow Examination Coordinator Suite (ExamDesk).
...
class ExamDeskValidator:
    """Domain validator implementing enterprise business rules for ExamDesk."""
