"""
Forms for EduFlow Accountant Financial Operations Desk (AccountantDesk).
...
class AccountantDeskMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountantDesk master records."""
    class Meta:
        try:
            model = AccountantDeskMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ACCO-001'}),
...
class AccountantDeskItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = AccountantDeskItem
...
class AccountantDeskAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = AccountantDeskAllocation
...
class AccountantDeskMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = AccountantDeskMetricRecord
...
class AccountantDeskPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = AccountantDeskPolicyRule
...
class AccountantDeskSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = AccountantDeskSchedulePeriod
...
class AccountantDeskFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = AccountantDeskFeedbackReview
...
class AccountantDeskWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = AccountantDeskWorkflowTransition
...
class AccountantDeskAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = AccountantDeskAccessRule
...
class AccountantDeskConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = AccountantDeskConfigurationParameter
...
class AccountantDeskDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = AccountantDeskDocumentAttachment
...
class AccountantDeskFilterForm(forms.Form):
...
class AccountantDeskBulkActionForm(forms.Form):
