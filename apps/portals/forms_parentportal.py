"""
Forms for EduFlow Parent & Guardian Multi-Child Portal (ParentPortal).
...
class ParentPortalMasterForm(forms.ModelForm):
    """Primary form for creating and updating ParentPortal master records."""
    class Meta:
        try:
            model = ParentPortalMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PARE-001'}),
...
class ParentPortalItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ParentPortalItem
...
class ParentPortalAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ParentPortalAllocation
...
class ParentPortalMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ParentPortalMetricRecord
...
class ParentPortalPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ParentPortalPolicyRule
...
class ParentPortalSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ParentPortalSchedulePeriod
...
class ParentPortalFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ParentPortalFeedbackReview
...
class ParentPortalWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ParentPortalWorkflowTransition
...
class ParentPortalAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ParentPortalAccessRule
...
class ParentPortalConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ParentPortalConfigurationParameter
...
class ParentPortalDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ParentPortalDocumentAttachment
...
class ParentPortalFilterForm(forms.Form):
...
class ParentPortalBulkActionForm(forms.Form):
