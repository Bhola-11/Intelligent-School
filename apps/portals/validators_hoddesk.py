"""
Domain Validators for EduFlow Department Head (HOD) Overview (HODDesk).
...
class HODDeskValidator:
    """Domain validator implementing enterprise business rules for HODDesk."""
