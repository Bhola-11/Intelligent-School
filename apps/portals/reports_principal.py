"""
Operational Reporting Engine for EduFlow Principal & Director Portal (Principal).
...
try:
    from .models import PrincipalMaster, PrincipalItem, PrincipalAllocation
except ImportError:
    pass

class PrincipalReportGenerator:
    """Generates analytical reports and summary matrices for Principal."""
