"""
Operational Reporting Engine for EduFlow Reception & Front Office Desk (ReceptionDesk).
...
try:
    from .models import ReceptionDeskMaster, ReceptionDeskItem, ReceptionDeskAllocation
except ImportError:
    pass

class ReceptionDeskReportGenerator:
    """Generates analytical reports and summary matrices for ReceptionDesk."""
