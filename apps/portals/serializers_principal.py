"""
Serializers for EduFlow Principal & Director Portal (Principal).
...
class PrincipalMasterSerializer:
    """Serializes PrincipalMaster instances to and from JSON/dict structures."""
...
class PrincipalAllocationSerializer:
    @classmethod
...
class PrincipalMetricSerializer:
    @classmethod
...
class PrincipalPolicyRuleSerializer:
    @classmethod
...
class PrincipalSchedulePeriodSerializer:
    @classmethod
...
class PrincipalFeedbackReviewSerializer:
    @classmethod
...
class PrincipalWorkflowTransitionSerializer:
    @classmethod
...
class PrincipalAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class PrincipalConfigurationParameterSerializer:
    @classmethod
...
class PrincipalDocumentAttachmentSerializer:
    @classmethod
...
class PrincipalAuditTrailSerializer:
    @classmethod
