"""
Operational Reporting Engine for EduFlow Examination Coordinator Suite (ExamDesk).
...
try:
    from .models import ExamDeskMaster, ExamDeskItem, ExamDeskAllocation
except ImportError:
    pass

class ExamDeskReportGenerator:
    """Generates analytical reports and summary matrices for ExamDesk."""
