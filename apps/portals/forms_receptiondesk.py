"""
Forms for EduFlow Reception & Front Office Desk (ReceptionDesk).
...
class ReceptionDeskMasterForm(forms.ModelForm):
    """Primary form for creating and updating ReceptionDesk master records."""
    class Meta:
        try:
            model = ReceptionDeskMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. RECE-001'}),
...
class ReceptionDeskItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ReceptionDeskItem
...
class ReceptionDeskAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ReceptionDeskAllocation
...
class ReceptionDeskMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ReceptionDeskMetricRecord
...
class ReceptionDeskPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ReceptionDeskPolicyRule
...
class ReceptionDeskSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ReceptionDeskSchedulePeriod
...
class ReceptionDeskFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ReceptionDeskFeedbackReview
...
class ReceptionDeskWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ReceptionDeskWorkflowTransition
...
class ReceptionDeskAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ReceptionDeskAccessRule
...
class ReceptionDeskConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ReceptionDeskConfigurationParameter
...
class ReceptionDeskDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ReceptionDeskDocumentAttachment
...
class ReceptionDeskFilterForm(forms.Form):
...
class ReceptionDeskBulkActionForm(forms.Form):
