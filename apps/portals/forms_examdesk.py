"""
Forms for EduFlow Examination Coordinator Suite (ExamDesk).
...
class ExamDeskMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamDesk master records."""
    class Meta:
        try:
            model = ExamDeskMaster
            fields = [
...
class ExamDeskItemForm(forms.ModelForm):
...
class ExamDeskAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ExamDeskAllocation
...
class ExamDeskMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ExamDeskMetricRecord
...
class ExamDeskPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ExamDeskPolicyRule
...
class ExamDeskSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ExamDeskSchedulePeriod
...
class ExamDeskFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ExamDeskFeedbackReview
...
class ExamDeskWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ExamDeskWorkflowTransition
...
class ExamDeskAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ExamDeskAccessRule
...
class ExamDeskConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ExamDeskConfigurationParameter
...
class ExamDeskDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ExamDeskDocumentAttachment
...
class ExamDeskFilterForm(forms.Form):
...
class ExamDeskBulkActionForm(forms.Form):
