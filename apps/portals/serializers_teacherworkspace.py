"""
Serializers for EduFlow Teacher Workspace & Daily Register (TeacherWorkspace).
...
class TeacherWorkspaceMasterSerializer:
    """Serializes TeacherWorkspaceMaster instances to and from JSON/dict structures."""
...
class TeacherWorkspaceItemSerializer:
    @classmethod
...
class TeacherWorkspaceAllocationSerializer:
    @classmethod
...
class TeacherWorkspaceMetricSerializer:
    @classmethod
...
class TeacherWorkspacePolicyRuleSerializer:
    @classmethod
...
class TeacherWorkspaceSchedulePeriodSerializer:
    @classmethod
...
class TeacherWorkspaceFeedbackReviewSerializer:
    @classmethod
...
class TeacherWorkspaceWorkflowTransitionSerializer:
    @classmethod
...
class TeacherWorkspaceAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class TeacherWorkspaceConfigurationParameterSerializer:
    @classmethod
...
class TeacherWorkspaceDocumentAttachmentSerializer:
    @classmethod
...
class TeacherWorkspaceAuditTrailSerializer:
    @classmethod
