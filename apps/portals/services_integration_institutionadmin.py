"""
Enterprise Integration Adapter & Data Interchange for EduFlow Institution Administrator Portal (InstitutionAdmin).
Module: apps.portals
...
class InstitutionAdminIntegrationAdapter:
    """Enterprise external integration pipeline and ETL payload transformer for InstitutionAdmin."""
    ...
    def build_external_lms_export_payload(self, record_code, record_attributes):
        """Transforms internal InstitutionAdmin record into standard SCORM/LTI exchange dictionary."""
        payload = {
            "schema_version": "LTI_v1.3",
            "resource_link_id": f"eduflow-{code_prefix}-{record_code}",
            "domain": "InstitutionAdmin",
            "institution_id": self.institution_id,
            "context_label": "Institution Administrator Portal",
            "custom_claims": {
                "code": record_code,
    ...
    def dispatch_webhook_event(self, event_name, event_data, target_endpoint, shared_secret):
        ...
        headers = {
            ...
            "X-EduFlow-Domain": "InstitutionAdmin",
        }
        ...
        logger.info(f"[InstitutionAdmin] Webhook queued for {target_endpoint}: {event_name}")
    ...
    def construct_graphql_projection_query(self, entity_name, fields_requested, filter_params=None):
        ...
        return "query GetInstitutionAdmin { " + str(entity_name) + str(filter_part) + " { " + str(fields_str) + " } }"
    ...
    def transform_edfi_interchange_record(self, edfi_payload_dict):
        ...
        return {
            ...
            "domain_context": "InstitutionAdmin",
            "normalized_record": {
