"""
Serializers for EduFlow Assignment Attachments & Rubric Matrix (Rubrics).
...
class RubricsMasterSerializer:
    """Serializes RubricsMaster instances to and from JSON/dict structures."""
...
class RubricsAllocationSerializer:
    @classmethod
...
class RubricsPolicyRuleSerializer:
    @classmethod
...
class RubricsSchedulePeriodSerializer:
    @classmethod
...
class RubricsFeedbackReviewSerializer:
    @classmethod
...
class RubricsWorkflowTransitionSerializer:
    @classmethod
...
class RubricsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class RubricsConfigurationParameterSerializer:
    @classmethod
...
class RubricsDocumentAttachmentSerializer:
    @classmethod
...
class RubricsAuditTrailSerializer:
    @classmethod
