"""Django Admin configuration for EduFlow Student Assignment Submissions Desk (Submissions)."""
...
if 'SubmissionsMaster' in globals():
    @admin.register(SubmissionsMaster)
    class SubmissionsMasterAdmin(admin.ModelAdmin):
...
if 'SubmissionsItem' in globals():
    @admin.register(SubmissionsItem)
    class SubmissionsItemAdmin(admin.ModelAdmin):
...
if 'SubmissionsAllocation' in globals():
    @admin.register(SubmissionsAllocation)
    class SubmissionsAllocationAdmin(admin.ModelAdmin):
...
if 'SubmissionsMetricRecord' in globals():
    @admin.register(SubmissionsMetricRecord)
    class SubmissionsMetricRecordAdmin(admin.ModelAdmin):
...
if 'SubmissionsPolicyRule' in globals():
    @admin.register(SubmissionsPolicyRule)
    class SubmissionsPolicyRuleAdmin(admin.ModelAdmin):
...
if 'SubmissionsSchedulePeriod' in globals():
    @admin.register(SubmissionsSchedulePeriod)
    class SubmissionsSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'SubmissionsFeedbackReview' in globals():
    @admin.register(SubmissionsFeedbackReview)
    class SubmissionsFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'SubmissionsWorkflowTransition' in globals():
    @admin.register(SubmissionsWorkflowTransition)
    class SubmissionsWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'SubmissionsAccessRule' in globals():
    @admin.register(SubmissionsAccessRule)
    class SubmissionsAccessRuleAdmin(admin.ModelAdmin):
...
if 'SubmissionsConfigurationParameter' in globals():
    @admin.register(SubmissionsConfigurationParameter)
    class SubmissionsConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'SubmissionsDocumentAttachment' in globals():
    @admin.register(SubmissionsDocumentAttachment)
    class SubmissionsDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'SubmissionsAuditTrail' in globals():
    @admin.register(SubmissionsAuditTrail)
    class SubmissionsAuditTrailAdmin(admin.ModelAdmin):
