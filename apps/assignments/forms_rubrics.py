"""
Forms for EduFlow Assignment Attachments & Rubric Matrix (Rubrics).
...
class RubricsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Rubrics master records."""
    class Meta:
        try:
            model = RubricsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. RUBR-001'}),
...
class RubricsItemForm(forms.ModelForm):
...
class RubricsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = RubricsAllocation
...
class RubricsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = RubricsMetricRecord
...
class RubricsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = RubricsPolicyRule
...
class RubricsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = RubricsSchedulePeriod
...
class RubricsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = RubricsFeedbackReview
...
class RubricsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = RubricsWorkflowTransition
...
class RubricsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = RubricsAccessRule
...
class RubricsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = RubricsConfigurationParameter
...
class RubricsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = RubricsDocumentAttachment
...
class RubricsFilterForm(forms.Form):
...
class RubricsBulkActionForm(forms.Form):
