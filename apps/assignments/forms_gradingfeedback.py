"""
Forms for EduFlow Assignment Grading, Rubrics & Feedback (GradingFeedback).
...
class GradingFeedbackMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingFeedback master records."""
    class Meta:
        try:
            model = GradingFeedbackMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. GRAD-001'}),
...
class GradingFeedbackItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = GradingFeedbackItem
...
class GradingFeedbackAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = GradingFeedbackAllocation
...
class GradingFeedbackMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = GradingFeedbackMetricRecord
...
class GradingFeedbackPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = GradingFeedbackPolicyRule
...
class GradingFeedbackSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = GradingFeedbackSchedulePeriod
...
class GradingFeedbackFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = GradingFeedbackFeedbackReview
...
class GradingFeedbackWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = GradingFeedbackWorkflowTransition
...
class GradingFeedbackAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = GradingFeedbackAccessRule
...
class GradingFeedbackConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = GradingFeedbackConfigurationParameter
...
class GradingFeedbackDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = GradingFeedbackDocumentAttachment
...
class GradingFeedbackFilterForm(forms.Form):
...
class GradingFeedbackBulkActionForm(forms.Form):
