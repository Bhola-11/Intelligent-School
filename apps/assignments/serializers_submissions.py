"""
Serializers for EduFlow Student Assignment Submissions Desk (Submissions).
...
class SubmissionsMasterSerializer:
    """Serializes SubmissionsMaster instances to and from JSON/dict structures."""
...
class SubmissionsItemSerializer:
    @classmethod
...
class SubmissionsAllocationSerializer:
    @classmethod
...
class SubmissionsMetricSerializer:
    @classmethod
...
class SubmissionsPolicyRuleSerializer:
    @classmethod
...
class SubmissionsSchedulePeriodSerializer:
    @classmethod
...
class SubmissionsFeedbackReviewSerializer:
    @classmethod
...
class SubmissionsWorkflowTransitionSerializer:
    @classmethod
...
class SubmissionsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class SubmissionsConfigurationParameterSerializer:
    @classmethod
...
class SubmissionsDocumentAttachmentSerializer:
    @classmethod
...
class SubmissionsAuditTrailSerializer:
    @classmethod
