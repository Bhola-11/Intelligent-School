"""
Serializers for EduFlow Assignment & Homework Management (Assignments).
...
class AssignmentsMasterSerializer:
    """Serializes AssignmentsMaster instances to and from JSON/dict structures."""
...
class AssignmentsItemSerializer:
    @classmethod
...
class AssignmentsAllocationSerializer:
    @classmethod
...
class AssignmentsMetricSerializer:
    @classmethod
...
class AssignmentsPolicyRuleSerializer:
    @classmethod
...
class AssignmentsSchedulePeriodSerializer:
    @classmethod
...
class AssignmentsFeedbackReviewSerializer:
    @classmethod
...
class AssignmentsWorkflowTransitionSerializer:
    @classmethod
...
class AssignmentsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AssignmentsConfigurationParameterSerializer:
    @classmethod
...
class AssignmentsDocumentAttachmentSerializer:
    @classmethod
...
class AssignmentsAuditTrailSerializer:
    @classmethod
