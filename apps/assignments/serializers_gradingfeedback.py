"""
Serializers for EduFlow Assignment Grading, Rubrics & Feedback (GradingFeedback).
...
class GradingFeedbackMasterSerializer:
    """Serializes GradingFeedbackMaster instances to and from JSON/dict structures."""
...
class GradingFeedbackItemSerializer:
    @classmethod
...
class GradingFeedbackAllocationSerializer:
    @classmethod
...
class GradingFeedbackMetricSerializer:
    @classmethod
...
class GradingFeedbackPolicyRuleSerializer:
    @classmethod
...
class GradingFeedbackSchedulePeriodSerializer:
    @classmethod
...
class GradingFeedbackFeedbackReviewSerializer:
    @classmethod
...
class GradingFeedbackWorkflowTransitionSerializer:
    @classmethod
...
class GradingFeedbackAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class GradingFeedbackConfigurationParameterSerializer:
    @classmethod
...
class GradingFeedbackDocumentAttachmentSerializer:
    @classmethod
...
class GradingFeedbackAuditTrailSerializer:
    @classmethod
