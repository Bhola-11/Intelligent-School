"""
Domain Validators for EduFlow Room Allocation & Facility Optimization (RoomAllocator).
...
class RoomAllocatorValidator:
    """Domain validator implementing enterprise business rules for RoomAllocator."""
