"""Django Admin configuration for EduFlow Timetable Schedule Matrix & Substitution (ScheduleMatrix)."""
...
if 'ScheduleMatrixMaster' in globals():
    @admin.register(ScheduleMatrixMaster)
    class ScheduleMatrixMasterAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixItem' in globals():
    @admin.register(ScheduleMatrixItem)
    class ScheduleMatrixItemAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixAllocation' in globals():
    @admin.register(ScheduleMatrixAllocation)
    class ScheduleMatrixAllocationAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixMetricRecord' in globals():
    @admin.register(ScheduleMatrixMetricRecord)
    class ScheduleMatrixMetricRecordAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixPolicyRule' in globals():
    @admin.register(ScheduleMatrixPolicyRule)
    class ScheduleMatrixPolicyRuleAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixSchedulePeriod' in globals():
    @admin.register(ScheduleMatrixSchedulePeriod)
    class ScheduleMatrixSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixFeedbackReview' in globals():
    @admin.register(ScheduleMatrixFeedbackReview)
    class ScheduleMatrixFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixWorkflowTransition' in globals():
    @admin.register(ScheduleMatrixWorkflowTransition)
    class ScheduleMatrixWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixAccessRule' in globals():
    @admin.register(ScheduleMatrixAccessRule)
    class ScheduleMatrixAccessRuleAdmin(admin.ModelAdmin):
...
if 'ScheduleMatrixConfigurationParameter' in globals():
    @admin.register(ScheduleMatrixConfigurationParameter)
    class ScheduleMatrixConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'ScheduleMatrixDocumentAttachment' in globals():
    @admin.register(ScheduleMatrixDocumentAttachment)
    class ScheduleMatrixDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'ScheduleMatrixAuditTrail' in globals():
    @admin.register(ScheduleMatrixAuditTrail)
    class ScheduleMatrixAuditTrailAdmin(admin.ModelAdmin):
