"""
Domain Validators for EduFlow Timetable Schedule Matrix & Substitution (ScheduleMatrix).
...
class ScheduleMatrixValidator:
    """Domain validator implementing enterprise business rules for ScheduleMatrix."""
