"""
Serializers for EduFlow Timetable Periods & Time Slot Definitions (TimeSlots).
...
class TimeSlotsMasterSerializer:
    """Serializes TimeSlotsMaster instances to and from JSON/dict structures."""
...
class TimeSlotsAllocationSerializer:
    @classmethod
...
class TimeSlotsMetricSerializer:
    @classmethod
...
class TimeSlotsPolicyRuleSerializer:
    @classmethod
...
class TimeSlotsSchedulePeriodSerializer:
    @classmethod
...
class TimeSlotsFeedbackReviewSerializer:
    @classmethod
...
class TimeSlotsWorkflowTransitionSerializer:
    @classmethod
...
class TimeSlotsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class TimeSlotsConfigurationParameterSerializer:
    @classmethod
...
class TimeSlotsDocumentAttachmentSerializer:
    @classmethod
...
class TimeSlotsAuditTrailSerializer:
    @classmethod
