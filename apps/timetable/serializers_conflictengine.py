"""
Serializers for EduFlow Timetable Conflict Detection Engine (ConflictEngine).
...
class ConflictEngineMasterSerializer:
    """Serializes ConflictEngineMaster instances to and from JSON/dict structures."""
...
class ConflictEngineItemSerializer:
    @classmethod
...
class ConflictEngineAllocationSerializer:
    @classmethod
...
class ConflictEngineMetricSerializer:
    @classmethod
...
class ConflictEnginePolicyRuleSerializer:
    @classmethod
...
class ConflictEngineSchedulePeriodSerializer:
    @classmethod
...
class ConflictEngineFeedbackReviewSerializer:
    @classmethod
...
class ConflictEngineWorkflowTransitionSerializer:
    @classmethod
...
class ConflictEngineAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ConflictEngineConfigurationParameterSerializer:
    @classmethod
...
class ConflictEngineDocumentAttachmentSerializer:
    @classmethod
...
class ConflictEngineAuditTrailSerializer:
    @classmethod
