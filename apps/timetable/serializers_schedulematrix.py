"""
Serializers for EduFlow Timetable Schedule Matrix & Substitution (ScheduleMatrix).
...
class ScheduleMatrixMasterSerializer:
    """Serializes ScheduleMatrixMaster instances to and from JSON/dict structures."""
...
class ScheduleMatrixItemSerializer:
    @classmethod
...
class ScheduleMatrixAllocationSerializer:
    @classmethod
...
class ScheduleMatrixMetricSerializer:
    @classmethod
...
class ScheduleMatrixPolicyRuleSerializer:
    @classmethod
...
class ScheduleMatrixSchedulePeriodSerializer:
    @classmethod
...
class ScheduleMatrixFeedbackReviewSerializer:
    @classmethod
...
class ScheduleMatrixWorkflowTransitionSerializer:
    @classmethod
...
class ScheduleMatrixAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ScheduleMatrixConfigurationParameterSerializer:
    @classmethod
...
class ScheduleMatrixDocumentAttachmentSerializer:
    @classmethod
...
class ScheduleMatrixAuditTrailSerializer:
    @classmethod
