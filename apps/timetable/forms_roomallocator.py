"""
Forms for EduFlow Room Allocation & Facility Optimization (RoomAllocator).
...
class RoomAllocatorMasterForm(forms.ModelForm):
    """Primary form for creating and updating RoomAllocator master records."""
    class Meta:
        try:
            model = RoomAllocatorMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ROOM-001'}),
...
class RoomAllocatorItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = RoomAllocatorItem
...
class RoomAllocatorAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = RoomAllocatorAllocation
...
class RoomAllocatorMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = RoomAllocatorMetricRecord
...
class RoomAllocatorPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = RoomAllocatorPolicyRule
...
class RoomAllocatorSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = RoomAllocatorSchedulePeriod
...
class RoomAllocatorFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = RoomAllocatorFeedbackReview
...
class RoomAllocatorWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = RoomAllocatorWorkflowTransition
...
class RoomAllocatorAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = RoomAllocatorAccessRule
...
class RoomAllocatorConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = RoomAllocatorConfigurationParameter
...
class RoomAllocatorDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = RoomAllocatorDocumentAttachment
...
class RoomAllocatorFilterForm(forms.Form):
...
class RoomAllocatorBulkActionForm(forms.Form):
