"""
Operational Reporting Engine for EduFlow Timetable Schedule Matrix & Substitution (ScheduleMatrix).
...
try:
    from .models import ScheduleMatrixMaster, ScheduleMatrixItem, ScheduleMatrixAllocation
except ImportError:
    pass

class ScheduleMatrixReportGenerator:
    """Generates analytical reports and summary matrices for ScheduleMatrix."""
