"""
Serializers for EduFlow Room Allocation & Facility Optimization (RoomAllocator).
...
class RoomAllocatorMasterSerializer:
    """Serializes RoomAllocatorMaster instances to and from JSON/dict structures."""
...
class RoomAllocatorItemSerializer:
    @classmethod
...
class RoomAllocatorAllocationSerializer:
    @classmethod
...
class RoomAllocatorMetricSerializer:
    @classmethod
...
class RoomAllocatorPolicyRuleSerializer:
    @classmethod
...
class RoomAllocatorSchedulePeriodSerializer:
    @classmethod
...
class RoomAllocatorFeedbackReviewSerializer:
    @classmethod
...
class RoomAllocatorWorkflowTransitionSerializer:
    @classmethod
...
class RoomAllocatorAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class RoomAllocatorConfigurationParameterSerializer:
    @classmethod
...
class RoomAllocatorDocumentAttachmentSerializer:
    @classmethod
...
class RoomAllocatorAuditTrailSerializer:
    @classmethod
