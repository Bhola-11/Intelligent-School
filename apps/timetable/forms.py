"""
Forms for EduFlow Timetable Periods & Time Slot Definitions (TimeSlots).
...
class TimeSlotsMasterForm(forms.ModelForm):
    """Primary form for creating and updating TimeSlots master records."""
    class Meta:
        try:
            model = TimeSlotsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. TIME-001'}),
...
class TimeSlotsItemForm(forms.ModelForm):
...
class TimeSlotsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = TimeSlotsAllocation
...
class TimeSlotsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = TimeSlotsMetricRecord
...
class TimeSlotsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = TimeSlotsPolicyRule
...
class TimeSlotsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = TimeSlotsSchedulePeriod
...
class TimeSlotsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = TimeSlotsFeedbackReview
...
class TimeSlotsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = TimeSlotsWorkflowTransition
...
class TimeSlotsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = TimeSlotsAccessRule
...
class TimeSlotsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = TimeSlotsConfigurationParameter
...
class TimeSlotsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = TimeSlotsDocumentAttachment
...
class TimeSlotsFilterForm(forms.Form):
...
class TimeSlotsBulkActionForm(forms.Form):
