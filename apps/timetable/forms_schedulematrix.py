"""
Forms for EduFlow Timetable Schedule Matrix & Substitution (ScheduleMatrix).
...
class ScheduleMatrixMasterForm(forms.ModelForm):
    """Primary form for creating and updating ScheduleMatrix master records."""
    class Meta:
        try:
            model = ScheduleMatrixMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. SCHE-001'}),
...
class ScheduleMatrixItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ScheduleMatrixItem
...
class ScheduleMatrixAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ScheduleMatrixAllocation
...
class ScheduleMatrixMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ScheduleMatrixMetricRecord
...
class ScheduleMatrixPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ScheduleMatrixPolicyRule
...
class ScheduleMatrixSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ScheduleMatrixSchedulePeriod
...
class ScheduleMatrixFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ScheduleMatrixFeedbackReview
...
class ScheduleMatrixWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ScheduleMatrixWorkflowTransition
...
class ScheduleMatrixAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ScheduleMatrixAccessRule
...
class ScheduleMatrixConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ScheduleMatrixConfigurationParameter
...
class ScheduleMatrixDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ScheduleMatrixDocumentAttachment
...
class ScheduleMatrixFilterForm(forms.Form):
...
class ScheduleMatrixBulkActionForm(forms.Form):
