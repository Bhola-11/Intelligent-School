"""
Operational Reporting Engine for EduFlow Room Allocation & Facility Optimization (RoomAllocator).
...
try:
    from .models import RoomAllocatorMaster, RoomAllocatorItem, RoomAllocatorAllocation
except ImportError:
    pass

class RoomAllocatorReportGenerator:
    """Generates analytical reports and summary matrices for RoomAllocator."""
