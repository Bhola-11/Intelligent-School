"""
Forms for EduFlow Institutional Events & Activity Calendar (EventsCalendar).
...
class EventsCalendarMasterForm(forms.ModelForm):
    """Primary form for creating and updating EventsCalendar master records."""
    class Meta:
        try:
            model = EventsCalendarMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. EVEN-001'}),
...
class EventsCalendarItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = EventsCalendarItem
...
class EventsCalendarAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = EventsCalendarAllocation
...
class EventsCalendarMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = EventsCalendarMetricRecord
...
class EventsCalendarPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = EventsCalendarPolicyRule
...
class EventsCalendarSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = EventsCalendarSchedulePeriod
...
class EventsCalendarFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = EventsCalendarFeedbackReview
...
class EventsCalendarWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = EventsCalendarWorkflowTransition
...
class EventsCalendarAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = EventsCalendarAccessRule
...
class EventsCalendarConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = EventsCalendarConfigurationParameter
...
class EventsCalendarDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = EventsCalendarDocumentAttachment
...
class EventsCalendarFilterForm(forms.Form):
...
class EventsCalendarBulkActionForm(forms.Form):
