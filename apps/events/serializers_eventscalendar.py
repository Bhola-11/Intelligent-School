"""
Serializers for EduFlow Institutional Events & Activity Calendar (EventsCalendar).
...
class EventsCalendarMasterSerializer:
    """Serializes EventsCalendarMaster instances to and from JSON/dict structures."""
...
class EventsCalendarItemSerializer:
    @classmethod
...
class EventsCalendarAllocationSerializer:
    @classmethod
...
class EventsCalendarMetricSerializer:
    @classmethod
...
class EventsCalendarPolicyRuleSerializer:
    @classmethod
...
class EventsCalendarSchedulePeriodSerializer:
    @classmethod
...
class EventsCalendarFeedbackReviewSerializer:
    @classmethod
...
class EventsCalendarWorkflowTransitionSerializer:
    @classmethod
...
class EventsCalendarAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class EventsCalendarConfigurationParameterSerializer:
    @classmethod
...
class EventsCalendarDocumentAttachmentSerializer:
    @classmethod
...
class EventsCalendarAuditTrailSerializer:
    @classmethod
