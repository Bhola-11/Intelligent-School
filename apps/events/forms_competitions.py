"""
Forms for EduFlow Event Participants & Competitions Tracker (Competitions).
...
class CompetitionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Competitions master records."""
    class Meta:
        try:
            model = CompetitionsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. COMP-001'}),
...
class CompetitionsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = CompetitionsItem
...
class CompetitionsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = CompetitionsAllocation
...
class CompetitionsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = CompetitionsMetricRecord
...
class CompetitionsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = CompetitionsPolicyRule
...
class CompetitionsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = CompetitionsSchedulePeriod
...
class CompetitionsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = CompetitionsFeedbackReview
...
class CompetitionsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = CompetitionsWorkflowTransition
...
class CompetitionsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = CompetitionsAccessRule
...
class CompetitionsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = CompetitionsConfigurationParameter
...
class CompetitionsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = CompetitionsDocumentAttachment
...
class CompetitionsFilterForm(forms.Form):
...
class CompetitionsBulkActionForm(forms.Form):
