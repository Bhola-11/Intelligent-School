"""Django Admin configuration for EduFlow Institutional Events & Activity Calendar (EventsCalendar)."""
...
if 'EventsCalendarMaster' in globals():
    @admin.register(EventsCalendarMaster)
    class EventsCalendarMasterAdmin(admin.ModelAdmin):
...
if 'EventsCalendarItem' in globals():
    @admin.register(EventsCalendarItem)
    class EventsCalendarItemAdmin(admin.ModelAdmin):
...
if 'EventsCalendarAllocation' in globals():
    @admin.register(EventsCalendarAllocation)
    class EventsCalendarAllocationAdmin(admin.ModelAdmin):
...
if 'EventsCalendarMetricRecord' in globals():
    @admin.register(EventsCalendarMetricRecord)
    class EventsCalendarMetricRecordAdmin(admin.ModelAdmin):
...
if 'EventsCalendarPolicyRule' in globals():
    @admin.register(EventsCalendarPolicyRule)
    class EventsCalendarPolicyRuleAdmin(admin.ModelAdmin):
...
if 'EventsCalendarSchedulePeriod' in globals():
    @admin.register(EventsCalendarSchedulePeriod)
    class EventsCalendarSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'EventsCalendarFeedbackReview' in globals():
    @admin.register(EventsCalendarFeedbackReview)
    class EventsCalendarFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'EventsCalendarWorkflowTransition' in globals():
    @admin.register(EventsCalendarWorkflowTransition)
    class EventsCalendarWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'EventsCalendarAccessRule' in globals():
    @admin.register(EventsCalendarAccessRule)
    class EventsCalendarAccessRuleAdmin(admin.ModelAdmin):
...
if 'EventsCalendarConfigurationParameter' in globals():
    @admin.register(EventsCalendarConfigurationParameter)
    class EventsCalendarConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'EventsCalendarDocumentAttachment' in globals():
    @admin.register(EventsCalendarDocumentAttachment)
    class EventsCalendarDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'EventsCalendarAuditTrail' in globals():
    @admin.register(EventsCalendarAuditTrail)
    class EventsCalendarAuditTrailAdmin(admin.ModelAdmin):
