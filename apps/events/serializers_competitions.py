"""
Serializers for EduFlow Event Participants & Competitions Tracker (Competitions).
...
class CompetitionsMasterSerializer:
    """Serializes CompetitionsMaster instances to and from JSON/dict structures."""
...
class CompetitionsItemSerializer:
    @classmethod
...
class CompetitionsAllocationSerializer:
    @classmethod
...
class CompetitionsMetricSerializer:
    @classmethod
...
class CompetitionsPolicyRuleSerializer:
    @classmethod
...
class CompetitionsSchedulePeriodSerializer:
    @classmethod
...
class CompetitionsFeedbackReviewSerializer:
    @classmethod
...
class CompetitionsWorkflowTransitionSerializer:
    @classmethod
...
class CompetitionsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CompetitionsConfigurationParameterSerializer:
    @classmethod
...
class CompetitionsDocumentAttachmentSerializer:
    @classmethod
...
class CompetitionsAuditTrailSerializer:
    @classmethod
