"""
Serializers for EduFlow Lesson Plans & Daily Teaching Logs (LessonPlans).
...
class LessonPlansMasterSerializer:
    """Serializes LessonPlansMaster instances to and from JSON/dict structures."""
...
class LessonPlansItemSerializer:
    @classmethod
...
class LessonPlansAllocationSerializer:
    @classmethod
...
class LessonPlansMetricSerializer:
    @classmethod
...
class LessonPlansPolicyRuleSerializer:
    @classmethod
...
class LessonPlansSchedulePeriodSerializer:
    @classmethod
...
class LessonPlansFeedbackReviewSerializer:
    @classmethod
...
class LessonPlansWorkflowTransitionSerializer:
    @classmethod
...
class LessonPlansAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class LessonPlansConfigurationParameterSerializer:
    @classmethod
...
class LessonPlansDocumentAttachmentSerializer:
    @classmethod
...
class LessonPlansAuditTrailSerializer:
    @classmethod
