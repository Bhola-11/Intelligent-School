"""
Serializers for EduFlow Teacher-Class-Subject Allocation Matrix (SubjectTeachers).
...
class SubjectTeachersMasterSerializer:
    """Serializes SubjectTeachersMaster instances to and from JSON/dict structures."""
...
class SubjectTeachersItemSerializer:
    @classmethod
...
class SubjectTeachersAllocationSerializer:
    @classmethod
...
class SubjectTeachersMetricSerializer:
    @classmethod
...
class SubjectTeachersPolicyRuleSerializer:
    @classmethod
...
class SubjectTeachersSchedulePeriodSerializer:
    @classmethod
...
class SubjectTeachersFeedbackReviewSerializer:
    @classmethod
...
class SubjectTeachersWorkflowTransitionSerializer:
    @classmethod
...
class SubjectTeachersAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class SubjectTeachersConfigurationParameterSerializer:
    @classmethod
...
class SubjectTeachersDocumentAttachmentSerializer:
    @classmethod
...
class SubjectTeachersAuditTrailSerializer:
    @classmethod
