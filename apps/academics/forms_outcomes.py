"""
Forms for EduFlow Learning Outcomes & Bloom's Taxonomy (Outcomes).
...
class OutcomesMasterForm(forms.ModelForm):
    """Primary form for creating and updating Outcomes master records."""
    class Meta:
        try:
            model = OutcomesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. OUTC-001'}),
...
class OutcomesItemForm(forms.ModelForm):
...
class OutcomesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = OutcomesAllocation
...
class OutcomesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = OutcomesMetricRecord
...
class OutcomesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = OutcomesPolicyRule
...
class OutcomesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = OutcomesSchedulePeriod
...
class OutcomesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = OutcomesFeedbackReview
...
class OutcomesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = OutcomesWorkflowTransition
...
class OutcomesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = OutcomesAccessRule
...
class OutcomesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = OutcomesConfigurationParameter
...
class OutcomesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = OutcomesDocumentAttachment
...
class OutcomesFilterForm(forms.Form):
...
class OutcomesBulkActionForm(forms.Form):
