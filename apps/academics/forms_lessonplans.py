"""
Forms for EduFlow Lesson Plans & Daily Teaching Logs (LessonPlans).
...
class LessonPlansMasterForm(forms.ModelForm):
    """Primary form for creating and updating LessonPlans master records."""
    class Meta:
        try:
            model = LessonPlansMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. LESS-001'}),
...
class LessonPlansItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = LessonPlansItem
...
class LessonPlansAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = LessonPlansAllocation
...
class LessonPlansMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = LessonPlansMetricRecord
...
class LessonPlansPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = LessonPlansPolicyRule
...
class LessonPlansSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = LessonPlansSchedulePeriod
...
class LessonPlansFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = LessonPlansFeedbackReview
...
class LessonPlansWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = LessonPlansWorkflowTransition
...
class LessonPlansAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = LessonPlansAccessRule
...
class LessonPlansConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = LessonPlansConfigurationParameter
...
class LessonPlansDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = LessonPlansDocumentAttachment
...
class LessonPlansFilterForm(forms.Form):
...
class LessonPlansBulkActionForm(forms.Form):
