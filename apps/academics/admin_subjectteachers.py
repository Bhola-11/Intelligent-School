"""Django Admin configuration for EduFlow Teacher-Class-Subject Allocation Matrix (SubjectTeachers)."""
...
if 'SubjectTeachersMaster' in globals():
    @admin.register(SubjectTeachersMaster)
    class SubjectTeachersMasterAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersItem' in globals():
    @admin.register(SubjectTeachersItem)
    class SubjectTeachersItemAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersAllocation' in globals():
    @admin.register(SubjectTeachersAllocation)
    class SubjectTeachersAllocationAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersMetricRecord' in globals():
    @admin.register(SubjectTeachersMetricRecord)
    class SubjectTeachersMetricRecordAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersPolicyRule' in globals():
    @admin.register(SubjectTeachersPolicyRule)
    class SubjectTeachersPolicyRuleAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersSchedulePeriod' in globals():
    @admin.register(SubjectTeachersSchedulePeriod)
    class SubjectTeachersSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersFeedbackReview' in globals():
    @admin.register(SubjectTeachersFeedbackReview)
    class SubjectTeachersFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersWorkflowTransition' in globals():
    @admin.register(SubjectTeachersWorkflowTransition)
    class SubjectTeachersWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersAccessRule' in globals():
    @admin.register(SubjectTeachersAccessRule)
    class SubjectTeachersAccessRuleAdmin(admin.ModelAdmin):
...
if 'SubjectTeachersConfigurationParameter' in globals():
    @admin.register(SubjectTeachersConfigurationParameter)
    class SubjectTeachersConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'SubjectTeachersDocumentAttachment' in globals():
    @admin.register(SubjectTeachersDocumentAttachment)
    class SubjectTeachersDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'SubjectTeachersAuditTrail' in globals():
    @admin.register(SubjectTeachersAuditTrail)
    class SubjectTeachersAuditTrailAdmin(admin.ModelAdmin):
