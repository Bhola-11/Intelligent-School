"""
Operational Reporting Engine for EduFlow Teacher-Class-Subject Allocation Matrix (SubjectTeachers).
...
try:
    from .models import SubjectTeachersMaster, SubjectTeachersItem, SubjectTeachersAllocation
except ImportError:
    pass

class SubjectTeachersReportGenerator:
    """Generates analytical reports and summary matrices for SubjectTeachers."""
