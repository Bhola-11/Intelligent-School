"""
Operational Reporting Engine for EduFlow Learning Outcomes & Bloom's Taxonomy (Outcomes).
...
try:
    from .models import OutcomesMaster, OutcomesItem, OutcomesAllocation
except ImportError:
    pass

class OutcomesReportGenerator:
    """Generates analytical reports and summary matrices for Outcomes."""
