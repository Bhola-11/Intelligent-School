"""
Serializers for EduFlow Academic Curriculum & Syllabus Topics (Curriculum).
...
class CurriculumMasterSerializer:
    """Serializes CurriculumMaster instances to and from JSON/dict structures."""
...
class CurriculumItemSerializer:
    @classmethod
...
class CurriculumAllocationSerializer:
    @classmethod
...
class CurriculumMetricSerializer:
    @classmethod
...
class CurriculumPolicyRuleSerializer:
    @classmethod
...
class CurriculumSchedulePeriodSerializer:
    @classmethod
...
class CurriculumFeedbackReviewSerializer:
    @classmethod
...
class CurriculumWorkflowTransitionSerializer:
    @classmethod
...
class CurriculumAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CurriculumConfigurationParameterSerializer:
    @classmethod
...
class CurriculumDocumentAttachmentSerializer:
    @classmethod
...
class CurriculumAuditTrailSerializer:
    @classmethod
