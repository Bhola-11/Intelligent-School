"""
Serializers for EduFlow Learning Outcomes & Bloom's Taxonomy (Outcomes).
...
class OutcomesMasterSerializer:
    """Serializes OutcomesMaster instances to and from JSON/dict structures."""
...
class OutcomesAllocationSerializer:
    @classmethod
...
class OutcomesMetricSerializer:
    @classmethod
...
class OutcomesPolicyRuleSerializer:
    @classmethod
...
class OutcomesSchedulePeriodSerializer:
    @classmethod
...
class OutcomesFeedbackReviewSerializer:
    @classmethod
...
class OutcomesWorkflowTransitionSerializer:
    @classmethod
...
class OutcomesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class OutcomesConfigurationParameterSerializer:
    @classmethod
...
class OutcomesDocumentAttachmentSerializer:
    @classmethod
...
class OutcomesAuditTrailSerializer:
    @classmethod
