"""
Forms for EduFlow Teacher-Class-Subject Allocation Matrix (SubjectTeachers).
...
class SubjectTeachersMasterForm(forms.ModelForm):
    """Primary form for creating and updating SubjectTeachers master records."""
    class Meta:
        try:
            model = SubjectTeachersMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. SUBJ-001'}),
...
class SubjectTeachersItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = SubjectTeachersItem
...
class SubjectTeachersAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = SubjectTeachersAllocation
...
class SubjectTeachersMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = SubjectTeachersMetricRecord
...
class SubjectTeachersPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = SubjectTeachersPolicyRule
...
class SubjectTeachersSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = SubjectTeachersSchedulePeriod
...
class SubjectTeachersFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = SubjectTeachersFeedbackReview
...
class SubjectTeachersWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = SubjectTeachersWorkflowTransition
...
class SubjectTeachersAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = SubjectTeachersAccessRule
...
class SubjectTeachersConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = SubjectTeachersConfigurationParameter
...
class SubjectTeachersDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = SubjectTeachersDocumentAttachment
...
class SubjectTeachersFilterForm(forms.Form):
...
class SubjectTeachersBulkActionForm(forms.Form):
