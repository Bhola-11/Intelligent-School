"""
Operational Dashboard and Realtime KPI Analytics for EduFlow Academic Curriculum & Syllabus Topics (Curriculum).
...
class CurriculumDashboardView(LoginRequiredMixin, TemplateView):
    """Executive operations dashboard for Curriculum."""
    template_name = 'academics/curriculum_dashboard.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        # Recent activities
        audit_trail = CurriculumAuditTrail.objects.all().order_by('-timestamp')[:10] if 'CurriculumAuditTrail' in globals() else []
        recent_records = records[:8] if records else []

        ctx.update({
            "page_title": "Academic Curriculum & Syllabus Topics Operations Dashboard",
...
class CurriculumAnalyticsView(LoginRequiredMixin, TemplateView):
    ...
    template_name = 'academics/curriculum_analytics.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx.update({
            "page_title": "Academic Curriculum & Syllabus Topics Analytical Insights",
