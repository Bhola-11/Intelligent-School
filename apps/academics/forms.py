"""
Forms for EduFlow Academic Curriculum & Syllabus Topics (Curriculum).
...
class CurriculumMasterForm(forms.ModelForm):
    """Primary form for creating and updating Curriculum master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. CURR-001'}),
...
class CurriculumAllocationForm(forms.ModelForm):
...
class CurriculumMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = CurriculumMetricRecord
...
class CurriculumPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = CurriculumPolicyRule
...
class CurriculumSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = CurriculumSchedulePeriod
...
class CurriculumFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = CurriculumFeedbackReview
...
class CurriculumWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = CurriculumWorkflowTransition
...
class CurriculumAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = CurriculumAccessRule
...
class CurriculumConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = CurriculumConfigurationParameter
...
class CurriculumDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = CurriculumDocumentAttachment
...
class CurriculumFilterForm(forms.Form):
...
class CurriculumBulkActionForm(forms.Form):
