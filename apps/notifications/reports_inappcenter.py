"""
Operational Reporting Engine for EduFlow In-App Notification Center & Alerts (InAppCenter).
...
try:
    from .models import InAppCenterMaster, InAppCenterItem, InAppCenterAllocation
except ImportError:
    pass

class InAppCenterReportGenerator:
    """Generates analytical reports and summary matrices for InAppCenter."""
