"""
Forms for EduFlow Notification Engine & Channel Routing (Notifications).
...
class NotificationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Notifications master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. NOTI-001'}),
...
class NotificationsItemForm(forms.ModelForm):
...
class NotificationsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = NotificationsAllocation
...
class NotificationsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = NotificationsMetricRecord
...
class NotificationsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = NotificationsPolicyRule
...
class NotificationsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = NotificationsSchedulePeriod
...
class NotificationsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = NotificationsFeedbackReview
...
class NotificationsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = NotificationsWorkflowTransition
...
class NotificationsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = NotificationsAccessRule
...
class NotificationsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = NotificationsConfigurationParameter
...
class NotificationsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = NotificationsDocumentAttachment
...
class NotificationsFilterForm(forms.Form):
...
class NotificationsBulkActionForm(forms.Form):
