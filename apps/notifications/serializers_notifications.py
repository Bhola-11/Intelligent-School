"""
Serializers for EduFlow Notification Engine & Channel Routing (Notifications).
...
class NotificationsMasterSerializer:
    """Serializes NotificationsMaster instances to and from JSON/dict structures."""
...
class NotificationsItemSerializer:
    @classmethod
...
class NotificationsAllocationSerializer:
    @classmethod
...
class NotificationsMetricSerializer:
    @classmethod
...
class NotificationsPolicyRuleSerializer:
    @classmethod
...
class NotificationsSchedulePeriodSerializer:
    @classmethod
...
class NotificationsFeedbackReviewSerializer:
    @classmethod
...
class NotificationsWorkflowTransitionSerializer:
    @classmethod
...
class NotificationsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class NotificationsConfigurationParameterSerializer:
    @classmethod
...
class NotificationsDocumentAttachmentSerializer:
    @classmethod
...
class NotificationsAuditTrailSerializer:
    @classmethod
