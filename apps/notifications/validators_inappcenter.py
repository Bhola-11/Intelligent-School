"""
Domain Validators for EduFlow In-App Notification Center & Alerts (InAppCenter).
...
class InAppCenterValidator:
    """Domain validator implementing enterprise business rules for InAppCenter."""
