"""
Serializers for EduFlow In-App Notification Center & Alerts (InAppCenter).
...
class InAppCenterMasterSerializer:
    """Serializes InAppCenterMaster instances to and from JSON/dict structures."""
...
class InAppCenterItemSerializer:
    @classmethod
...
class InAppCenterAllocationSerializer:
    @classmethod
...
class InAppCenterMetricSerializer:
    @classmethod
...
class InAppCenterPolicyRuleSerializer:
    @classmethod
...
class InAppCenterSchedulePeriodSerializer:
    @classmethod
...
class InAppCenterFeedbackReviewSerializer:
    @classmethod
...
class InAppCenterWorkflowTransitionSerializer:
    @classmethod
...
class InAppCenterAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class InAppCenterConfigurationParameterSerializer:
    @classmethod
...
class InAppCenterDocumentAttachmentSerializer:
    @classmethod
...
class InAppCenterAuditTrailSerializer:
    @classmethod
