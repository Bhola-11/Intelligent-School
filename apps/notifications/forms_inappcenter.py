"""
Forms for EduFlow In-App Notification Center & Alerts (InAppCenter).
...
class InAppCenterMasterForm(forms.ModelForm):
    """Primary form for creating and updating InAppCenter master records."""
    class Meta:
        try:
            model = InAppCenterMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. INAP-001'}),
...
class InAppCenterItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = InAppCenterItem
...
class InAppCenterAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = InAppCenterAllocation
...
class InAppCenterMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = InAppCenterMetricRecord
...
class InAppCenterPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = InAppCenterPolicyRule
...
class InAppCenterSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = InAppCenterSchedulePeriod
...
class InAppCenterFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = InAppCenterFeedbackReview
...
class InAppCenterWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = InAppCenterWorkflowTransition
...
class InAppCenterAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = InAppCenterAccessRule
...
class InAppCenterConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = InAppCenterConfigurationParameter
...
class InAppCenterDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = InAppCenterDocumentAttachment
...
class InAppCenterFilterForm(forms.Form):
...
class InAppCenterBulkActionForm(forms.Form):
