"""
Serializers for EduFlow Book Reservations & Overdue Fines (Reservations).
...
class ReservationsMasterSerializer:
    """Serializes ReservationsMaster instances to and from JSON/dict structures."""
...
class ReservationsItemSerializer:
    @classmethod
...
class ReservationsAllocationSerializer:
    @classmethod
...
class ReservationsMetricSerializer:
    @classmethod
...
class ReservationsPolicyRuleSerializer:
    @classmethod
...
class ReservationsSchedulePeriodSerializer:
    @classmethod
...
class ReservationsFeedbackReviewSerializer:
    @classmethod
...
class ReservationsWorkflowTransitionSerializer:
    @classmethod
...
class ReservationsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ReservationsConfigurationParameterSerializer:
    @classmethod
...
class ReservationsDocumentAttachmentSerializer:
    @classmethod
...
class ReservationsAuditTrailSerializer:
    @classmethod
