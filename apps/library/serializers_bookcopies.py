"""
Serializers for EduFlow Book Copies, Barcodes & Shelf Tracking (BookCopies).
...
class BookCopiesMasterSerializer:
    """Serializes BookCopiesMaster instances to and from JSON/dict structures."""
...
class BookCopiesItemSerializer:
    @classmethod
...
class BookCopiesAllocationSerializer:
    @classmethod
...
class BookCopiesMetricSerializer:
    @classmethod
...
class BookCopiesPolicyRuleSerializer:
    @classmethod
...
class BookCopiesSchedulePeriodSerializer:
    @classmethod
...
class BookCopiesFeedbackReviewSerializer:
    @classmethod
...
class BookCopiesWorkflowTransitionSerializer:
    @classmethod
...
class BookCopiesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class BookCopiesConfigurationParameterSerializer:
    @classmethod
...
class BookCopiesDocumentAttachmentSerializer:
    @classmethod
...
class BookCopiesAuditTrailSerializer:
    @classmethod
