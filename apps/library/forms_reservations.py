"""
Forms for EduFlow Book Reservations & Overdue Fines (Reservations).
...
class ReservationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Reservations master records."""
    class Meta:
        try:
            model = ReservationsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. RESE-001'}),
...
class ReservationsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ReservationsItem
...
class ReservationsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ReservationsAllocation
...
class ReservationsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ReservationsMetricRecord
...
class ReservationsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ReservationsPolicyRule
...
class ReservationsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ReservationsSchedulePeriod
...
class ReservationsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ReservationsFeedbackReview
...
class ReservationsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ReservationsWorkflowTransition
...
class ReservationsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ReservationsAccessRule
...
class ReservationsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ReservationsConfigurationParameter
...
class ReservationsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ReservationsDocumentAttachment
...
class ReservationsFilterForm(forms.Form):
...
class ReservationsBulkActionForm(forms.Form):
