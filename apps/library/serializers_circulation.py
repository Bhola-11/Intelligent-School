"""
Serializers for EduFlow Library Circulation, Borrow & Returns (Circulation).
...
class CirculationMasterSerializer:
    """Serializes CirculationMaster instances to and from JSON/dict structures."""
...
class CirculationItemSerializer:
    @classmethod
...
class CirculationAllocationSerializer:
    @classmethod
...
class CirculationMetricSerializer:
    @classmethod
...
class CirculationPolicyRuleSerializer:
    @classmethod
...
class CirculationSchedulePeriodSerializer:
    @classmethod
...
class CirculationFeedbackReviewSerializer:
    @classmethod
...
class CirculationWorkflowTransitionSerializer:
    @classmethod
...
class CirculationAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CirculationConfigurationParameterSerializer:
    @classmethod
...
class CirculationDocumentAttachmentSerializer:
    @classmethod
...
class CirculationAuditTrailSerializer:
    @classmethod
