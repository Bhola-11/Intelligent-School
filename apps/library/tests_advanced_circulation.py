"""
Advanced Integration, Stress, and Permission Test Suite for EduFlow Library Circulation, Borrow & Returns (Circulation).
...
try:
    ...
    from .services_extended_circulation import CirculationAdvancedService
    from .reports_circulation import CirculationReportGenerator
except ImportError:
    try:
...
class CirculationAdvancedIntegrationTestSuite(TestCase):
    """Deep integration tests covering service coordination, reporting, and audit trails."""

    def setUp(self):
        self.superadmin = User.objects.create_user(
            username='admin_circulation_adv',
            email='admin_circulation_adv@eduflow.local',
            password='AdminPassword123!',
            role='SuperAdmin'
        )
        self.staff_user = User.objects.create_user(
            username='staff_circulation_adv',
            email='staff_circulation_adv@eduflow.local',
    ...
    def test_complete_entity_graph_creation(self):
        ...
        # 2. Allocation
        if 'CirculationAllocation' in globals():
        ...
        # 3. Metric
        if 'CirculationMetricRecord' in globals():
        ...
        # 4. Policy Rule
        if 'CirculationPolicyRule' in globals():
        ...
        # 5. Schedule Period
        if 'CirculationSchedulePeriod' in globals():
            period = CirculationSchedulePeriod.objects.create(
                master=master,
        ...
        # 6. Feedback Review
        if 'CirculationFeedbackReview' in globals():
            review = CirculationFeedbackReview.objects.create(
                master=master,
        ...
        if 'CirculationWorkflowTransition' in globals():
            wf = CirculationWorkflowTransition.objects.create(
                master=master,
                from_stage='DRAFT',
                to_stage='ACTIVE',
        ...
        # 8. Access Rule
        if 'CirculationAccessRule' in globals():
            rule = CirculationAccessRule.objects.create(
                master=master,
        ...
        # 9. Config Parameter
        if 'CirculationConfigurationParameter' in globals():
            config = CirculationConfigurationParameter.objects.create(
                master=master,
        ...
        if 'CirculationDocumentAttachment' in globals():
            doc = CirculationDocumentAttachment.objects.create(
                master=master,
                title='Campus Safety Certification',
                file_path='/vault/library/circulation_cert.pdf',
        ...
        # 11. Audit Trail
        if 'CirculationAuditTrail' in globals():
            audit = CirculationAuditTrail.objects.create(
                master=master,
    ...
    def test_report_generator_aggregation(self):
        ...
        if 'CirculationReportGenerator' in globals():
            summary = CirculationReportGenerator.generate_utilization_summary()
    ...
    def test_bulk_status_update_permissions(self):
        ...
        try:
            url = reverse('library:circulation_bulk_update')
    ...
    def test_advanced_service_efficiency_analytics(self):
        ...
        if 'CirculationAdvancedService' in globals():
            analysis = CirculationAdvancedService.analyze_operational_efficiency(self.master.pk)
