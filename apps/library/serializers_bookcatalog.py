"""
Serializers for EduFlow Library Book Catalog & ISBN Management (BookCatalog).
...
class BookCatalogMasterSerializer:
    """Serializes BookCatalogMaster instances to and from JSON/dict structures."""
...
class BookCatalogItemSerializer:
    @classmethod
...
class BookCatalogAllocationSerializer:
    @classmethod
...
class BookCatalogMetricSerializer:
    @classmethod
...
class BookCatalogPolicyRuleSerializer:
    @classmethod
...
class BookCatalogSchedulePeriodSerializer:
    @classmethod
...
class BookCatalogFeedbackReviewSerializer:
    @classmethod
...
class BookCatalogWorkflowTransitionSerializer:
    @classmethod
...
class BookCatalogAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class BookCatalogConfigurationParameterSerializer:
    @classmethod
...
class BookCatalogDocumentAttachmentSerializer:
    @classmethod
...
class BookCatalogAuditTrailSerializer:
    @classmethod
