"""
Forms for EduFlow Library Circulation, Borrow & Returns (Circulation).
...
class CirculationMasterForm(forms.ModelForm):
    """Primary form for creating and updating Circulation master records."""
    class Meta:
        try:
            model = CirculationMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. CIRC-001'}),
...
class CirculationItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = CirculationItem
...
class CirculationAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = CirculationAllocation
...
class CirculationMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = CirculationMetricRecord
...
class CirculationPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = CirculationPolicyRule
...
class CirculationSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = CirculationSchedulePeriod
...
class CirculationFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = CirculationFeedbackReview
...
class CirculationWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = CirculationWorkflowTransition
...
class CirculationAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = CirculationAccessRule
...
class CirculationConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = CirculationConfigurationParameter
...
class CirculationDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = CirculationDocumentAttachment
...
class CirculationBulkActionForm(forms.Form):
