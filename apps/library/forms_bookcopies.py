"""
Forms for EduFlow Book Copies, Barcodes & Shelf Tracking (BookCopies).
...
class BookCopiesMasterForm(forms.ModelForm):
    """Primary form for creating and updating BookCopies master records."""
    class Meta:
        try:
            model = BookCopiesMaster
            fields = [
...
class BookCopiesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = BookCopiesItem
...
class BookCopiesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = BookCopiesAllocation
...
class BookCopiesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = BookCopiesMetricRecord
...
class BookCopiesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = BookCopiesPolicyRule
...
class BookCopiesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = BookCopiesSchedulePeriod
...
class BookCopiesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = BookCopiesFeedbackReview
...
class BookCopiesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = BookCopiesWorkflowTransition
...
class BookCopiesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = BookCopiesAccessRule
...
class BookCopiesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = BookCopiesConfigurationParameter
...
class BookCopiesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = BookCopiesDocumentAttachment
...
class BookCopiesFilterForm(forms.Form):
...
class BookCopiesBulkActionForm(forms.Form):
