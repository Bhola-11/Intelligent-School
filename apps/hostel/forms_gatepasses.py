"""
Forms for EduFlow Hostel Gate Passes & Resident Discipline (GatePasses).
...
class GatePassesMasterForm(forms.ModelForm):
    """Primary form for creating and updating GatePasses master records."""
    class Meta:
        try:
            model = GatePassesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. GATE-001'}),
...
class GatePassesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = GatePassesItem
...
class GatePassesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = GatePassesAllocation
...
class GatePassesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = GatePassesMetricRecord
...
class GatePassesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = GatePassesPolicyRule
...
class GatePassesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = GatePassesSchedulePeriod
...
class GatePassesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = GatePassesFeedbackReview
...
class GatePassesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = GatePassesWorkflowTransition
...
class GatePassesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = GatePassesAccessRule
...
class GatePassesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = GatePassesConfigurationParameter
...
class GatePassesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = GatePassesDocumentAttachment
...
class GatePassesFilterForm(forms.Form):
...
class GatePassesBulkActionForm(forms.Form):
