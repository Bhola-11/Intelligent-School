"""
Forms for EduFlow Hostel Buildings, Blocks & Rooms (HostelFacilities).
...
class HostelFacilitiesMasterForm(forms.ModelForm):
    """Primary form for creating and updating HostelFacilities master records."""
    class Meta:
        try:
            model = HostelFacilitiesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. HOST-001'}),
...
class HostelFacilitiesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = HostelFacilitiesItem
...
class HostelFacilitiesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = HostelFacilitiesAllocation
...
class HostelFacilitiesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = HostelFacilitiesMetricRecord
...
class HostelFacilitiesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = HostelFacilitiesPolicyRule
...
class HostelFacilitiesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = HostelFacilitiesSchedulePeriod
...
class HostelFacilitiesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = HostelFacilitiesFeedbackReview
...
class HostelFacilitiesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = HostelFacilitiesWorkflowTransition
...
class HostelFacilitiesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = HostelFacilitiesAccessRule
...
class HostelFacilitiesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = HostelFacilitiesConfigurationParameter
...
class HostelFacilitiesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = HostelFacilitiesDocumentAttachment
...
class HostelFacilitiesFilterForm(forms.Form):
...
class HostelFacilitiesBulkActionForm(forms.Form):
