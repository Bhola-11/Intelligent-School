"""
Domain Validators for EduFlow Hostel Bed Allocation & Check-In (BedAllocations).
...
class BedAllocationsValidator:
    """Domain validator implementing enterprise business rules for BedAllocations."""
