"""
Domain Validators for EduFlow Hostel Gate Passes & Resident Discipline (GatePasses).
...
class GatePassesValidator:
    """Domain validator implementing enterprise business rules for GatePasses."""
