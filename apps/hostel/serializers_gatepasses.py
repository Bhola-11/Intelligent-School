"""
Serializers for EduFlow Hostel Gate Passes & Resident Discipline (GatePasses).
...
class GatePassesMasterSerializer:
    """Serializes GatePassesMaster instances to and from JSON/dict structures."""
...
class GatePassesItemSerializer:
    @classmethod
...
class GatePassesAllocationSerializer:
    @classmethod
...
class GatePassesMetricSerializer:
    @classmethod
...
class GatePassesPolicyRuleSerializer:
    @classmethod
...
class GatePassesSchedulePeriodSerializer:
    @classmethod
...
class GatePassesFeedbackReviewSerializer:
    @classmethod
...
class GatePassesWorkflowTransitionSerializer:
    @classmethod
...
class GatePassesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class GatePassesConfigurationParameterSerializer:
    @classmethod
...
class GatePassesDocumentAttachmentSerializer:
    @classmethod
...
class GatePassesAuditTrailSerializer:
    @classmethod
