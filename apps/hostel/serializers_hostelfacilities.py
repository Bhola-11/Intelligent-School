"""
Serializers for EduFlow Hostel Buildings, Blocks & Rooms (HostelFacilities).
...
class HostelFacilitiesMasterSerializer:
    """Serializes HostelFacilitiesMaster instances to and from JSON/dict structures."""
...
class HostelFacilitiesItemSerializer:
    @classmethod
...
class HostelFacilitiesAllocationSerializer:
    @classmethod
...
class HostelFacilitiesMetricSerializer:
    @classmethod
...
class HostelFacilitiesPolicyRuleSerializer:
    @classmethod
...
class HostelFacilitiesSchedulePeriodSerializer:
    @classmethod
...
class HostelFacilitiesFeedbackReviewSerializer:
    @classmethod
...
class HostelFacilitiesWorkflowTransitionSerializer:
    @classmethod
...
class HostelFacilitiesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class HostelFacilitiesConfigurationParameterSerializer:
    @classmethod
...
class HostelFacilitiesDocumentAttachmentSerializer:
    @classmethod
...
class HostelFacilitiesAuditTrailSerializer:
    @classmethod
