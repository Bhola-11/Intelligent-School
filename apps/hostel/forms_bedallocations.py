"""
Forms for EduFlow Hostel Bed Allocation & Check-In (BedAllocations).
...
class BedAllocationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating BedAllocations master records."""
    class Meta:
        try:
            model = BedAllocationsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. BEDA-001'}),
...
class BedAllocationsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = BedAllocationsItem
...
class BedAllocationsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = BedAllocationsAllocation
...
class BedAllocationsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = BedAllocationsMetricRecord
...
class BedAllocationsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = BedAllocationsPolicyRule
...
class BedAllocationsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = BedAllocationsSchedulePeriod
...
class BedAllocationsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = BedAllocationsFeedbackReview
...
class BedAllocationsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = BedAllocationsWorkflowTransition
...
class BedAllocationsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = BedAllocationsAccessRule
...
class BedAllocationsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = BedAllocationsConfigurationParameter
...
class BedAllocationsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = BedAllocationsDocumentAttachment
...
class BedAllocationsFilterForm(forms.Form):
...
class BedAllocationsBulkActionForm(forms.Form):
