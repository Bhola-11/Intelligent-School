"""
Domain Validators for EduFlow Hostel Buildings, Blocks & Rooms (HostelFacilities).
...
class HostelFacilitiesValidator:
    """Domain validator implementing enterprise business rules for HostelFacilities."""
