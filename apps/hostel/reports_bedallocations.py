"""
Operational Reporting Engine for EduFlow Hostel Bed Allocation & Check-In (BedAllocations).
...
try:
    from .models import BedAllocationsMaster, BedAllocationsItem, BedAllocationsAllocation
except ImportError:
    pass

class BedAllocationsReportGenerator:
    """Generates analytical reports and summary matrices for BedAllocations."""
