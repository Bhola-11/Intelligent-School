"""
Serializers for EduFlow Hostel Bed Allocation & Check-In (BedAllocations).
...
class BedAllocationsMasterSerializer:
    """Serializes BedAllocationsMaster instances to and from JSON/dict structures."""
...
class BedAllocationsItemSerializer:
    @classmethod
...
class BedAllocationsAllocationSerializer:
    @classmethod
...
class BedAllocationsMetricSerializer:
    @classmethod
...
class BedAllocationsPolicyRuleSerializer:
    @classmethod
...
class BedAllocationsSchedulePeriodSerializer:
    @classmethod
...
class BedAllocationsFeedbackReviewSerializer:
    @classmethod
...
class BedAllocationsWorkflowTransitionSerializer:
    @classmethod
...
class BedAllocationsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class BedAllocationsConfigurationParameterSerializer:
    @classmethod
...
class BedAllocationsDocumentAttachmentSerializer:
    @classmethod
...
class BedAllocationsAuditTrailSerializer:
    @classmethod
