"""
Serializers for EduFlow Admission Offers & Student Account Provisioning (EnrollmentOffer).
...
class EnrollmentOfferMasterSerializer:
    """Serializes EnrollmentOfferMaster instances to and from JSON/dict structures."""
...
class EnrollmentOfferItemSerializer:
    @classmethod
...
class EnrollmentOfferAllocationSerializer:
    @classmethod
...
class EnrollmentOfferMetricSerializer:
    @classmethod
...
class EnrollmentOfferPolicyRuleSerializer:
    @classmethod
...
class EnrollmentOfferSchedulePeriodSerializer:
    @classmethod
...
class EnrollmentOfferFeedbackReviewSerializer:
    @classmethod
...
class EnrollmentOfferWorkflowTransitionSerializer:
    @classmethod
...
class EnrollmentOfferAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class EnrollmentOfferConfigurationParameterSerializer:
    @classmethod
...
class EnrollmentOfferDocumentAttachmentSerializer:
    @classmethod
...
class EnrollmentOfferAuditTrailSerializer:
    @classmethod
