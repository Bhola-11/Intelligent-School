"""
Domain Validators for EduFlow Admissions Entrance Exams & Interviews (EntranceExam).
...
class EntranceExamValidator:
    """Domain validator implementing enterprise business rules for EntranceExam."""
