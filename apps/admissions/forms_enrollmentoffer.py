"""
Forms for EduFlow Admission Offers & Student Account Provisioning (EnrollmentOffer).
...
class EnrollmentOfferMasterForm(forms.ModelForm):
    """Primary form for creating and updating EnrollmentOffer master records."""
    class Meta:
        try:
            model = EnrollmentOfferMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ENRO-001'}),
...
class EnrollmentOfferItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = EnrollmentOfferItem
...
class EnrollmentOfferAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = EnrollmentOfferAllocation
...
class EnrollmentOfferMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = EnrollmentOfferMetricRecord
...
class EnrollmentOfferPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = EnrollmentOfferPolicyRule
...
class EnrollmentOfferSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = EnrollmentOfferSchedulePeriod
...
class EnrollmentOfferFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = EnrollmentOfferFeedbackReview
...
class EnrollmentOfferWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = EnrollmentOfferWorkflowTransition
...
class EnrollmentOfferAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = EnrollmentOfferAccessRule
...
class EnrollmentOfferConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = EnrollmentOfferConfigurationParameter
...
class EnrollmentOfferDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = EnrollmentOfferDocumentAttachment
...
class EnrollmentOfferFilterForm(forms.Form):
...
class EnrollmentOfferBulkActionForm(forms.Form):
