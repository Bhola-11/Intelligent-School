"""
Operational Reporting Engine for EduFlow Admission Offers & Student Account Provisioning (EnrollmentOffer).
...
try:
    from .models import EnrollmentOfferMaster, EnrollmentOfferItem, EnrollmentOfferAllocation
except ImportError:
    pass

class EnrollmentOfferReportGenerator:
    """Generates analytical reports and summary matrices for EnrollmentOffer."""
