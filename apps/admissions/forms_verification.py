"""
Forms for EduFlow Admissions Document Verification Desk (Verification).
...
class VerificationMasterForm(forms.ModelForm):
    """Primary form for creating and updating Verification master records."""
    class Meta:
        try:
            model = VerificationMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. VERI-001'}),
...
class VerificationItemForm(forms.ModelForm):
...
class VerificationAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = VerificationAllocation
...
class VerificationMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = VerificationMetricRecord
...
class VerificationPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = VerificationPolicyRule
...
class VerificationSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = VerificationSchedulePeriod
...
class VerificationFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = VerificationFeedbackReview
...
class VerificationWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = VerificationWorkflowTransition
...
class VerificationAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = VerificationAccessRule
...
class VerificationConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = VerificationConfigurationParameter
...
class VerificationDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = VerificationDocumentAttachment
...
class VerificationBulkActionForm(forms.Form):
