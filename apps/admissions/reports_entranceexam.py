"""
Operational Reporting Engine for EduFlow Admissions Entrance Exams & Interviews (EntranceExam).
...
try:
    from .models import EntranceExamMaster, EntranceExamItem, EntranceExamAllocation
except ImportError:
    pass

class EntranceExamReportGenerator:
    """Generates analytical reports and summary matrices for EntranceExam."""
