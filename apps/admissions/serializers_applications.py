"""
Serializers for EduFlow Online Admissions Application Pipeline (Applications).
...
class ApplicationsMasterSerializer:
    """Serializes ApplicationsMaster instances to and from JSON/dict structures."""
...
class ApplicationsItemSerializer:
    @classmethod
...
class ApplicationsAllocationSerializer:
    @classmethod
...
class ApplicationsMetricSerializer:
    @classmethod
...
class ApplicationsPolicyRuleSerializer:
    @classmethod
...
class ApplicationsSchedulePeriodSerializer:
    @classmethod
...
class ApplicationsFeedbackReviewSerializer:
    @classmethod
...
class ApplicationsWorkflowTransitionSerializer:
    @classmethod
...
class ApplicationsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ApplicationsConfigurationParameterSerializer:
    @classmethod
...
class ApplicationsDocumentAttachmentSerializer:
    @classmethod
...
class ApplicationsAuditTrailSerializer:
    @classmethod
