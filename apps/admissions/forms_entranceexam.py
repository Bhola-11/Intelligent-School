"""
Forms for EduFlow Admissions Entrance Exams & Interviews (EntranceExam).
...
class EntranceExamMasterForm(forms.ModelForm):
    """Primary form for creating and updating EntranceExam master records."""
    class Meta:
        try:
            model = EntranceExamMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ENTR-001'}),
...
class EntranceExamItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = EntranceExamItem
...
class EntranceExamAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = EntranceExamAllocation
...
class EntranceExamMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = EntranceExamMetricRecord
...
class EntranceExamPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = EntranceExamPolicyRule
...
class EntranceExamSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = EntranceExamSchedulePeriod
...
class EntranceExamFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = EntranceExamFeedbackReview
...
class EntranceExamWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = EntranceExamWorkflowTransition
...
class EntranceExamAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = EntranceExamAccessRule
...
class EntranceExamConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = EntranceExamConfigurationParameter
...
class EntranceExamDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = EntranceExamDocumentAttachment
...
class EntranceExamFilterForm(forms.Form):
...
class EntranceExamBulkActionForm(forms.Form):
