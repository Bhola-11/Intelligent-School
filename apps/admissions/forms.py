"""
Forms for EduFlow Online Admissions Application Pipeline (Applications).
...
class ApplicationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Applications master records."""
    class Meta:
        try:
            model = ApplicationsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. APPL-001'}),
...
class ApplicationsItemForm(forms.ModelForm):
...
class ApplicationsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ApplicationsAllocation
...
class ApplicationsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ApplicationsMetricRecord
...
class ApplicationsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ApplicationsPolicyRule
...
class ApplicationsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ApplicationsSchedulePeriod
...
class ApplicationsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ApplicationsFeedbackReview
...
class ApplicationsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ApplicationsWorkflowTransition
...
class ApplicationsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ApplicationsAccessRule
...
class ApplicationsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ApplicationsConfigurationParameter
...
class ApplicationsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ApplicationsDocumentAttachment
...
class ApplicationsBulkActionForm(forms.Form):
