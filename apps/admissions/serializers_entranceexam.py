"""
Serializers for EduFlow Admissions Entrance Exams & Interviews (EntranceExam).
...
class EntranceExamMasterSerializer:
    """Serializes EntranceExamMaster instances to and from JSON/dict structures."""
...
class EntranceExamItemSerializer:
    @classmethod
...
class EntranceExamAllocationSerializer:
    @classmethod
...
class EntranceExamMetricSerializer:
    @classmethod
...
class EntranceExamPolicyRuleSerializer:
    @classmethod
...
class EntranceExamSchedulePeriodSerializer:
    @classmethod
...
class EntranceExamFeedbackReviewSerializer:
    @classmethod
...
class EntranceExamWorkflowTransitionSerializer:
    @classmethod
...
class EntranceExamAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class EntranceExamConfigurationParameterSerializer:
    @classmethod
...
class EntranceExamDocumentAttachmentSerializer:
    @classmethod
...
class EntranceExamAuditTrailSerializer:
    @classmethod
