"""
Serializers for EduFlow Admissions Document Verification Desk (Verification).
...
class VerificationMasterSerializer:
    """Serializes VerificationMaster instances to and from JSON/dict structures."""
...
class VerificationItemSerializer:
    @classmethod
...
class VerificationAllocationSerializer:
    @classmethod
...
class VerificationMetricSerializer:
    @classmethod
...
class VerificationPolicyRuleSerializer:
    @classmethod
...
class VerificationSchedulePeriodSerializer:
    @classmethod
...
class VerificationFeedbackReviewSerializer:
    @classmethod
...
class VerificationWorkflowTransitionSerializer:
    @classmethod
...
class VerificationAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class VerificationConfigurationParameterSerializer:
    @classmethod
...
class VerificationDocumentAttachmentSerializer:
    @classmethod
...
class VerificationAuditTrailSerializer:
    @classmethod
