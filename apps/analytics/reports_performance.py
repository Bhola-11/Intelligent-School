"""
Operational Reporting Engine for EduFlow Student Academic Performance Trends (Performance).
...
try:
    from .models import PerformanceMaster, PerformanceItem, PerformanceAllocation
except ImportError:
    pass

class PerformanceReportGenerator:
    """Generates analytical reports and summary matrices for Performance."""
