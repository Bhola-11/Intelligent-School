"""
Forms for EduFlow Student Academic Performance Trends (Performance).
...
class PerformanceMasterForm(forms.ModelForm):
    """Primary form for creating and updating Performance master records."""
    class Meta:
        try:
            model = PerformanceMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PERF-001'}),
...
class PerformanceItemForm(forms.ModelForm):
...
class PerformanceAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = PerformanceAllocation
...
class PerformanceMetricRecordForm(forms.ModelForm):
...
class PerformancePolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = PerformancePolicyRule
...
class PerformanceSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = PerformanceSchedulePeriod
...
class PerformanceFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = PerformanceFeedbackReview
...
class PerformanceWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = PerformanceWorkflowTransition
...
class PerformanceAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = PerformanceAccessRule
...
class PerformanceConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = PerformanceConfigurationParameter
...
class PerformanceDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = PerformanceDocumentAttachment
...
class PerformanceBulkActionForm(forms.Form):
