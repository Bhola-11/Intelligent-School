"""
Domain Validators for EduFlow Institutional KPI & Executive Metrics (InstitutionKPI).
...
class InstitutionKPIValidator:
    """Domain validator implementing enterprise business rules for InstitutionKPI."""
