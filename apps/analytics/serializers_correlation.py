"""
Serializers for EduFlow Attendance Correlation & At-Risk Predictor (Correlation).
...
class CorrelationMasterSerializer:
    """Serializes CorrelationMaster instances to and from JSON/dict structures."""
...
class CorrelationItemSerializer:
    @classmethod
...
class CorrelationAllocationSerializer:
    @classmethod
...
class CorrelationMetricSerializer:
    @classmethod
...
class CorrelationPolicyRuleSerializer:
    @classmethod
...
class CorrelationSchedulePeriodSerializer:
    @classmethod
...
class CorrelationFeedbackReviewSerializer:
    @classmethod
...
class CorrelationWorkflowTransitionSerializer:
    @classmethod
...
class CorrelationAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CorrelationConfigurationParameterSerializer:
    @classmethod
...
class CorrelationDocumentAttachmentSerializer:
    @classmethod
...
class CorrelationAuditTrailSerializer:
    @classmethod
