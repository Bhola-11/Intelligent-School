"""
Serializers for EduFlow Institutional KPI & Executive Metrics (InstitutionKPI).
...
class InstitutionKPIMasterSerializer:
    """Serializes InstitutionKPIMaster instances to and from JSON/dict structures."""
...
class InstitutionKPIItemSerializer:
    @classmethod
...
class InstitutionKPIAllocationSerializer:
    @classmethod
...
class InstitutionKPIMetricSerializer:
    @classmethod
...
class InstitutionKPIPolicyRuleSerializer:
    @classmethod
...
class InstitutionKPISchedulePeriodSerializer:
    @classmethod
...
class InstitutionKPIFeedbackReviewSerializer:
    @classmethod
...
class InstitutionKPIWorkflowTransitionSerializer:
    @classmethod
...
class InstitutionKPIAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class InstitutionKPIConfigurationParameterSerializer:
    @classmethod
...
class InstitutionKPIDocumentAttachmentSerializer:
    @classmethod
...
class InstitutionKPIAuditTrailSerializer:
    @classmethod
