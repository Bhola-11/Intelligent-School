"""
Operational Reporting Engine for EduFlow Institutional KPI & Executive Metrics (InstitutionKPI).
...
try:
    from .models import InstitutionKPIMaster, InstitutionKPIItem, InstitutionKPIAllocation
except ImportError:
    pass

class InstitutionKPIReportGenerator:
    """Generates analytical reports and summary matrices for InstitutionKPI."""
