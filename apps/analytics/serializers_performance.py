"""
Serializers for EduFlow Student Academic Performance Trends (Performance).
...
class PerformanceMasterSerializer:
    """Serializes PerformanceMaster instances to and from JSON/dict structures."""
...
class PerformanceItemSerializer:
    @classmethod
...
class PerformanceAllocationSerializer:
    @classmethod
...
class PerformancePolicyRuleSerializer:
    @classmethod
...
class PerformanceSchedulePeriodSerializer:
    @classmethod
...
class PerformanceFeedbackReviewSerializer:
    @classmethod
...
class PerformanceWorkflowTransitionSerializer:
    @classmethod
...
class PerformanceAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class PerformanceConfigurationParameterSerializer:
    @classmethod
...
class PerformanceDocumentAttachmentSerializer:
    @classmethod
...
class PerformanceAuditTrailSerializer:
    @classmethod
