"""Django Admin configuration for EduFlow Attendance Correlation & At-Risk Predictor (Correlation)."""
...
if 'CorrelationMaster' in globals():
    @admin.register(CorrelationMaster)
    class CorrelationMasterAdmin(admin.ModelAdmin):
...
if 'CorrelationItem' in globals():
    @admin.register(CorrelationItem)
    class CorrelationItemAdmin(admin.ModelAdmin):
...
if 'CorrelationAllocation' in globals():
    @admin.register(CorrelationAllocation)
    class CorrelationAllocationAdmin(admin.ModelAdmin):
...
if 'CorrelationMetricRecord' in globals():
    @admin.register(CorrelationMetricRecord)
    class CorrelationMetricRecordAdmin(admin.ModelAdmin):
...
if 'CorrelationPolicyRule' in globals():
    @admin.register(CorrelationPolicyRule)
    class CorrelationPolicyRuleAdmin(admin.ModelAdmin):
...
if 'CorrelationSchedulePeriod' in globals():
    @admin.register(CorrelationSchedulePeriod)
    class CorrelationSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'CorrelationFeedbackReview' in globals():
    @admin.register(CorrelationFeedbackReview)
    class CorrelationFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'CorrelationWorkflowTransition' in globals():
    @admin.register(CorrelationWorkflowTransition)
    class CorrelationWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'CorrelationAccessRule' in globals():
    @admin.register(CorrelationAccessRule)
    class CorrelationAccessRuleAdmin(admin.ModelAdmin):
...
if 'CorrelationConfigurationParameter' in globals():
    @admin.register(CorrelationConfigurationParameter)
    class CorrelationConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'CorrelationDocumentAttachment' in globals():
    @admin.register(CorrelationDocumentAttachment)
    class CorrelationDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'CorrelationAuditTrail' in globals():
    @admin.register(CorrelationAuditTrail)
    class CorrelationAuditTrailAdmin(admin.ModelAdmin):
