"""
Serializers for EduFlow Chart of Accounts & Financial Ledger (ChartOfAccounts).
...
class ChartOfAccountsMasterSerializer:
    """Serializes ChartOfAccountsMaster instances to and from JSON/dict structures."""
...
class ChartOfAccountsItemSerializer:
    @classmethod
...
class ChartOfAccountsAllocationSerializer:
    @classmethod
...
class ChartOfAccountsMetricSerializer:
    @classmethod
...
class ChartOfAccountsPolicyRuleSerializer:
    @classmethod
...
class ChartOfAccountsSchedulePeriodSerializer:
    @classmethod
...
class ChartOfAccountsFeedbackReviewSerializer:
    @classmethod
...
class ChartOfAccountsWorkflowTransitionSerializer:
    @classmethod
...
class ChartOfAccountsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ChartOfAccountsConfigurationParameterSerializer:
    @classmethod
...
class ChartOfAccountsDocumentAttachmentSerializer:
    @classmethod
...
class ChartOfAccountsAuditTrailSerializer:
    @classmethod
