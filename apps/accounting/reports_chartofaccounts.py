"""
Operational Reporting Engine for EduFlow Chart of Accounts & Financial Ledger (ChartOfAccounts).
...
try:
    from .models import ChartOfAccountsMaster, ChartOfAccountsItem, ChartOfAccountsAllocation
except ImportError:
    pass

class ChartOfAccountsReportGenerator:
    """Generates analytical reports and summary matrices for ChartOfAccounts."""
