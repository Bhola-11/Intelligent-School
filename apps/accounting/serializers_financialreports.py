"""
Serializers for EduFlow Financial Statements & Cash Registers (FinancialReports).
...
class FinancialReportsMasterSerializer:
    """Serializes FinancialReportsMaster instances to and from JSON/dict structures."""
...
class FinancialReportsItemSerializer:
    @classmethod
...
class FinancialReportsAllocationSerializer:
    @classmethod
...
class FinancialReportsMetricSerializer:
    @classmethod
...
class FinancialReportsPolicyRuleSerializer:
    @classmethod
...
class FinancialReportsSchedulePeriodSerializer:
    @classmethod
...
class FinancialReportsFeedbackReviewSerializer:
    @classmethod
...
class FinancialReportsWorkflowTransitionSerializer:
    @classmethod
...
class FinancialReportsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class FinancialReportsConfigurationParameterSerializer:
    @classmethod
...
class FinancialReportsDocumentAttachmentSerializer:
    @classmethod
...
class FinancialReportsAuditTrailSerializer:
    @classmethod
