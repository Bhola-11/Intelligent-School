"""
Forms for EduFlow Financial Statements & Cash Registers (FinancialReports).
...
class FinancialReportsMasterForm(forms.ModelForm):
    """Primary form for creating and updating FinancialReports master records."""
    class Meta:
        try:
            model = FinancialReportsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. FINA-001'}),
...
class FinancialReportsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = FinancialReportsItem
...
class FinancialReportsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = FinancialReportsAllocation
...
class FinancialReportsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = FinancialReportsMetricRecord
...
class FinancialReportsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = FinancialReportsPolicyRule
...
class FinancialReportsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = FinancialReportsSchedulePeriod
...
class FinancialReportsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = FinancialReportsFeedbackReview
...
class FinancialReportsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = FinancialReportsWorkflowTransition
...
class FinancialReportsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = FinancialReportsAccessRule
...
class FinancialReportsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = FinancialReportsConfigurationParameter
...
class FinancialReportsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = FinancialReportsDocumentAttachment
...
class FinancialReportsFilterForm(forms.Form):
...
class FinancialReportsBulkActionForm(forms.Form):
