"""
Serializers for EduFlow General Ledger & Double-Entry Journals (GeneralLedger).
...
class GeneralLedgerMasterSerializer:
    """Serializes GeneralLedgerMaster instances to and from JSON/dict structures."""
...
class GeneralLedgerItemSerializer:
    @classmethod
...
class GeneralLedgerAllocationSerializer:
    @classmethod
...
class GeneralLedgerMetricSerializer:
    @classmethod
...
class GeneralLedgerPolicyRuleSerializer:
    @classmethod
...
class GeneralLedgerSchedulePeriodSerializer:
    @classmethod
...
class GeneralLedgerFeedbackReviewSerializer:
    @classmethod
...
class GeneralLedgerWorkflowTransitionSerializer:
    @classmethod
...
class GeneralLedgerAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class GeneralLedgerConfigurationParameterSerializer:
    @classmethod
...
class GeneralLedgerDocumentAttachmentSerializer:
    @classmethod
...
class GeneralLedgerAuditTrailSerializer:
    @classmethod
