"""
Forms for EduFlow General Ledger & Double-Entry Journals (GeneralLedger).
...
class GeneralLedgerMasterForm(forms.ModelForm):
    """Primary form for creating and updating GeneralLedger master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. GENE-001'}),
...
class GeneralLedgerItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = GeneralLedgerItem
...
class GeneralLedgerAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = GeneralLedgerAllocation
...
class GeneralLedgerMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = GeneralLedgerMetricRecord
...
class GeneralLedgerPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = GeneralLedgerPolicyRule
...
class GeneralLedgerSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = GeneralLedgerSchedulePeriod
...
class GeneralLedgerFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = GeneralLedgerFeedbackReview
...
class GeneralLedgerWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = GeneralLedgerWorkflowTransition
...
class GeneralLedgerAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = GeneralLedgerAccessRule
...
class GeneralLedgerConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = GeneralLedgerConfigurationParameter
...
class GeneralLedgerDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = GeneralLedgerDocumentAttachment
...
class GeneralLedgerBulkActionForm(forms.Form):
