"""
Domain Validators for EduFlow Chart of Accounts & Financial Ledger (ChartOfAccounts).
...
class ChartOfAccountsValidator:
    """Domain validator implementing enterprise business rules for ChartOfAccounts."""
