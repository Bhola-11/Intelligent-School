"""
Domain Validators for EduFlow General Ledger & Double-Entry Journals (GeneralLedger).
...
class GeneralLedgerValidator:
    """Domain validator implementing enterprise business rules for GeneralLedger."""
