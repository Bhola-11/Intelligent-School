"""
Operational Reporting Engine for EduFlow Expense Vouchers & Payment Approvals (Vouchers).
...
try:
    from .models import VouchersMaster, VouchersItem, VouchersAllocation
except ImportError:
    pass

class VouchersReportGenerator:
    """Generates analytical reports and summary matrices for Vouchers."""
