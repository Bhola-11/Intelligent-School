"""
Serializers for EduFlow Expense Vouchers & Payment Approvals (Vouchers).
...
class VouchersMasterSerializer:
    """Serializes VouchersMaster instances to and from JSON/dict structures."""
...
class VouchersAllocationSerializer:
    @classmethod
...
class VouchersMetricSerializer:
    @classmethod
...
class VouchersPolicyRuleSerializer:
    @classmethod
...
class VouchersSchedulePeriodSerializer:
    @classmethod
...
class VouchersFeedbackReviewSerializer:
    @classmethod
...
class VouchersWorkflowTransitionSerializer:
    @classmethod
...
class VouchersAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class VouchersConfigurationParameterSerializer:
    @classmethod
...
class VouchersDocumentAttachmentSerializer:
    @classmethod
...
class VouchersAuditTrailSerializer:
    @classmethod
