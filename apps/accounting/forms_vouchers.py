"""
Forms for EduFlow Expense Vouchers & Payment Approvals (Vouchers).
...
class VouchersMasterForm(forms.ModelForm):
    """Primary form for creating and updating Vouchers master records."""
    class Meta:
        try:
            model = VouchersMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. VOUC-001'}),
...
class VouchersItemForm(forms.ModelForm):
...
class VouchersAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = VouchersAllocation
...
class VouchersMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = VouchersMetricRecord
...
class VouchersPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = VouchersPolicyRule
...
class VouchersSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = VouchersSchedulePeriod
...
class VouchersFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = VouchersFeedbackReview
...
class VouchersWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = VouchersWorkflowTransition
...
class VouchersAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = VouchersAccessRule
...
class VouchersConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = VouchersConfigurationParameter
...
class VouchersDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = VouchersDocumentAttachment
...
class VouchersFilterForm(forms.Form):
...
class VouchersBulkActionForm(forms.Form):
