"""
Forms for EduFlow Chart of Accounts & Financial Ledger (ChartOfAccounts).
...
class ChartOfAccountsMasterForm(forms.ModelForm):
    """Primary form for creating and updating ChartOfAccounts master records."""
    class Meta:
        try:
            model = ChartOfAccountsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. CHAR-001'}),
...
class ChartOfAccountsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ChartOfAccountsItem
...
class ChartOfAccountsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ChartOfAccountsAllocation
...
class ChartOfAccountsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ChartOfAccountsMetricRecord
...
class ChartOfAccountsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ChartOfAccountsPolicyRule
...
class ChartOfAccountsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ChartOfAccountsSchedulePeriod
...
class ChartOfAccountsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ChartOfAccountsFeedbackReview
...
class ChartOfAccountsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ChartOfAccountsWorkflowTransition
...
class ChartOfAccountsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ChartOfAccountsAccessRule
...
class ChartOfAccountsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ChartOfAccountsConfigurationParameter
...
class ChartOfAccountsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ChartOfAccountsDocumentAttachment
...
class ChartOfAccountsBulkActionForm(forms.Form):
