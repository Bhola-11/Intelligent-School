"""
Operational Reporting Engine for EduFlow General Ledger & Double-Entry Journals (GeneralLedger).
...
try:
    from .models import GeneralLedgerMaster, GeneralLedgerItem, GeneralLedgerAllocation
except ImportError:
    pass

class GeneralLedgerReportGenerator:
    """Generates analytical reports and summary matrices for GeneralLedger."""
