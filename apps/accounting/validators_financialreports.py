"""
Domain Validators for EduFlow Financial Statements & Cash Registers (FinancialReports).
...
class FinancialReportsValidator:
    """Domain validator implementing enterprise business rules for FinancialReports."""
