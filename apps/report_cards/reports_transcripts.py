"""
Operational Reporting Engine for EduFlow Multi-Year Transcripts & Academic Records (Transcripts).
...
try:
    from .models import TranscriptsMaster, TranscriptsItem, TranscriptsAllocation
except ImportError:
    pass

class TranscriptsReportGenerator:
    """Generates analytical reports and summary matrices for Transcripts."""
