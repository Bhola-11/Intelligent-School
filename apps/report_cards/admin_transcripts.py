"""Django Admin configuration for EduFlow Multi-Year Transcripts & Academic Records (Transcripts)."""
...
if 'TranscriptsMaster' in globals():
    @admin.register(TranscriptsMaster)
    class TranscriptsMasterAdmin(admin.ModelAdmin):
...
if 'TranscriptsItem' in globals():
    @admin.register(TranscriptsItem)
    class TranscriptsItemAdmin(admin.ModelAdmin):
...
if 'TranscriptsAllocation' in globals():
    @admin.register(TranscriptsAllocation)
    class TranscriptsAllocationAdmin(admin.ModelAdmin):
...
if 'TranscriptsMetricRecord' in globals():
    @admin.register(TranscriptsMetricRecord)
    class TranscriptsMetricRecordAdmin(admin.ModelAdmin):
...
if 'TranscriptsPolicyRule' in globals():
    @admin.register(TranscriptsPolicyRule)
    class TranscriptsPolicyRuleAdmin(admin.ModelAdmin):
...
if 'TranscriptsSchedulePeriod' in globals():
    @admin.register(TranscriptsSchedulePeriod)
    class TranscriptsSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'TranscriptsFeedbackReview' in globals():
    @admin.register(TranscriptsFeedbackReview)
    class TranscriptsFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'TranscriptsWorkflowTransition' in globals():
    @admin.register(TranscriptsWorkflowTransition)
    class TranscriptsWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'TranscriptsAccessRule' in globals():
    @admin.register(TranscriptsAccessRule)
    class TranscriptsAccessRuleAdmin(admin.ModelAdmin):
...
if 'TranscriptsConfigurationParameter' in globals():
    @admin.register(TranscriptsConfigurationParameter)
    class TranscriptsConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'TranscriptsDocumentAttachment' in globals():
    @admin.register(TranscriptsDocumentAttachment)
    class TranscriptsDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'TranscriptsAuditTrail' in globals():
    @admin.register(TranscriptsAuditTrail)
    class TranscriptsAuditTrailAdmin(admin.ModelAdmin):
