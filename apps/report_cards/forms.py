"""
Forms for EduFlow Report Card Custom Templates & Layouts (Templates).
...
class TemplatesMasterForm(forms.ModelForm):
    """Primary form for creating and updating Templates master records."""
    class Meta:
        try:
            model = TemplatesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. TEMP-001'}),
...
class TemplatesItemForm(forms.ModelForm):
...
class TemplatesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = TemplatesAllocation
...
class TemplatesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = TemplatesMetricRecord
...
class TemplatesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = TemplatesPolicyRule
...
class TemplatesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = TemplatesSchedulePeriod
...
class TemplatesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = TemplatesFeedbackReview
...
class TemplatesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = TemplatesWorkflowTransition
...
class TemplatesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = TemplatesAccessRule
...
class TemplatesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = TemplatesConfigurationParameter
...
class TemplatesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = TemplatesDocumentAttachment
...
class TemplatesFilterForm(forms.Form):
...
class TemplatesBulkActionForm(forms.Form):
