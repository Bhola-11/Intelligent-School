"""
Serializers for EduFlow Multi-Year Transcripts & Academic Records (Transcripts).
...
class TranscriptsMasterSerializer:
    """Serializes TranscriptsMaster instances to and from JSON/dict structures."""
...
class TranscriptsItemSerializer:
    @classmethod
...
class TranscriptsAllocationSerializer:
    @classmethod
...
class TranscriptsMetricSerializer:
    @classmethod
...
class TranscriptsPolicyRuleSerializer:
    @classmethod
...
class TranscriptsSchedulePeriodSerializer:
    @classmethod
...
class TranscriptsFeedbackReviewSerializer:
    @classmethod
...
class TranscriptsWorkflowTransitionSerializer:
    @classmethod
...
class TranscriptsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class TranscriptsConfigurationParameterSerializer:
    @classmethod
...
class TranscriptsDocumentAttachmentSerializer:
    @classmethod
...
class TranscriptsAuditTrailSerializer:
    @classmethod
