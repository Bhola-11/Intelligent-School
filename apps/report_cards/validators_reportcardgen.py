"""
Domain Validators for EduFlow Report Cards Generation & Teacher Remarks (ReportCardGen).
...
class ReportCardGenValidator:
    """Domain validator implementing enterprise business rules for ReportCardGen."""
