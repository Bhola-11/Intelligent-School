"""
Serializers for EduFlow Report Cards Generation & Teacher Remarks (ReportCardGen).
...
class ReportCardGenMasterSerializer:
    """Serializes ReportCardGenMaster instances to and from JSON/dict structures."""
...
class ReportCardGenItemSerializer:
    @classmethod
...
class ReportCardGenAllocationSerializer:
    @classmethod
...
class ReportCardGenMetricSerializer:
    @classmethod
...
class ReportCardGenPolicyRuleSerializer:
    @classmethod
...
class ReportCardGenSchedulePeriodSerializer:
    @classmethod
...
class ReportCardGenFeedbackReviewSerializer:
    @classmethod
...
class ReportCardGenWorkflowTransitionSerializer:
    @classmethod
...
class ReportCardGenAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ReportCardGenConfigurationParameterSerializer:
    @classmethod
...
class ReportCardGenDocumentAttachmentSerializer:
    @classmethod
...
class ReportCardGenAuditTrailSerializer:
    @classmethod
