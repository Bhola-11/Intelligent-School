"""
Serializers for EduFlow Report Card Custom Templates & Layouts (Templates).
...
class TemplatesMasterSerializer:
    """Serializes TemplatesMaster instances to and from JSON/dict structures."""
...
class TemplatesAllocationSerializer:
    @classmethod
...
class TemplatesMetricSerializer:
    @classmethod
...
class TemplatesPolicyRuleSerializer:
    @classmethod
...
class TemplatesSchedulePeriodSerializer:
    @classmethod
...
class TemplatesFeedbackReviewSerializer:
    @classmethod
...
class TemplatesWorkflowTransitionSerializer:
    @classmethod
...
class TemplatesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class TemplatesConfigurationParameterSerializer:
    @classmethod
...
class TemplatesDocumentAttachmentSerializer:
    @classmethod
...
class TemplatesAuditTrailSerializer:
    @classmethod
