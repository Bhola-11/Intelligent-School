"""
Forms for EduFlow Report Cards Generation & Teacher Remarks (ReportCardGen).
...
class ReportCardGenMasterForm(forms.ModelForm):
    """Primary form for creating and updating ReportCardGen master records."""
    class Meta:
        try:
            model = ReportCardGenMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. REPO-001'}),
...
class ReportCardGenItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ReportCardGenItem
...
class ReportCardGenAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ReportCardGenAllocation
...
class ReportCardGenMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ReportCardGenMetricRecord
...
class ReportCardGenPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ReportCardGenPolicyRule
...
class ReportCardGenSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ReportCardGenSchedulePeriod
...
class ReportCardGenFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ReportCardGenFeedbackReview
...
class ReportCardGenWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ReportCardGenWorkflowTransition
...
class ReportCardGenAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ReportCardGenAccessRule
...
class ReportCardGenConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ReportCardGenConfigurationParameter
...
class ReportCardGenDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ReportCardGenDocumentAttachment
...
class ReportCardGenFilterForm(forms.Form):
...
class ReportCardGenBulkActionForm(forms.Form):
