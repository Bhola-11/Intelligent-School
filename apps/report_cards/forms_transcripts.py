"""
Forms for EduFlow Multi-Year Transcripts & Academic Records (Transcripts).
...
class TranscriptsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Transcripts master records."""
    class Meta:
        try:
            model = TranscriptsMaster
            fields = [
...
class TranscriptsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = TranscriptsItem
...
class TranscriptsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = TranscriptsAllocation
...
class TranscriptsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = TranscriptsMetricRecord
...
class TranscriptsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = TranscriptsPolicyRule
...
class TranscriptsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = TranscriptsSchedulePeriod
...
class TranscriptsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = TranscriptsFeedbackReview
...
class TranscriptsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = TranscriptsWorkflowTransition
...
class TranscriptsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = TranscriptsAccessRule
...
class TranscriptsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = TranscriptsConfigurationParameter
...
class TranscriptsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = TranscriptsDocumentAttachment
...
class TranscriptsFilterForm(forms.Form):
...
class TranscriptsBulkActionForm(forms.Form):
