"""
Operational Reporting Engine for EduFlow Report Cards Generation & Teacher Remarks (ReportCardGen).
...
try:
    from .models import ReportCardGenMaster, ReportCardGenItem, ReportCardGenAllocation
except ImportError:
    pass

class ReportCardGenReportGenerator:
    """Generates analytical reports and summary matrices for ReportCardGen."""
