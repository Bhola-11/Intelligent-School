"""
Serializers for EduFlow Buildings, Floors, Rooms & Facilities (Facilities).
...
class FacilitiesMasterSerializer:
    """Serializes FacilitiesMaster instances to and from JSON/dict structures."""
...
class FacilitiesItemSerializer:
    @classmethod
...
class FacilitiesAllocationSerializer:
    @classmethod
...
class FacilitiesMetricSerializer:
    @classmethod
...
class FacilitiesPolicyRuleSerializer:
    @classmethod
...
class FacilitiesSchedulePeriodSerializer:
    @classmethod
...
class FacilitiesFeedbackReviewSerializer:
    @classmethod
...
class FacilitiesWorkflowTransitionSerializer:
    @classmethod
...
class FacilitiesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class FacilitiesConfigurationParameterSerializer:
    @classmethod
...
class FacilitiesDocumentAttachmentSerializer:
    @classmethod
...
class FacilitiesAuditTrailSerializer:
    @classmethod
