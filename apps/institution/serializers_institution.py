"""
Serializers for EduFlow Institution Profile & Multi-Campus Architecture (Institution).
...
class InstitutionMasterSerializer:
    """Serializes InstitutionMaster instances to and from JSON/dict structures."""
...
class InstitutionItemSerializer:
    @classmethod
...
class InstitutionAllocationSerializer:
    @classmethod
...
class InstitutionMetricSerializer:
    @classmethod
...
class InstitutionPolicyRuleSerializer:
    @classmethod
...
class InstitutionSchedulePeriodSerializer:
    @classmethod
...
class InstitutionFeedbackReviewSerializer:
    @classmethod
...
class InstitutionWorkflowTransitionSerializer:
    @classmethod
...
class InstitutionAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class InstitutionConfigurationParameterSerializer:
    @classmethod
...
class InstitutionDocumentAttachmentSerializer:
    @classmethod
...
class InstitutionAuditTrailSerializer:
    @classmethod
