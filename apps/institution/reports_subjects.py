"""
Operational Reporting Engine for EduFlow Subjects, Syllabi & Credit Hours (Subjects).
...
try:
    from .models import SubjectsMaster, SubjectsItem, SubjectsAllocation
except ImportError:
    pass

class SubjectsReportGenerator:
    """Generates analytical reports and summary matrices for Subjects."""
