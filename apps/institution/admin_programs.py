"""Django Admin configuration for EduFlow Degree Programs & Course Catalog (Programs)."""
...
if 'ProgramsMaster' in globals():
    @admin.register(ProgramsMaster)
    class ProgramsMasterAdmin(admin.ModelAdmin):
...
if 'ProgramsItem' in globals():
    @admin.register(ProgramsItem)
    class ProgramsItemAdmin(admin.ModelAdmin):
...
if 'ProgramsAllocation' in globals():
    @admin.register(ProgramsAllocation)
    class ProgramsAllocationAdmin(admin.ModelAdmin):
...
if 'ProgramsMetricRecord' in globals():
    @admin.register(ProgramsMetricRecord)
    class ProgramsMetricRecordAdmin(admin.ModelAdmin):
...
if 'ProgramsPolicyRule' in globals():
    @admin.register(ProgramsPolicyRule)
    class ProgramsPolicyRuleAdmin(admin.ModelAdmin):
...
if 'ProgramsSchedulePeriod' in globals():
    @admin.register(ProgramsSchedulePeriod)
    class ProgramsSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'ProgramsFeedbackReview' in globals():
    @admin.register(ProgramsFeedbackReview)
    class ProgramsFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'ProgramsWorkflowTransition' in globals():
    @admin.register(ProgramsWorkflowTransition)
    class ProgramsWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'ProgramsAccessRule' in globals():
    @admin.register(ProgramsAccessRule)
    class ProgramsAccessRuleAdmin(admin.ModelAdmin):
...
if 'ProgramsConfigurationParameter' in globals():
    @admin.register(ProgramsConfigurationParameter)
    class ProgramsConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'ProgramsDocumentAttachment' in globals():
    @admin.register(ProgramsDocumentAttachment)
    class ProgramsDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'ProgramsAuditTrail' in globals():
    @admin.register(ProgramsAuditTrail)
    class ProgramsAuditTrailAdmin(admin.ModelAdmin):
