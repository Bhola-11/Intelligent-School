"""
Forms for EduFlow Subjects, Syllabi & Credit Hours (Subjects).
...
class SubjectsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Subjects master records."""
    class Meta:
        try:
            model = SubjectsMaster
            fields = [
...
class SubjectsItemForm(forms.ModelForm):
...
class SubjectsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = SubjectsAllocation
...
class SubjectsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = SubjectsMetricRecord
...
class SubjectsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = SubjectsPolicyRule
...
class SubjectsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = SubjectsSchedulePeriod
...
class SubjectsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = SubjectsFeedbackReview
...
class SubjectsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = SubjectsWorkflowTransition
...
class SubjectsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = SubjectsAccessRule
...
class SubjectsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = SubjectsConfigurationParameter
...
class SubjectsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = SubjectsDocumentAttachment
...
class SubjectsFilterForm(forms.Form):
...
class SubjectsBulkActionForm(forms.Form):
