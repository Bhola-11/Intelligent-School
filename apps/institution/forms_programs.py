"""
Forms for EduFlow Degree Programs & Course Catalog (Programs).
...
class ProgramsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Programs master records."""
    class Meta:
        try:
            model = ProgramsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PROG-001'}),
...
class ProgramsItemForm(forms.ModelForm):
...
class ProgramsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ProgramsAllocation
...
class ProgramsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ProgramsMetricRecord
...
class ProgramsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ProgramsPolicyRule
...
class ProgramsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ProgramsSchedulePeriod
...
class ProgramsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ProgramsFeedbackReview
...
class ProgramsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ProgramsWorkflowTransition
...
class ProgramsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ProgramsAccessRule
...
class ProgramsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ProgramsConfigurationParameter
...
class ProgramsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ProgramsDocumentAttachment
...
class ProgramsFilterForm(forms.Form):
...
class ProgramsBulkActionForm(forms.Form):
