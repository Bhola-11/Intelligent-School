"""
Forms for EduFlow Institution Profile & Multi-Campus Architecture (Institution).
...
class InstitutionMasterForm(forms.ModelForm):
    """Primary form for creating and updating Institution master records."""
    class Meta:
        try:
...
class InstitutionItemForm(forms.ModelForm):
...
class InstitutionAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = InstitutionAllocation
...
class InstitutionMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = InstitutionMetricRecord
...
class InstitutionPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = InstitutionPolicyRule
...
class InstitutionSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = InstitutionSchedulePeriod
...
class InstitutionFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = InstitutionFeedbackReview
...
class InstitutionWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = InstitutionWorkflowTransition
...
class InstitutionAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = InstitutionAccessRule
...
class InstitutionConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = InstitutionConfigurationParameter
...
class InstitutionDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = InstitutionDocumentAttachment
...
class InstitutionBulkActionForm(forms.Form):
