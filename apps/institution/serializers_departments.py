"""
Serializers for EduFlow Academic Departments & Faculties (Departments).
...
class DepartmentsMasterSerializer:
    """Serializes DepartmentsMaster instances to and from JSON/dict structures."""
...
class DepartmentsItemSerializer:
    @classmethod
...
class DepartmentsAllocationSerializer:
    @classmethod
...
class DepartmentsMetricSerializer:
    @classmethod
...
class DepartmentsPolicyRuleSerializer:
    @classmethod
...
class DepartmentsSchedulePeriodSerializer:
    @classmethod
...
class DepartmentsFeedbackReviewSerializer:
    @classmethod
...
class DepartmentsWorkflowTransitionSerializer:
    @classmethod
...
class DepartmentsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class DepartmentsConfigurationParameterSerializer:
    @classmethod
...
class DepartmentsDocumentAttachmentSerializer:
    @classmethod
...
class DepartmentsAuditTrailSerializer:
    @classmethod
