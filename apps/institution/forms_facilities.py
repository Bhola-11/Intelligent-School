"""
Forms for EduFlow Buildings, Floors, Rooms & Facilities (Facilities).
...
class FacilitiesMasterForm(forms.ModelForm):
    """Primary form for creating and updating Facilities master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. FACI-001'}),
...
class FacilitiesItemForm(forms.ModelForm):
...
class FacilitiesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = FacilitiesAllocation
...
class FacilitiesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = FacilitiesMetricRecord
...
class FacilitiesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = FacilitiesPolicyRule
...
class FacilitiesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = FacilitiesSchedulePeriod
...
class FacilitiesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = FacilitiesFeedbackReview
...
class FacilitiesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = FacilitiesWorkflowTransition
...
class FacilitiesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = FacilitiesAccessRule
...
class FacilitiesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = FacilitiesConfigurationParameter
...
class FacilitiesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = FacilitiesDocumentAttachment
...
class FacilitiesFilterForm(forms.Form):
...
class FacilitiesBulkActionForm(forms.Form):
