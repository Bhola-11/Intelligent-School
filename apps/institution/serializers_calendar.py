"""
Serializers for EduFlow Academic Calendar, Terms & Semesters (Calendar).
...
class CalendarMasterSerializer:
    """Serializes CalendarMaster instances to and from JSON/dict structures."""
...
class CalendarAllocationSerializer:
    @classmethod
...
class CalendarMetricSerializer:
    @classmethod
...
class CalendarPolicyRuleSerializer:
    @classmethod
...
class CalendarSchedulePeriodSerializer:
    @classmethod
...
class CalendarFeedbackReviewSerializer:
    @classmethod
...
class CalendarWorkflowTransitionSerializer:
    @classmethod
...
class CalendarAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CalendarConfigurationParameterSerializer:
    @classmethod
...
class CalendarDocumentAttachmentSerializer:
    @classmethod
...
class CalendarAuditTrailSerializer:
    @classmethod
