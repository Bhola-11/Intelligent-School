"""
Serializers for EduFlow Degree Programs & Course Catalog (Programs).
...
class ProgramsMasterSerializer:
    """Serializes ProgramsMaster instances to and from JSON/dict structures."""
...
class ProgramsAllocationSerializer:
    @classmethod
...
class ProgramsMetricSerializer:
    @classmethod
...
class ProgramsPolicyRuleSerializer:
    @classmethod
...
class ProgramsSchedulePeriodSerializer:
    @classmethod
...
class ProgramsFeedbackReviewSerializer:
    @classmethod
...
class ProgramsWorkflowTransitionSerializer:
    @classmethod
...
class ProgramsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ProgramsConfigurationParameterSerializer:
    @classmethod
...
class ProgramsDocumentAttachmentSerializer:
    @classmethod
...
class ProgramsAuditTrailSerializer:
    @classmethod
