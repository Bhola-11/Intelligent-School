"""
Serializers for EduFlow Class Levels, Sections & Batches (Classes).
...
class ClassesMasterSerializer:
    """Serializes ClassesMaster instances to and from JSON/dict structures."""
...
class ClassesAllocationSerializer:
    @classmethod
...
class ClassesPolicyRuleSerializer:
    @classmethod
...
class ClassesSchedulePeriodSerializer:
    @classmethod
...
class ClassesFeedbackReviewSerializer:
    @classmethod
...
class ClassesWorkflowTransitionSerializer:
    @classmethod
...
class ClassesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ClassesConfigurationParameterSerializer:
    @classmethod
...
class ClassesDocumentAttachmentSerializer:
    @classmethod
...
class ClassesAuditTrailSerializer:
    @classmethod
