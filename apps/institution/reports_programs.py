"""
Operational Reporting Engine for EduFlow Degree Programs & Course Catalog (Programs).
...
try:
    from .models import ProgramsMaster, ProgramsItem, ProgramsAllocation
except ImportError:
    pass

class ProgramsReportGenerator:
    """Generates analytical reports and summary matrices for Programs."""
