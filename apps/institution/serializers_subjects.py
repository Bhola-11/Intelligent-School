"""
Serializers for EduFlow Subjects, Syllabi & Credit Hours (Subjects).
...
class SubjectsMasterSerializer:
    """Serializes SubjectsMaster instances to and from JSON/dict structures."""
...
class SubjectsAllocationSerializer:
    @classmethod
...
class SubjectsMetricSerializer:
    @classmethod
...
class SubjectsPolicyRuleSerializer:
    @classmethod
...
class SubjectsSchedulePeriodSerializer:
    @classmethod
...
class SubjectsFeedbackReviewSerializer:
    @classmethod
...
class SubjectsWorkflowTransitionSerializer:
    @classmethod
...
class SubjectsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class SubjectsConfigurationParameterSerializer:
    @classmethod
...
class SubjectsDocumentAttachmentSerializer:
    @classmethod
...
class SubjectsAuditTrailSerializer:
    @classmethod
