"""
Forms for EduFlow Academic Calendar, Terms & Semesters (Calendar).
...
class CalendarMasterForm(forms.ModelForm):
    """Primary form for creating and updating Calendar master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. CALE-001'}),
...
class CalendarAllocationForm(forms.ModelForm):
...
class CalendarMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = CalendarMetricRecord
...
class CalendarPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = CalendarPolicyRule
...
class CalendarSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = CalendarSchedulePeriod
...
class CalendarFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = CalendarFeedbackReview
...
class CalendarWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = CalendarWorkflowTransition
...
class CalendarAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = CalendarAccessRule
...
class CalendarConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = CalendarConfigurationParameter
...
class CalendarDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = CalendarDocumentAttachment
...
class CalendarBulkActionForm(forms.Form):
