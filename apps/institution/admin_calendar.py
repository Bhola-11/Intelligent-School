"""Django Admin configuration for EduFlow Academic Calendar, Terms & Semesters (Calendar)."""
...
if 'CalendarMaster' in globals():
    ...
    class CalendarMasterAdmin(admin.ModelAdmin):
...
if 'CalendarAllocation' in globals():
    @admin.register(CalendarAllocation)
    class CalendarAllocationAdmin(admin.ModelAdmin):
...
if 'CalendarMetricRecord' in globals():
    @admin.register(CalendarMetricRecord)
    class CalendarMetricRecordAdmin(admin.ModelAdmin):
...
if 'CalendarPolicyRule' in globals():
    @admin.register(CalendarPolicyRule)
    class CalendarPolicyRuleAdmin(admin.ModelAdmin):
...
if 'CalendarSchedulePeriod' in globals():
    @admin.register(CalendarSchedulePeriod)
    class CalendarSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'CalendarFeedbackReview' in globals():
    @admin.register(CalendarFeedbackReview)
    class CalendarFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'CalendarWorkflowTransition' in globals():
    @admin.register(CalendarWorkflowTransition)
    class CalendarWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'CalendarAccessRule' in globals():
    @admin.register(CalendarAccessRule)
    class CalendarAccessRuleAdmin(admin.ModelAdmin):
...
if 'CalendarConfigurationParameter' in globals():
    @admin.register(CalendarConfigurationParameter)
    class CalendarConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'CalendarDocumentAttachment' in globals():
    @admin.register(CalendarDocumentAttachment)
    class CalendarDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'CalendarAuditTrail' in globals():
    @admin.register(CalendarAuditTrail)
    class CalendarAuditTrailAdmin(admin.ModelAdmin):
