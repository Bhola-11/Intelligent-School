"""
Serializers for EduFlow Transport Routes, Stops & Timings (Routes).
...
class RoutesMasterSerializer:
    """Serializes RoutesMaster instances to and from JSON/dict structures."""
...
class RoutesAllocationSerializer:
    @classmethod
...
class RoutesPolicyRuleSerializer:
    @classmethod
...
class RoutesSchedulePeriodSerializer:
    @classmethod
...
class RoutesFeedbackReviewSerializer:
    @classmethod
...
class RoutesWorkflowTransitionSerializer:
    @classmethod
...
class RoutesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class RoutesConfigurationParameterSerializer:
    @classmethod
...
class RoutesDocumentAttachmentSerializer:
    @classmethod
...
class RoutesAuditTrailSerializer:
    @classmethod
