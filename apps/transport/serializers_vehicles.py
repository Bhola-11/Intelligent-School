"""
Serializers for EduFlow Vehicles, Drivers & Fleet Maintenance (Vehicles).
...
class VehiclesMasterSerializer:
    """Serializes VehiclesMaster instances to and from JSON/dict structures."""
...
class VehiclesAllocationSerializer:
    @classmethod
...
class VehiclesMetricSerializer:
    @classmethod
...
class VehiclesPolicyRuleSerializer:
    @classmethod
...
class VehiclesSchedulePeriodSerializer:
    @classmethod
...
class VehiclesFeedbackReviewSerializer:
    @classmethod
...
class VehiclesWorkflowTransitionSerializer:
    @classmethod
...
class VehiclesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class VehiclesConfigurationParameterSerializer:
    @classmethod
...
class VehiclesDocumentAttachmentSerializer:
    @classmethod
...
class VehiclesAuditTrailSerializer:
    @classmethod
