"""Django Admin configuration for EduFlow Student Transport Subscriptions & Fees (TransportSubs)."""
...
if 'TransportSubsMaster' in globals():
    @admin.register(TransportSubsMaster)
    class TransportSubsMasterAdmin(admin.ModelAdmin):
...
if 'TransportSubsItem' in globals():
    @admin.register(TransportSubsItem)
    class TransportSubsItemAdmin(admin.ModelAdmin):
...
if 'TransportSubsAllocation' in globals():
    @admin.register(TransportSubsAllocation)
    class TransportSubsAllocationAdmin(admin.ModelAdmin):
...
if 'TransportSubsMetricRecord' in globals():
    @admin.register(TransportSubsMetricRecord)
    class TransportSubsMetricRecordAdmin(admin.ModelAdmin):
...
if 'TransportSubsPolicyRule' in globals():
    @admin.register(TransportSubsPolicyRule)
    class TransportSubsPolicyRuleAdmin(admin.ModelAdmin):
...
if 'TransportSubsSchedulePeriod' in globals():
    @admin.register(TransportSubsSchedulePeriod)
    class TransportSubsSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'TransportSubsFeedbackReview' in globals():
    @admin.register(TransportSubsFeedbackReview)
    class TransportSubsFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'TransportSubsWorkflowTransition' in globals():
    @admin.register(TransportSubsWorkflowTransition)
    class TransportSubsWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'TransportSubsAccessRule' in globals():
    @admin.register(TransportSubsAccessRule)
    class TransportSubsAccessRuleAdmin(admin.ModelAdmin):
...
if 'TransportSubsConfigurationParameter' in globals():
    @admin.register(TransportSubsConfigurationParameter)
    class TransportSubsConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'TransportSubsDocumentAttachment' in globals():
    @admin.register(TransportSubsDocumentAttachment)
    class TransportSubsDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'TransportSubsAuditTrail' in globals():
    @admin.register(TransportSubsAuditTrail)
    class TransportSubsAuditTrailAdmin(admin.ModelAdmin):
