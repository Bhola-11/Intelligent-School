"""
Forms for EduFlow Vehicles, Drivers & Fleet Maintenance (Vehicles).
...
class VehiclesMasterForm(forms.ModelForm):
    """Primary form for creating and updating Vehicles master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. VEHI-001'}),
...
class VehiclesItemForm(forms.ModelForm):
...
class VehiclesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = VehiclesAllocation
...
class VehiclesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = VehiclesMetricRecord
...
class VehiclesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = VehiclesPolicyRule
...
class VehiclesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = VehiclesSchedulePeriod
...
class VehiclesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = VehiclesFeedbackReview
...
class VehiclesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = VehiclesWorkflowTransition
...
class VehiclesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = VehiclesAccessRule
...
class VehiclesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = VehiclesConfigurationParameter
...
class VehiclesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = VehiclesDocumentAttachment
...
class VehiclesBulkActionForm(forms.Form):
