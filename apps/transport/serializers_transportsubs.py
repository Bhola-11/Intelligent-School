"""
Serializers for EduFlow Student Transport Subscriptions & Fees (TransportSubs).
...
class TransportSubsMasterSerializer:
    """Serializes TransportSubsMaster instances to and from JSON/dict structures."""
...
class TransportSubsItemSerializer:
    @classmethod
...
class TransportSubsAllocationSerializer:
    @classmethod
...
class TransportSubsMetricSerializer:
    @classmethod
...
class TransportSubsPolicyRuleSerializer:
    @classmethod
...
class TransportSubsSchedulePeriodSerializer:
    @classmethod
...
class TransportSubsFeedbackReviewSerializer:
    @classmethod
...
class TransportSubsWorkflowTransitionSerializer:
    @classmethod
...
class TransportSubsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class TransportSubsConfigurationParameterSerializer:
    @classmethod
...
class TransportSubsDocumentAttachmentSerializer:
    @classmethod
...
class TransportSubsAuditTrailSerializer:
    @classmethod
