"""
Forms for EduFlow Transport Routes, Stops & Timings (Routes).
...
class RoutesMasterForm(forms.ModelForm):
    """Primary form for creating and updating Routes master records."""
    class Meta:
        try:
            model = RoutesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ROUT-001'}),
...
class RoutesItemForm(forms.ModelForm):
...
class RoutesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = RoutesAllocation
...
class RoutesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = RoutesMetricRecord
...
class RoutesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = RoutesPolicyRule
...
class RoutesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = RoutesSchedulePeriod
...
class RoutesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = RoutesFeedbackReview
...
class RoutesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = RoutesWorkflowTransition
...
class RoutesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = RoutesAccessRule
...
class RoutesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = RoutesConfigurationParameter
...
class RoutesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = RoutesDocumentAttachment
...
class RoutesFilterForm(forms.Form):
...
class RoutesBulkActionForm(forms.Form):
