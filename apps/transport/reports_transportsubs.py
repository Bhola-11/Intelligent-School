"""
Operational Reporting Engine for EduFlow Student Transport Subscriptions & Fees (TransportSubs).
...
try:
    from .models import TransportSubsMaster, TransportSubsItem, TransportSubsAllocation
except ImportError:
    pass

class TransportSubsReportGenerator:
    """Generates analytical reports and summary matrices for TransportSubs."""
