"""
Serializers for EduFlow Leave Policies & Entitlement Setup (LeavePolicies).
...
class LeavePoliciesMasterSerializer:
    """Serializes LeavePoliciesMaster instances to and from JSON/dict structures."""
...
class LeavePoliciesItemSerializer:
    @classmethod
...
class LeavePoliciesAllocationSerializer:
    @classmethod
...
class LeavePoliciesMetricSerializer:
    @classmethod
...
class LeavePoliciesPolicyRuleSerializer:
    @classmethod
...
class LeavePoliciesSchedulePeriodSerializer:
    @classmethod
...
class LeavePoliciesFeedbackReviewSerializer:
    @classmethod
...
class LeavePoliciesWorkflowTransitionSerializer:
    @classmethod
...
class LeavePoliciesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class LeavePoliciesConfigurationParameterSerializer:
    @classmethod
...
class LeavePoliciesDocumentAttachmentSerializer:
    @classmethod
...
class LeavePoliciesAuditTrailSerializer:
    @classmethod
