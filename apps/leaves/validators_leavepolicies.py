"""
Domain Validators for EduFlow Leave Policies & Entitlement Setup (LeavePolicies).
...
class LeavePoliciesValidator:
    """Domain validator implementing enterprise business rules for LeavePolicies."""
