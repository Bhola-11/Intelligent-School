"""
Forms for EduFlow Student Leave Requests & Parent Consents (StudentLeaves).
...
class StudentLeavesMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentLeaves master records."""
    class Meta:
        try:
            model = StudentLeavesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. STUD-001'}),
...
class StudentLeavesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = StudentLeavesItem
...
class StudentLeavesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = StudentLeavesAllocation
...
class StudentLeavesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = StudentLeavesMetricRecord
...
class StudentLeavesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = StudentLeavesPolicyRule
...
class StudentLeavesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = StudentLeavesSchedulePeriod
...
class StudentLeavesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = StudentLeavesFeedbackReview
...
class StudentLeavesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = StudentLeavesWorkflowTransition
...
class StudentLeavesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = StudentLeavesAccessRule
...
class StudentLeavesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = StudentLeavesConfigurationParameter
...
class StudentLeavesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = StudentLeavesDocumentAttachment
...
class StudentLeavesFilterForm(forms.Form):
...
class StudentLeavesBulkActionForm(forms.Form):
