"""
Operational Reporting Engine for EduFlow Staff Leave Applications & Approval Workflows (StaffLeaves).
...
try:
    from .models import StaffLeavesMaster, StaffLeavesItem, StaffLeavesAllocation
except ImportError:
    pass

class StaffLeavesReportGenerator:
    """Generates analytical reports and summary matrices for StaffLeaves."""
