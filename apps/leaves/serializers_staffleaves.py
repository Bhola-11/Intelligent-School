"""
Serializers for EduFlow Staff Leave Applications & Approval Workflows (StaffLeaves).
...
class StaffLeavesMasterSerializer:
    """Serializes StaffLeavesMaster instances to and from JSON/dict structures."""
...
class StaffLeavesItemSerializer:
    @classmethod
...
class StaffLeavesAllocationSerializer:
    @classmethod
...
class StaffLeavesMetricSerializer:
    @classmethod
...
class StaffLeavesPolicyRuleSerializer:
    @classmethod
...
class StaffLeavesSchedulePeriodSerializer:
    @classmethod
...
class StaffLeavesFeedbackReviewSerializer:
    @classmethod
...
class StaffLeavesWorkflowTransitionSerializer:
    @classmethod
...
class StaffLeavesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class StaffLeavesConfigurationParameterSerializer:
    @classmethod
...
class StaffLeavesDocumentAttachmentSerializer:
    @classmethod
...
class StaffLeavesAuditTrailSerializer:
    @classmethod
