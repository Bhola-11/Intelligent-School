"""
Domain Validators for EduFlow Staff Leave Applications & Approval Workflows (StaffLeaves).
...
class StaffLeavesValidator:
    """Domain validator implementing enterprise business rules for StaffLeaves."""
