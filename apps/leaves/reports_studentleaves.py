"""
Operational Reporting Engine for EduFlow Student Leave Requests & Parent Consents (StudentLeaves).
...
try:
    from .models import StudentLeavesMaster, StudentLeavesItem, StudentLeavesAllocation
except ImportError:
    pass

class StudentLeavesReportGenerator:
    """Generates analytical reports and summary matrices for StudentLeaves."""
