"""Django Admin configuration for EduFlow Student Leave Requests & Parent Consents (StudentLeaves)."""
...
if 'StudentLeavesMaster' in globals():
    @admin.register(StudentLeavesMaster)
    class StudentLeavesMasterAdmin(admin.ModelAdmin):
...
if 'StudentLeavesItem' in globals():
    @admin.register(StudentLeavesItem)
    class StudentLeavesItemAdmin(admin.ModelAdmin):
...
if 'StudentLeavesAllocation' in globals():
    @admin.register(StudentLeavesAllocation)
    class StudentLeavesAllocationAdmin(admin.ModelAdmin):
...
if 'StudentLeavesMetricRecord' in globals():
    @admin.register(StudentLeavesMetricRecord)
    class StudentLeavesMetricRecordAdmin(admin.ModelAdmin):
...
if 'StudentLeavesPolicyRule' in globals():
    @admin.register(StudentLeavesPolicyRule)
    class StudentLeavesPolicyRuleAdmin(admin.ModelAdmin):
...
if 'StudentLeavesSchedulePeriod' in globals():
    @admin.register(StudentLeavesSchedulePeriod)
    class StudentLeavesSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'StudentLeavesFeedbackReview' in globals():
    @admin.register(StudentLeavesFeedbackReview)
    class StudentLeavesFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'StudentLeavesWorkflowTransition' in globals():
    @admin.register(StudentLeavesWorkflowTransition)
    class StudentLeavesWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'StudentLeavesAccessRule' in globals():
    @admin.register(StudentLeavesAccessRule)
    class StudentLeavesAccessRuleAdmin(admin.ModelAdmin):
...
if 'StudentLeavesConfigurationParameter' in globals():
    @admin.register(StudentLeavesConfigurationParameter)
    class StudentLeavesConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'StudentLeavesDocumentAttachment' in globals():
    @admin.register(StudentLeavesDocumentAttachment)
    class StudentLeavesDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'StudentLeavesAuditTrail' in globals():
    @admin.register(StudentLeavesAuditTrail)
    class StudentLeavesAuditTrailAdmin(admin.ModelAdmin):
