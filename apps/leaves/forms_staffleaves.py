"""
Forms for EduFlow Staff Leave Applications & Approval Workflows (StaffLeaves).
...
class StaffLeavesMasterForm(forms.ModelForm):
    """Primary form for creating and updating StaffLeaves master records."""
    class Meta:
        try:
            model = StaffLeavesMaster
            fields = [
...
class StaffLeavesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = StaffLeavesItem
...
class StaffLeavesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = StaffLeavesAllocation
...
class StaffLeavesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = StaffLeavesMetricRecord
...
class StaffLeavesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = StaffLeavesPolicyRule
...
class StaffLeavesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = StaffLeavesSchedulePeriod
...
class StaffLeavesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = StaffLeavesFeedbackReview
...
class StaffLeavesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = StaffLeavesWorkflowTransition
...
class StaffLeavesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = StaffLeavesAccessRule
...
class StaffLeavesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = StaffLeavesConfigurationParameter
...
class StaffLeavesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = StaffLeavesDocumentAttachment
...
class StaffLeavesFilterForm(forms.Form):
...
class StaffLeavesBulkActionForm(forms.Form):
