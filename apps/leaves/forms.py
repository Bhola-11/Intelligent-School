"""
Forms for EduFlow Leave Policies & Entitlement Setup (LeavePolicies).
...
class LeavePoliciesMasterForm(forms.ModelForm):
    """Primary form for creating and updating LeavePolicies master records."""
    class Meta:
        try:
            model = LeavePoliciesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. LEAV-001'}),
...
class LeavePoliciesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = LeavePoliciesItem
...
class LeavePoliciesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = LeavePoliciesAllocation
...
class LeavePoliciesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = LeavePoliciesMetricRecord
...
class LeavePoliciesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = LeavePoliciesPolicyRule
...
class LeavePoliciesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = LeavePoliciesSchedulePeriod
...
class LeavePoliciesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = LeavePoliciesFeedbackReview
...
class LeavePoliciesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = LeavePoliciesWorkflowTransition
...
class LeavePoliciesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = LeavePoliciesAccessRule
...
class LeavePoliciesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = LeavePoliciesConfigurationParameter
...
class LeavePoliciesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = LeavePoliciesDocumentAttachment
...
class LeavePoliciesFilterForm(forms.Form):
...
class LeavePoliciesBulkActionForm(forms.Form):
