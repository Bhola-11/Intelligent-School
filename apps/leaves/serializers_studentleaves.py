"""
Serializers for EduFlow Student Leave Requests & Parent Consents (StudentLeaves).
...
class StudentLeavesMasterSerializer:
    """Serializes StudentLeavesMaster instances to and from JSON/dict structures."""
...
class StudentLeavesItemSerializer:
    @classmethod
...
class StudentLeavesAllocationSerializer:
    @classmethod
...
class StudentLeavesMetricSerializer:
    @classmethod
...
class StudentLeavesPolicyRuleSerializer:
    @classmethod
...
class StudentLeavesSchedulePeriodSerializer:
    @classmethod
...
class StudentLeavesFeedbackReviewSerializer:
    @classmethod
...
class StudentLeavesWorkflowTransitionSerializer:
    @classmethod
...
class StudentLeavesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class StudentLeavesConfigurationParameterSerializer:
    @classmethod
...
class StudentLeavesDocumentAttachmentSerializer:
    @classmethod
...
class StudentLeavesAuditTrailSerializer:
    @classmethod
