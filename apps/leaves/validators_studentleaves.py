"""
Domain Validators for EduFlow Student Leave Requests & Parent Consents (StudentLeaves).
...
class StudentLeavesValidator:
    """Domain validator implementing enterprise business rules for StudentLeaves."""
