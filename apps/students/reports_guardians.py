"""
Operational Reporting Engine for EduFlow Guardians, Parents & Emergency Contacts (Guardians).
...
try:
    from .models import GuardiansMaster, GuardiansItem, GuardiansAllocation
except ImportError:
    pass

class GuardiansReportGenerator:
    """Generates analytical reports and summary matrices for Guardians."""
