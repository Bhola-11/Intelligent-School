"""
Serializers for EduFlow Student Previous Education & Transfers (PreviousEducation).
...
class PreviousEducationMasterSerializer:
    """Serializes PreviousEducationMaster instances to and from JSON/dict structures."""
...
class PreviousEducationItemSerializer:
    @classmethod
...
class PreviousEducationAllocationSerializer:
    @classmethod
...
class PreviousEducationMetricSerializer:
    @classmethod
...
class PreviousEducationPolicyRuleSerializer:
    @classmethod
...
class PreviousEducationSchedulePeriodSerializer:
    @classmethod
...
class PreviousEducationFeedbackReviewSerializer:
    @classmethod
...
class PreviousEducationWorkflowTransitionSerializer:
    @classmethod
...
class PreviousEducationAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class PreviousEducationConfigurationParameterSerializer:
    @classmethod
...
class PreviousEducationDocumentAttachmentSerializer:
    @classmethod
...
class PreviousEducationAuditTrailSerializer:
    @classmethod
