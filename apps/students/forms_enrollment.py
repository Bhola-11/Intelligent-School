"""
Forms for EduFlow Student Enrollment & Academic History (Enrollment).
...
class EnrollmentMasterForm(forms.ModelForm):
    """Primary form for creating and updating Enrollment master records."""
    class Meta:
        try:
            model = EnrollmentMaster
            fields = [
...
class EnrollmentItemForm(forms.ModelForm):
...
class EnrollmentAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = EnrollmentAllocation
...
class EnrollmentMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = EnrollmentMetricRecord
...
class EnrollmentPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = EnrollmentPolicyRule
...
class EnrollmentSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = EnrollmentSchedulePeriod
...
class EnrollmentFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = EnrollmentFeedbackReview
...
class EnrollmentWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = EnrollmentWorkflowTransition
...
class EnrollmentAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = EnrollmentAccessRule
...
class EnrollmentConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = EnrollmentConfigurationParameter
...
class EnrollmentDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = EnrollmentDocumentAttachment
...
class EnrollmentBulkActionForm(forms.Form):
