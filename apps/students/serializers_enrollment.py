"""
Serializers for EduFlow Student Enrollment & Academic History (Enrollment).
...
class EnrollmentMasterSerializer:
    """Serializes EnrollmentMaster instances to and from JSON/dict structures."""
...
class EnrollmentItemSerializer:
    @classmethod
...
class EnrollmentAllocationSerializer:
    @classmethod
...
class EnrollmentMetricSerializer:
    @classmethod
...
class EnrollmentPolicyRuleSerializer:
    @classmethod
...
class EnrollmentSchedulePeriodSerializer:
    @classmethod
...
class EnrollmentFeedbackReviewSerializer:
    @classmethod
...
class EnrollmentWorkflowTransitionSerializer:
    @classmethod
...
class EnrollmentAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class EnrollmentConfigurationParameterSerializer:
    @classmethod
...
class EnrollmentDocumentAttachmentSerializer:
    @classmethod
...
class EnrollmentAuditTrailSerializer:
    @classmethod
