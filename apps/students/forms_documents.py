"""
Forms for EduFlow Student Document Vault & Verifications (Documents).
...
class DocumentsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Documents master records."""
    class Meta:
        try:
            model = DocumentsMaster
            fields = [
...
class DocumentsItemForm(forms.ModelForm):
...
class DocumentsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = DocumentsAllocation
...
class DocumentsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = DocumentsMetricRecord
...
class DocumentsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = DocumentsPolicyRule
...
class DocumentsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = DocumentsSchedulePeriod
...
class DocumentsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = DocumentsFeedbackReview
...
class DocumentsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = DocumentsWorkflowTransition
...
class DocumentsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = DocumentsAccessRule
...
class DocumentsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = DocumentsConfigurationParameter
...
class DocumentsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = DocumentsDocumentAttachment
...
class DocumentsFilterForm(forms.Form):
...
class DocumentsBulkActionForm(forms.Form):
