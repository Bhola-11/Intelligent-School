"""
Forms for EduFlow Student Previous Education & Transfers (PreviousEducation).
...
class PreviousEducationMasterForm(forms.ModelForm):
    """Primary form for creating and updating PreviousEducation master records."""
    class Meta:
        try:
            model = PreviousEducationMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PREV-001'}),
...
class PreviousEducationItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = PreviousEducationItem
...
class PreviousEducationAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = PreviousEducationAllocation
...
class PreviousEducationMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = PreviousEducationMetricRecord
...
class PreviousEducationPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = PreviousEducationPolicyRule
...
class PreviousEducationSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = PreviousEducationSchedulePeriod
...
class PreviousEducationFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = PreviousEducationFeedbackReview
...
class PreviousEducationWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = PreviousEducationWorkflowTransition
...
class PreviousEducationAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = PreviousEducationAccessRule
...
class PreviousEducationConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = PreviousEducationConfigurationParameter
...
class PreviousEducationDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = PreviousEducationDocumentAttachment
...
class PreviousEducationFilterForm(forms.Form):
...
class PreviousEducationBulkActionForm(forms.Form):
