"""
Forms for EduFlow Student Medical & Health Records (Health).
...
class HealthMasterForm(forms.ModelForm):
    """Primary form for creating and updating Health master records."""
    class Meta:
        try:
            model = HealthMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. HEAL-001'}),
...
class HealthItemForm(forms.ModelForm):
...
class HealthAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = HealthAllocation
...
class HealthMetricRecordForm(forms.ModelForm):
...
class HealthPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = HealthPolicyRule
...
class HealthSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = HealthSchedulePeriod
...
class HealthFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = HealthFeedbackReview
...
class HealthWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = HealthWorkflowTransition
...
class HealthAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = HealthAccessRule
...
class HealthConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = HealthConfigurationParameter
...
class HealthDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = HealthDocumentAttachment
...
class HealthFilterForm(forms.Form):
...
class HealthBulkActionForm(forms.Form):
