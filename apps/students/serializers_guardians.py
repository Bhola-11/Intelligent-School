"""
Serializers for EduFlow Guardians, Parents & Emergency Contacts (Guardians).
...
class GuardiansMasterSerializer:
    """Serializes GuardiansMaster instances to and from JSON/dict structures."""
...
class GuardiansAllocationSerializer:
    @classmethod
...
class GuardiansMetricSerializer:
    @classmethod
...
class GuardiansPolicyRuleSerializer:
    @classmethod
...
class GuardiansSchedulePeriodSerializer:
    @classmethod
...
class GuardiansFeedbackReviewSerializer:
    @classmethod
...
class GuardiansWorkflowTransitionSerializer:
    @classmethod
...
class GuardiansAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class GuardiansConfigurationParameterSerializer:
    @classmethod
...
class GuardiansDocumentAttachmentSerializer:
    @classmethod
...
class GuardiansAuditTrailSerializer:
    @classmethod
