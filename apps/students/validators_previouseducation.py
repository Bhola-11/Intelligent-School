"""
Domain Validators for EduFlow Student Previous Education & Transfers (PreviousEducation).
...
class PreviousEducationValidator:
    """Domain validator implementing enterprise business rules for PreviousEducation."""
