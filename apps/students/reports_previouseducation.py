"""
Operational Reporting Engine for EduFlow Student Previous Education & Transfers (PreviousEducation).
...
try:
    from .models import PreviousEducationMaster, PreviousEducationItem, PreviousEducationAllocation
except ImportError:
    pass

class PreviousEducationReportGenerator:
    """Generates analytical reports and summary matrices for PreviousEducation."""
