"""Django Admin configuration for EduFlow Student Medical & Health Records (Health)."""
...
if 'HealthMaster' in globals():
    @admin.register(HealthMaster)
    class HealthMasterAdmin(admin.ModelAdmin):
...
if 'HealthAllocation' in globals():
    @admin.register(HealthAllocation)
    class HealthAllocationAdmin(admin.ModelAdmin):
...
if 'HealthPolicyRule' in globals():
    @admin.register(HealthPolicyRule)
    class HealthPolicyRuleAdmin(admin.ModelAdmin):
...
if 'HealthSchedulePeriod' in globals():
    @admin.register(HealthSchedulePeriod)
    class HealthSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'HealthFeedbackReview' in globals():
    @admin.register(HealthFeedbackReview)
    class HealthFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'HealthWorkflowTransition' in globals():
    @admin.register(HealthWorkflowTransition)
    class HealthWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'HealthAccessRule' in globals():
    @admin.register(HealthAccessRule)
    class HealthAccessRuleAdmin(admin.ModelAdmin):
...
if 'HealthConfigurationParameter' in globals():
    @admin.register(HealthConfigurationParameter)
    class HealthConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'HealthDocumentAttachment' in globals():
    @admin.register(HealthDocumentAttachment)
    class HealthDocumentAttachmentAdmin(admin.ModelAdmin):
