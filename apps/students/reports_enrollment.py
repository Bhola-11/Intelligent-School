"""
Operational Reporting Engine for EduFlow Student Enrollment & Academic History (Enrollment).
...
try:
    from .models import EnrollmentMaster, EnrollmentItem, EnrollmentAllocation
except ImportError:
    pass

class EnrollmentReportGenerator:
    """Generates analytical reports and summary matrices for Enrollment."""
