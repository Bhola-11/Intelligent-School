"""
Serializers for EduFlow Student Document Vault & Verifications (Documents).
...
class DocumentsMasterSerializer:
    """Serializes DocumentsMaster instances to and from JSON/dict structures."""
...
class DocumentsAllocationSerializer:
    @classmethod
...
class DocumentsMetricSerializer:
    @classmethod
...
class DocumentsPolicyRuleSerializer:
    @classmethod
...
class DocumentsSchedulePeriodSerializer:
    @classmethod
...
class DocumentsFeedbackReviewSerializer:
    @classmethod
...
class DocumentsWorkflowTransitionSerializer:
    @classmethod
...
class DocumentsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class DocumentsConfigurationParameterSerializer:
    @classmethod
...
class DocumentsDocumentAttachmentSerializer:
    @classmethod
...
class DocumentsAuditTrailSerializer:
    @classmethod
