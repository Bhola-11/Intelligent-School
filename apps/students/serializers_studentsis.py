"""
Serializers for EduFlow Student Information System (SIS) Core (StudentSIS).
...
class StudentSISMasterSerializer:
    """Serializes StudentSISMaster instances to and from JSON/dict structures."""
...
class StudentSISItemSerializer:
    @classmethod
...
class StudentSISAllocationSerializer:
    @classmethod
...
class StudentSISMetricSerializer:
    @classmethod
...
class StudentSISPolicyRuleSerializer:
    @classmethod
...
class StudentSISSchedulePeriodSerializer:
    @classmethod
...
class StudentSISFeedbackReviewSerializer:
    @classmethod
...
class StudentSISWorkflowTransitionSerializer:
    @classmethod
...
class StudentSISAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class StudentSISConfigurationParameterSerializer:
    @classmethod
...
class StudentSISDocumentAttachmentSerializer:
    @classmethod
...
class StudentSISAuditTrailSerializer:
    @classmethod
