"""
Serializers for EduFlow Student Medical & Health Records (Health).
...
class HealthMasterSerializer:
    """Serializes HealthMaster instances to and from JSON/dict structures."""
...
class HealthAllocationSerializer:
    @classmethod
...
class HealthPolicyRuleSerializer:
    @classmethod
...
class HealthSchedulePeriodSerializer:
    @classmethod
...
class HealthFeedbackReviewSerializer:
    @classmethod
...
class HealthWorkflowTransitionSerializer:
    @classmethod
...
class HealthAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class HealthConfigurationParameterSerializer:
    @classmethod
...
class HealthDocumentAttachmentSerializer:
    @classmethod
...
class HealthAuditTrailSerializer:
    @classmethod
