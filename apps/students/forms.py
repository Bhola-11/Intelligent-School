"""
Forms for EduFlow Student Information System (SIS) Core (StudentSIS).
...
class StudentSISMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentSIS master records."""
    class Meta:
        try:
            model = StudentSISMaster
            fields = [
...
class StudentSISItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = StudentSISItem
...
class StudentSISAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = StudentSISAllocation
...
class StudentSISMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = StudentSISMetricRecord
...
class StudentSISPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = StudentSISPolicyRule
...
class StudentSISSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = StudentSISSchedulePeriod
...
class StudentSISFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = StudentSISFeedbackReview
...
class StudentSISWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = StudentSISWorkflowTransition
...
class StudentSISAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = StudentSISAccessRule
...
class StudentSISConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = StudentSISConfigurationParameter
...
class StudentSISDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = StudentSISDocumentAttachment
...
class StudentSISFilterForm(forms.Form):
...
class StudentSISBulkActionForm(forms.Form):
