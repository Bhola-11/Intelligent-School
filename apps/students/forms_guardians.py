"""
Forms for EduFlow Guardians, Parents & Emergency Contacts (Guardians).
...
class GuardiansMasterForm(forms.ModelForm):
    """Primary form for creating and updating Guardians master records."""
    class Meta:
        try:
            model = GuardiansMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. GUAR-001'}),
...
class GuardiansItemForm(forms.ModelForm):
...
class GuardiansAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = GuardiansAllocation
...
class GuardiansMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = GuardiansMetricRecord
...
class GuardiansPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = GuardiansPolicyRule
...
class GuardiansSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = GuardiansSchedulePeriod
...
class GuardiansFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = GuardiansFeedbackReview
...
class GuardiansWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = GuardiansWorkflowTransition
...
class GuardiansAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = GuardiansAccessRule
...
class GuardiansConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = GuardiansConfigurationParameter
...
class GuardiansDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = GuardiansDocumentAttachment
...
class GuardiansFilterForm(forms.Form):
...
class GuardiansBulkActionForm(forms.Form):
