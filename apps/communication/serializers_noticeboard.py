"""
Serializers for EduFlow Notice Board & Announcements (NoticeBoard).
...
class NoticeBoardMasterSerializer:
    """Serializes NoticeBoardMaster instances to and from JSON/dict structures."""
...
class NoticeBoardItemSerializer:
    @classmethod
...
class NoticeBoardAllocationSerializer:
    @classmethod
...
class NoticeBoardMetricSerializer:
    @classmethod
...
class NoticeBoardPolicyRuleSerializer:
    @classmethod
...
class NoticeBoardSchedulePeriodSerializer:
    @classmethod
...
class NoticeBoardFeedbackReviewSerializer:
    @classmethod
...
class NoticeBoardWorkflowTransitionSerializer:
    @classmethod
...
class NoticeBoardAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class NoticeBoardConfigurationParameterSerializer:
    @classmethod
...
class NoticeBoardDocumentAttachmentSerializer:
    @classmethod
...
class NoticeBoardAuditTrailSerializer:
    @classmethod
