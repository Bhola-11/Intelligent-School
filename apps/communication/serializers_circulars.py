"""
Serializers for EduFlow Institutional Circulars & Acknowledgments (Circulars).
...
class CircularsMasterSerializer:
    """Serializes CircularsMaster instances to and from JSON/dict structures."""
...
class CircularsAllocationSerializer:
    @classmethod
...
class CircularsMetricSerializer:
    @classmethod
...
class CircularsPolicyRuleSerializer:
    @classmethod
...
class CircularsSchedulePeriodSerializer:
    @classmethod
...
class CircularsFeedbackReviewSerializer:
    @classmethod
...
class CircularsWorkflowTransitionSerializer:
    @classmethod
...
class CircularsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CircularsConfigurationParameterSerializer:
    @classmethod
...
class CircularsDocumentAttachmentSerializer:
    @classmethod
...
class CircularsAuditTrailSerializer:
    @classmethod
