"""
Forms for EduFlow Notice Board & Announcements (NoticeBoard).
...
class NoticeBoardMasterForm(forms.ModelForm):
    """Primary form for creating and updating NoticeBoard master records."""
    class Meta:
        try:
            model = NoticeBoardMaster
            fields = [
...
class NoticeBoardAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = NoticeBoardAllocation
...
class NoticeBoardMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = NoticeBoardMetricRecord
...
class NoticeBoardPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = NoticeBoardPolicyRule
...
class NoticeBoardSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = NoticeBoardSchedulePeriod
...
class NoticeBoardFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = NoticeBoardFeedbackReview
...
class NoticeBoardWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = NoticeBoardWorkflowTransition
...
class NoticeBoardAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = NoticeBoardAccessRule
...
class NoticeBoardConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = NoticeBoardConfigurationParameter
...
class NoticeBoardDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = NoticeBoardDocumentAttachment
...
class NoticeBoardFilterForm(forms.Form):
...
class NoticeBoardBulkActionForm(forms.Form):
