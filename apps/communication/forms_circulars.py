"""
Forms for EduFlow Institutional Circulars & Acknowledgments (Circulars).
...
class CircularsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Circulars master records."""
    class Meta:
        try:
            model = CircularsMaster
            fields = [
...
class CircularsItemForm(forms.ModelForm):
...
class CircularsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = CircularsAllocation
...
class CircularsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = CircularsMetricRecord
...
class CircularsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = CircularsPolicyRule
...
class CircularsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = CircularsSchedulePeriod
...
class CircularsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = CircularsFeedbackReview
...
class CircularsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = CircularsWorkflowTransition
...
class CircularsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = CircularsAccessRule
...
class CircularsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = CircularsConfigurationParameter
...
class CircularsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = CircularsDocumentAttachment
...
class CircularsFilterForm(forms.Form):
...
class CircularsBulkActionForm(forms.Form):
