"""
Forms for EduFlow Internal Messaging & Communication Threads (Messages).
...
class MessagesMasterForm(forms.ModelForm):
    """Primary form for creating and updating Messages master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. MESS-001'}),
...
class MessagesItemForm(forms.ModelForm):
...
class MessagesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = MessagesAllocation
...
class MessagesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = MessagesMetricRecord
...
class MessagesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = MessagesPolicyRule
...
class MessagesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = MessagesSchedulePeriod
...
class MessagesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = MessagesFeedbackReview
...
class MessagesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = MessagesWorkflowTransition
...
class MessagesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = MessagesAccessRule
...
class MessagesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = MessagesConfigurationParameter
...
class MessagesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = MessagesDocumentAttachment
...
class MessagesFilterForm(forms.Form):
...
class MessagesBulkActionForm(forms.Form):
