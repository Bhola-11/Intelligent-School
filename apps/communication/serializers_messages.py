"""
Serializers for EduFlow Internal Messaging & Communication Threads (Messages).
...
class MessagesMasterSerializer:
    """Serializes MessagesMaster instances to and from JSON/dict structures."""
...
class MessagesAllocationSerializer:
    @classmethod
...
class MessagesMetricSerializer:
    @classmethod
...
class MessagesPolicyRuleSerializer:
    @classmethod
...
class MessagesSchedulePeriodSerializer:
    @classmethod
...
class MessagesFeedbackReviewSerializer:
    @classmethod
...
class MessagesWorkflowTransitionSerializer:
    @classmethod
...
class MessagesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class MessagesConfigurationParameterSerializer:
    @classmethod
...
class MessagesDocumentAttachmentSerializer:
    @classmethod
...
class MessagesAuditTrailSerializer:
    @classmethod
