"""
Serializers for EduFlow Global Search, Audit Logs, Master Reports & CLI (MasterReports).
...
class MasterReportsMasterSerializer:
    """Serializes MasterReportsMaster instances to and from JSON/dict structures."""
...
class MasterReportsItemSerializer:
    @classmethod
...
class MasterReportsAllocationSerializer:
    @classmethod
...
class MasterReportsMetricSerializer:
    @classmethod
...
class MasterReportsPolicyRuleSerializer:
    @classmethod
...
class MasterReportsSchedulePeriodSerializer:
    @classmethod
...
class MasterReportsFeedbackReviewSerializer:
    @classmethod
...
class MasterReportsWorkflowTransitionSerializer:
    @classmethod
...
class MasterReportsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class MasterReportsConfigurationParameterSerializer:
    @classmethod
...
class MasterReportsDocumentAttachmentSerializer:
    @classmethod
...
class MasterReportsAuditTrailSerializer:
    @classmethod
