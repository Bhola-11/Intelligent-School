"""
Forms for EduFlow Global Search, Audit Logs, Master Reports & CLI (MasterReports).
...
class MasterReportsMasterForm(forms.ModelForm):
    """Primary form for creating and updating MasterReports master records."""
    class Meta:
        try:
            model = MasterReportsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. MAST-001'}),
...
class MasterReportsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = MasterReportsItem
...
class MasterReportsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = MasterReportsAllocation
...
class MasterReportsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = MasterReportsMetricRecord
...
class MasterReportsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = MasterReportsPolicyRule
...
class MasterReportsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = MasterReportsSchedulePeriod
...
class MasterReportsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = MasterReportsFeedbackReview
...
class MasterReportsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = MasterReportsWorkflowTransition
...
class MasterReportsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = MasterReportsAccessRule
...
class MasterReportsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = MasterReportsConfigurationParameter
...
class MasterReportsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = MasterReportsDocumentAttachment
...
class MasterReportsFilterForm(forms.Form):
...
class MasterReportsBulkActionForm(forms.Form):
