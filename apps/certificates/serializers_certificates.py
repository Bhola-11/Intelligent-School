"""
Serializers for EduFlow Certificates Generation & QR Verification (Certificates).
...
class CertificatesMasterSerializer:
    """Serializes CertificatesMaster instances to and from JSON/dict structures."""
...
class CertificatesItemSerializer:
    @classmethod
...
class CertificatesAllocationSerializer:
    @classmethod
...
class CertificatesMetricSerializer:
    @classmethod
...
class CertificatesPolicyRuleSerializer:
    @classmethod
...
class CertificatesSchedulePeriodSerializer:
    @classmethod
...
class CertificatesFeedbackReviewSerializer:
    @classmethod
...
class CertificatesWorkflowTransitionSerializer:
    @classmethod
...
class CertificatesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class CertificatesConfigurationParameterSerializer:
    @classmethod
...
class CertificatesDocumentAttachmentSerializer:
    @classmethod
...
class CertificatesAuditTrailSerializer:
    @classmethod
