"""
Domain Validators for EduFlow Certificates Generation & QR Verification (Certificates).
...
class CertificatesValidator:
    """Domain validator implementing enterprise business rules for Certificates."""
