"""Django Admin configuration for EduFlow Certificates Generation & QR Verification (Certificates)."""
...
if 'CertificatesItem' in globals():
    @admin.register(CertificatesItem)
    class CertificatesItemAdmin(admin.ModelAdmin):
...
if 'CertificatesAllocation' in globals():
    @admin.register(CertificatesAllocation)
    class CertificatesAllocationAdmin(admin.ModelAdmin):
...
if 'CertificatesMetricRecord' in globals():
    @admin.register(CertificatesMetricRecord)
    class CertificatesMetricRecordAdmin(admin.ModelAdmin):
...
if 'CertificatesPolicyRule' in globals():
    @admin.register(CertificatesPolicyRule)
    class CertificatesPolicyRuleAdmin(admin.ModelAdmin):
...
if 'CertificatesSchedulePeriod' in globals():
    @admin.register(CertificatesSchedulePeriod)
    class CertificatesSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'CertificatesFeedbackReview' in globals():
    @admin.register(CertificatesFeedbackReview)
    class CertificatesFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'CertificatesWorkflowTransition' in globals():
    @admin.register(CertificatesWorkflowTransition)
    class CertificatesWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'CertificatesAccessRule' in globals():
    @admin.register(CertificatesAccessRule)
    class CertificatesAccessRuleAdmin(admin.ModelAdmin):
...
if 'CertificatesConfigurationParameter' in globals():
    @admin.register(CertificatesConfigurationParameter)
    class CertificatesConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'CertificatesDocumentAttachment' in globals():
    @admin.register(CertificatesDocumentAttachment)
    class CertificatesDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'CertificatesAuditTrail' in globals():
    @admin.register(CertificatesAuditTrail)
    class CertificatesAuditTrailAdmin(admin.ModelAdmin):
