"""
Operational Reporting Engine for EduFlow Inventory Categories & Asset Registry (AssetRegistry).
...
try:
    from .models import AssetRegistryMaster, AssetRegistryItem, AssetRegistryAllocation
except ImportError:
    pass

class AssetRegistryReportGenerator:
    """Generates analytical reports and summary matrices for AssetRegistry."""
