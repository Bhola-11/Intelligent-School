"""
Forms for EduFlow Inventory Categories & Asset Registry (AssetRegistry).
...
class AssetRegistryMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssetRegistry master records."""
    class Meta:
        try:
            model = AssetRegistryMaster
            fields = [
...
class AssetRegistryItemForm(forms.ModelForm):
...
class AssetRegistryAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = AssetRegistryAllocation
...
class AssetRegistryMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = AssetRegistryMetricRecord
...
class AssetRegistryPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = AssetRegistryPolicyRule
...
class AssetRegistrySchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = AssetRegistrySchedulePeriod
...
class AssetRegistryFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = AssetRegistryFeedbackReview
...
class AssetRegistryWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = AssetRegistryWorkflowTransition
...
class AssetRegistryAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = AssetRegistryAccessRule
...
class AssetRegistryConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = AssetRegistryConfigurationParameter
...
class AssetRegistryDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = AssetRegistryDocumentAttachment
...
class AssetRegistryFilterForm(forms.Form):
...
class AssetRegistryBulkActionForm(forms.Form):
