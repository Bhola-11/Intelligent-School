"""
Forms for EduFlow Asset Allocations, Stock Movement & Depreciations (AssetAllocations).
...
class AssetAllocationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssetAllocations master records."""
    class Meta:
        try:
            model = AssetAllocationsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ASSE-001'}),
...
class AssetAllocationsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = AssetAllocationsItem
...
class AssetAllocationsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = AssetAllocationsAllocation
...
class AssetAllocationsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = AssetAllocationsMetricRecord
...
class AssetAllocationsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = AssetAllocationsPolicyRule
...
class AssetAllocationsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = AssetAllocationsSchedulePeriod
...
class AssetAllocationsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = AssetAllocationsFeedbackReview
...
class AssetAllocationsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = AssetAllocationsWorkflowTransition
...
class AssetAllocationsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = AssetAllocationsAccessRule
...
class AssetAllocationsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = AssetAllocationsConfigurationParameter
...
class AssetAllocationsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = AssetAllocationsDocumentAttachment
...
class AssetAllocationsFilterForm(forms.Form):
...
class AssetAllocationsBulkActionForm(forms.Form):
