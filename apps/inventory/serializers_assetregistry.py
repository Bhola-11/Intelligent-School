"""
Serializers for EduFlow Inventory Categories & Asset Registry (AssetRegistry).
...
class AssetRegistryMasterSerializer:
    """Serializes AssetRegistryMaster instances to and from JSON/dict structures."""
...
class AssetRegistryItemSerializer:
    @classmethod
...
class AssetRegistryAllocationSerializer:
    @classmethod
...
class AssetRegistryMetricSerializer:
    @classmethod
...
class AssetRegistryPolicyRuleSerializer:
    @classmethod
...
class AssetRegistrySchedulePeriodSerializer:
    @classmethod
...
class AssetRegistryFeedbackReviewSerializer:
    @classmethod
...
class AssetRegistryWorkflowTransitionSerializer:
    @classmethod
...
class AssetRegistryAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AssetRegistryConfigurationParameterSerializer:
    @classmethod
...
class AssetRegistryDocumentAttachmentSerializer:
    @classmethod
...
class AssetRegistryAuditTrailSerializer:
    @classmethod
