"""
Domain Validators for EduFlow Inventory Categories & Asset Registry (AssetRegistry).
...
class AssetRegistryValidator:
    """Domain validator implementing enterprise business rules for AssetRegistry."""
