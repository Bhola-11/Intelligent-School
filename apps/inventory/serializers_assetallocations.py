"""
Serializers for EduFlow Asset Allocations, Stock Movement & Depreciations (AssetAllocations).
...
class AssetAllocationsMasterSerializer:
    """Serializes AssetAllocationsMaster instances to and from JSON/dict structures."""
...
class AssetAllocationsItemSerializer:
    @classmethod
...
class AssetAllocationsAllocationSerializer:
    @classmethod
...
class AssetAllocationsMetricSerializer:
    @classmethod
...
class AssetAllocationsPolicyRuleSerializer:
    @classmethod
...
class AssetAllocationsSchedulePeriodSerializer:
    @classmethod
...
class AssetAllocationsFeedbackReviewSerializer:
    @classmethod
...
class AssetAllocationsWorkflowTransitionSerializer:
    @classmethod
...
class AssetAllocationsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AssetAllocationsConfigurationParameterSerializer:
    @classmethod
...
class AssetAllocationsDocumentAttachmentSerializer:
    @classmethod
...
class AssetAllocationsAuditTrailSerializer:
    @classmethod
