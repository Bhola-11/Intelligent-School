"""
Forms for EduFlow GPA, CGPA, Term Average & Rank Engine (GPACalculator).
...
class GPACalculatorMasterForm(forms.ModelForm):
    """Primary form for creating and updating GPACalculator master records."""
    class Meta:
        try:
            model = GPACalculatorMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. GPAC-001'}),
...
class GPACalculatorItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = GPACalculatorItem
...
class GPACalculatorAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = GPACalculatorAllocation
...
class GPACalculatorMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = GPACalculatorMetricRecord
...
class GPACalculatorPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = GPACalculatorPolicyRule
...
class GPACalculatorSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = GPACalculatorSchedulePeriod
...
class GPACalculatorFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = GPACalculatorFeedbackReview
...
class GPACalculatorWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = GPACalculatorWorkflowTransition
...
class GPACalculatorAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = GPACalculatorAccessRule
...
class GPACalculatorConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = GPACalculatorConfigurationParameter
...
class GPACalculatorDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = GPACalculatorDocumentAttachment
...
class GPACalculatorFilterForm(forms.Form):
...
class GPACalculatorBulkActionForm(forms.Form):
