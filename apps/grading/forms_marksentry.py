"""
Forms for EduFlow Subject Marks & Component Entry Register (MarksEntry).
...
class MarksEntryMasterForm(forms.ModelForm):
    """Primary form for creating and updating MarksEntry master records."""
    class Meta:
        try:
            model = MarksEntryMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. MARK-001'}),
...
class MarksEntryItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = MarksEntryItem
...
class MarksEntryAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = MarksEntryAllocation
...
class MarksEntryMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = MarksEntryMetricRecord
...
class MarksEntryPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = MarksEntryPolicyRule
...
class MarksEntrySchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = MarksEntrySchedulePeriod
...
class MarksEntryFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = MarksEntryFeedbackReview
...
class MarksEntryWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = MarksEntryWorkflowTransition
...
class MarksEntryAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = MarksEntryAccessRule
...
class MarksEntryConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = MarksEntryConfigurationParameter
...
class MarksEntryDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = MarksEntryDocumentAttachment
...
class MarksEntryBulkActionForm(forms.Form):
