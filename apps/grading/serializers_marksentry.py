"""
Serializers for EduFlow Subject Marks & Component Entry Register (MarksEntry).
...
class MarksEntryMasterSerializer:
    """Serializes MarksEntryMaster instances to and from JSON/dict structures."""
...
class MarksEntryItemSerializer:
    @classmethod
...
class MarksEntryAllocationSerializer:
    @classmethod
...
class MarksEntryMetricSerializer:
    @classmethod
...
class MarksEntryPolicyRuleSerializer:
    @classmethod
...
class MarksEntrySchedulePeriodSerializer:
    @classmethod
...
class MarksEntryFeedbackReviewSerializer:
    @classmethod
...
class MarksEntryWorkflowTransitionSerializer:
    @classmethod
...
class MarksEntryAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class MarksEntryConfigurationParameterSerializer:
    @classmethod
...
class MarksEntryDocumentAttachmentSerializer:
    @classmethod
...
class MarksEntryAuditTrailSerializer:
    @classmethod
