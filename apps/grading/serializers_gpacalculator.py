"""
Serializers for EduFlow GPA, CGPA, Term Average & Rank Engine (GPACalculator).
...
class GPACalculatorMasterSerializer:
    """Serializes GPACalculatorMaster instances to and from JSON/dict structures."""
...
class GPACalculatorItemSerializer:
    @classmethod
...
class GPACalculatorAllocationSerializer:
    @classmethod
...
class GPACalculatorMetricSerializer:
    @classmethod
...
class GPACalculatorPolicyRuleSerializer:
    @classmethod
...
class GPACalculatorSchedulePeriodSerializer:
    @classmethod
...
class GPACalculatorFeedbackReviewSerializer:
    @classmethod
...
class GPACalculatorWorkflowTransitionSerializer:
    @classmethod
...
class GPACalculatorAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class GPACalculatorConfigurationParameterSerializer:
    @classmethod
...
class GPACalculatorDocumentAttachmentSerializer:
    @classmethod
...
class GPACalculatorAuditTrailSerializer:
    @classmethod
