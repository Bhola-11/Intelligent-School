"""
Forms for EduFlow Grading Schemes & Grade Scale Boundaries (GradeScales).
...
class GradeScalesMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradeScales master records."""
    class Meta:
        try:
            model = GradeScalesMaster
            fields = [
...
class GradeScalesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = GradeScalesItem
...
class GradeScalesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = GradeScalesAllocation
...
class GradeScalesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = GradeScalesMetricRecord
...
class GradeScalesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = GradeScalesPolicyRule
...
class GradeScalesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = GradeScalesSchedulePeriod
...
class GradeScalesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = GradeScalesFeedbackReview
...
class GradeScalesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = GradeScalesWorkflowTransition
...
class GradeScalesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = GradeScalesAccessRule
...
class GradeScalesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = GradeScalesConfigurationParameter
...
class GradeScalesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = GradeScalesDocumentAttachment
...
class GradeScalesFilterForm(forms.Form):
...
class GradeScalesBulkActionForm(forms.Form):
