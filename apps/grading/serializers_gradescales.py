"""
Serializers for EduFlow Grading Schemes & Grade Scale Boundaries (GradeScales).
...
class GradeScalesMasterSerializer:
    """Serializes GradeScalesMaster instances to and from JSON/dict structures."""
...
class GradeScalesItemSerializer:
    @classmethod
...
class GradeScalesAllocationSerializer:
    @classmethod
...
class GradeScalesMetricSerializer:
    @classmethod
...
class GradeScalesPolicyRuleSerializer:
    @classmethod
...
class GradeScalesSchedulePeriodSerializer:
    @classmethod
...
class GradeScalesFeedbackReviewSerializer:
    @classmethod
...
class GradeScalesWorkflowTransitionSerializer:
    @classmethod
...
class GradeScalesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class GradeScalesConfigurationParameterSerializer:
    @classmethod
...
class GradeScalesDocumentAttachmentSerializer:
    @classmethod
...
class GradeScalesAuditTrailSerializer:
    @classmethod
