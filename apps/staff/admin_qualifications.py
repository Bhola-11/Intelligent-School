"""Django Admin configuration for EduFlow Staff Qualifications, Degrees & Certifications (Qualifications)."""
...
if 'QualificationsMaster' in globals():
    @admin.register(QualificationsMaster)
    class QualificationsMasterAdmin(admin.ModelAdmin):
...
if 'QualificationsItem' in globals():
    @admin.register(QualificationsItem)
    class QualificationsItemAdmin(admin.ModelAdmin):
...
if 'QualificationsAllocation' in globals():
    @admin.register(QualificationsAllocation)
    class QualificationsAllocationAdmin(admin.ModelAdmin):
...
if 'QualificationsMetricRecord' in globals():
    @admin.register(QualificationsMetricRecord)
    class QualificationsMetricRecordAdmin(admin.ModelAdmin):
...
if 'QualificationsPolicyRule' in globals():
    @admin.register(QualificationsPolicyRule)
    class QualificationsPolicyRuleAdmin(admin.ModelAdmin):
...
if 'QualificationsSchedulePeriod' in globals():
    @admin.register(QualificationsSchedulePeriod)
    class QualificationsSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'QualificationsFeedbackReview' in globals():
    @admin.register(QualificationsFeedbackReview)
    class QualificationsFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'QualificationsWorkflowTransition' in globals():
    @admin.register(QualificationsWorkflowTransition)
    class QualificationsWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'QualificationsAccessRule' in globals():
    @admin.register(QualificationsAccessRule)
    class QualificationsAccessRuleAdmin(admin.ModelAdmin):
...
if 'QualificationsConfigurationParameter' in globals():
    @admin.register(QualificationsConfigurationParameter)
    class QualificationsConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'QualificationsDocumentAttachment' in globals():
    @admin.register(QualificationsDocumentAttachment)
    class QualificationsDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'QualificationsAuditTrail' in globals():
    @admin.register(QualificationsAuditTrail)
    class QualificationsAuditTrailAdmin(admin.ModelAdmin):
