"""
Operational Reporting Engine for EduFlow Teacher Workload & Teaching Allocations (Workload).
...
try:
    from .models import WorkloadMaster, WorkloadItem, WorkloadAllocation
except ImportError:
    pass

class WorkloadReportGenerator:
    """Generates analytical reports and summary matrices for Workload."""
