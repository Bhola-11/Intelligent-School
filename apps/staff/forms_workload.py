"""
Forms for EduFlow Teacher Workload & Teaching Allocations (Workload).
...
class WorkloadMasterForm(forms.ModelForm):
    """Primary form for creating and updating Workload master records."""
    class Meta:
        try:
            model = WorkloadMaster
            fields = [
...
class WorkloadItemForm(forms.ModelForm):
...
class WorkloadAllocationForm(forms.ModelForm):
...
class WorkloadMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = WorkloadMetricRecord
...
class WorkloadPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = WorkloadPolicyRule
...
class WorkloadSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = WorkloadSchedulePeriod
...
class WorkloadFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = WorkloadFeedbackReview
...
class WorkloadWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = WorkloadWorkflowTransition
...
class WorkloadAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = WorkloadAccessRule
...
class WorkloadConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = WorkloadConfigurationParameter
...
class WorkloadDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = WorkloadDocumentAttachment
...
class WorkloadFilterForm(forms.Form):
...
class WorkloadBulkActionForm(forms.Form):
