"""
Serializers for EduFlow Staff Profiles & Employee Directory (StaffDirectory).
...
class StaffDirectoryMasterSerializer:
    """Serializes StaffDirectoryMaster instances to and from JSON/dict structures."""
...
class StaffDirectoryItemSerializer:
    @classmethod
...
class StaffDirectoryAllocationSerializer:
    @classmethod
...
class StaffDirectoryMetricSerializer:
    @classmethod
...
class StaffDirectoryPolicyRuleSerializer:
    @classmethod
...
class StaffDirectorySchedulePeriodSerializer:
    @classmethod
...
class StaffDirectoryFeedbackReviewSerializer:
    @classmethod
...
class StaffDirectoryWorkflowTransitionSerializer:
    @classmethod
...
class StaffDirectoryAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class StaffDirectoryConfigurationParameterSerializer:
    @classmethod
...
class StaffDirectoryDocumentAttachmentSerializer:
    @classmethod
...
class StaffDirectoryAuditTrailSerializer:
    @classmethod
