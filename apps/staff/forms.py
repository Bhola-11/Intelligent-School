"""
Forms for EduFlow Staff Profiles & Employee Directory (StaffDirectory).
...
class StaffDirectoryMasterForm(forms.ModelForm):
    """Primary form for creating and updating StaffDirectory master records."""
    class Meta:
        try:
            model = StaffDirectoryMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. STAF-001'}),
...
class StaffDirectoryItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = StaffDirectoryItem
...
class StaffDirectoryAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = StaffDirectoryAllocation
...
class StaffDirectoryMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = StaffDirectoryMetricRecord
...
class StaffDirectoryPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = StaffDirectoryPolicyRule
...
class StaffDirectorySchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = StaffDirectorySchedulePeriod
...
class StaffDirectoryFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = StaffDirectoryFeedbackReview
...
class StaffDirectoryWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = StaffDirectoryWorkflowTransition
...
class StaffDirectoryAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = StaffDirectoryAccessRule
...
class StaffDirectoryConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = StaffDirectoryConfigurationParameter
...
class StaffDirectoryDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = StaffDirectoryDocumentAttachment
...
class StaffDirectoryFilterForm(forms.Form):
...
class StaffDirectoryBulkActionForm(forms.Form):
