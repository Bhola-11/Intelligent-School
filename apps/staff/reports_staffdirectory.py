"""
Operational Reporting Engine for EduFlow Staff Profiles & Employee Directory (StaffDirectory).
...
try:
    from .models import StaffDirectoryMaster, StaffDirectoryItem, StaffDirectoryAllocation
except ImportError:
    pass

class StaffDirectoryReportGenerator:
    """Generates analytical reports and summary matrices for StaffDirectory."""
