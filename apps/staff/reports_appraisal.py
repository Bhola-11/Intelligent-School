"""
Operational Reporting Engine for EduFlow Staff Performance Appraisals & Reviews (Appraisal).
...
try:
    from .models import AppraisalMaster, AppraisalItem, AppraisalAllocation
except ImportError:
    pass

class AppraisalReportGenerator:
    """Generates analytical reports and summary matrices for Appraisal."""
