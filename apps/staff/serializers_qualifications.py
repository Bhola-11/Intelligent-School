"""
Serializers for EduFlow Staff Qualifications, Degrees & Certifications (Qualifications).
...
class QualificationsMasterSerializer:
    """Serializes QualificationsMaster instances to and from JSON/dict structures."""
...
class QualificationsItemSerializer:
    @classmethod
...
class QualificationsAllocationSerializer:
    @classmethod
...
class QualificationsMetricSerializer:
    @classmethod
...
class QualificationsPolicyRuleSerializer:
    @classmethod
...
class QualificationsSchedulePeriodSerializer:
    @classmethod
...
class QualificationsFeedbackReviewSerializer:
    @classmethod
...
class QualificationsWorkflowTransitionSerializer:
    @classmethod
...
class QualificationsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class QualificationsConfigurationParameterSerializer:
    @classmethod
...
class QualificationsDocumentAttachmentSerializer:
    @classmethod
...
class QualificationsAuditTrailSerializer:
    @classmethod
