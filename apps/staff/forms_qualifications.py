"""
Forms for EduFlow Staff Qualifications, Degrees & Certifications (Qualifications).
...
class QualificationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Qualifications master records."""
    class Meta:
        try:
            model = QualificationsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. QUAL-001'}),
...
class QualificationsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = QualificationsItem
...
class QualificationsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = QualificationsAllocation
...
class QualificationsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = QualificationsMetricRecord
...
class QualificationsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = QualificationsPolicyRule
...
class QualificationsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = QualificationsSchedulePeriod
...
class QualificationsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = QualificationsFeedbackReview
...
class QualificationsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = QualificationsWorkflowTransition
...
class QualificationsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = QualificationsAccessRule
...
class QualificationsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = QualificationsConfigurationParameter
...
class QualificationsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = QualificationsDocumentAttachment
...
class QualificationsFilterForm(forms.Form):
...
class QualificationsBulkActionForm(forms.Form):
