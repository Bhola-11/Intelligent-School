"""
Domain Validators for EduFlow Staff Profiles & Employee Directory (StaffDirectory).
...
class StaffDirectoryValidator:
    """Domain validator implementing enterprise business rules for StaffDirectory."""
