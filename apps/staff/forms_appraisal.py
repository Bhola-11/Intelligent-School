"""
Forms for EduFlow Staff Performance Appraisals & Reviews (Appraisal).
...
class AppraisalMasterForm(forms.ModelForm):
    """Primary form for creating and updating Appraisal master records."""
    class Meta:
        try:
            model = AppraisalMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. APPR-001'}),
...
class AppraisalItemForm(forms.ModelForm):
...
class AppraisalAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = AppraisalAllocation
...
class AppraisalMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = AppraisalMetricRecord
...
class AppraisalPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = AppraisalPolicyRule
...
class AppraisalSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = AppraisalSchedulePeriod
...
class AppraisalFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = AppraisalFeedbackReview
...
class AppraisalWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = AppraisalWorkflowTransition
...
class AppraisalAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = AppraisalAccessRule
...
class AppraisalConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = AppraisalConfigurationParameter
...
class AppraisalDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = AppraisalDocumentAttachment
...
class AppraisalBulkActionForm(forms.Form):
