"""
Operational Reporting Engine for EduFlow Staff Qualifications, Degrees & Certifications (Qualifications).
...
try:
    from .models import QualificationsMaster, QualificationsItem, QualificationsAllocation
except ImportError:
    pass

class QualificationsReportGenerator:
    """Generates analytical reports and summary matrices for Qualifications."""
