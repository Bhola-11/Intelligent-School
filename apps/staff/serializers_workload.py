"""
Serializers for EduFlow Teacher Workload & Teaching Allocations (Workload).
...
class WorkloadMasterSerializer:
    """Serializes WorkloadMaster instances to and from JSON/dict structures."""
...
class WorkloadAllocationSerializer:
    @classmethod
...
class WorkloadMetricSerializer:
    @classmethod
...
class WorkloadPolicyRuleSerializer:
    @classmethod
...
class WorkloadSchedulePeriodSerializer:
    @classmethod
...
class WorkloadFeedbackReviewSerializer:
    @classmethod
...
class WorkloadWorkflowTransitionSerializer:
    @classmethod
...
class WorkloadAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class WorkloadConfigurationParameterSerializer:
    @classmethod
...
class WorkloadDocumentAttachmentSerializer:
    @classmethod
...
class WorkloadAuditTrailSerializer:
    @classmethod
