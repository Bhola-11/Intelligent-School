"""Django Admin configuration for EduFlow Teacher Workload & Teaching Allocations (Workload)."""
...
if 'WorkloadMaster' in globals():
    @admin.register(WorkloadMaster)
    class WorkloadMasterAdmin(admin.ModelAdmin):
...
if 'WorkloadMetricRecord' in globals():
    @admin.register(WorkloadMetricRecord)
    class WorkloadMetricRecordAdmin(admin.ModelAdmin):
...
if 'WorkloadPolicyRule' in globals():
    @admin.register(WorkloadPolicyRule)
    class WorkloadPolicyRuleAdmin(admin.ModelAdmin):
...
if 'WorkloadSchedulePeriod' in globals():
    @admin.register(WorkloadSchedulePeriod)
    class WorkloadSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'WorkloadFeedbackReview' in globals():
    @admin.register(WorkloadFeedbackReview)
    class WorkloadFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'WorkloadWorkflowTransition' in globals():
    @admin.register(WorkloadWorkflowTransition)
    class WorkloadWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'WorkloadAccessRule' in globals():
    @admin.register(WorkloadAccessRule)
    class WorkloadAccessRuleAdmin(admin.ModelAdmin):
...
if 'WorkloadConfigurationParameter' in globals():
    @admin.register(WorkloadConfigurationParameter)
    class WorkloadConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'WorkloadDocumentAttachment' in globals():
    @admin.register(WorkloadDocumentAttachment)
    class WorkloadDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'WorkloadAuditTrail' in globals():
    @admin.register(WorkloadAuditTrail)
    class WorkloadAuditTrailAdmin(admin.ModelAdmin):
