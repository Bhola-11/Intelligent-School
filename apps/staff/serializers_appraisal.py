"""
Serializers for EduFlow Staff Performance Appraisals & Reviews (Appraisal).
...
class AppraisalMasterSerializer:
    """Serializes AppraisalMaster instances to and from JSON/dict structures."""
...
class AppraisalAllocationSerializer:
    @classmethod
...
class AppraisalMetricSerializer:
    @classmethod
...
class AppraisalPolicyRuleSerializer:
    @classmethod
...
class AppraisalSchedulePeriodSerializer:
    @classmethod
...
class AppraisalFeedbackReviewSerializer:
    @classmethod
...
class AppraisalWorkflowTransitionSerializer:
    @classmethod
...
class AppraisalAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AppraisalConfigurationParameterSerializer:
    @classmethod
...
class AppraisalDocumentAttachmentSerializer:
    @classmethod
...
class AppraisalAuditTrailSerializer:
    @classmethod
