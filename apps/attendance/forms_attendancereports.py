"""
Forms for EduFlow Attendance Policies, Alerts & Analytics (AttendanceReports).
...
class AttendanceReportsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendanceReports master records."""
    class Meta:
        try:
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ATTE-001'}),
...
class AttendanceReportsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = AttendanceReportsItem
...
class AttendanceReportsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = AttendanceReportsAllocation
...
class AttendanceReportsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = AttendanceReportsMetricRecord
...
class AttendanceReportsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = AttendanceReportsPolicyRule
...
class AttendanceReportsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = AttendanceReportsSchedulePeriod
...
class AttendanceReportsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = AttendanceReportsFeedbackReview
...
class AttendanceReportsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = AttendanceReportsWorkflowTransition
...
class AttendanceReportsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = AttendanceReportsAccessRule
...
class AttendanceReportsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = AttendanceReportsConfigurationParameter
...
class AttendanceReportsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = AttendanceReportsDocumentAttachment
...
class AttendanceReportsFilterForm(forms.Form):
...
class AttendanceReportsBulkActionForm(forms.Form):
