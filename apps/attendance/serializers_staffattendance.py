"""
Serializers for EduFlow Teacher & Staff Attendance Management (StaffAttendance).
...
class StaffAttendanceMasterSerializer:
    """Serializes StaffAttendanceMaster instances to and from JSON/dict structures."""
...
class StaffAttendanceItemSerializer:
    @classmethod
...
class StaffAttendanceAllocationSerializer:
    @classmethod
...
class StaffAttendanceMetricSerializer:
    @classmethod
...
class StaffAttendancePolicyRuleSerializer:
    @classmethod
...
class StaffAttendanceSchedulePeriodSerializer:
    @classmethod
...
class StaffAttendanceFeedbackReviewSerializer:
    @classmethod
...
class StaffAttendanceWorkflowTransitionSerializer:
    @classmethod
...
class StaffAttendanceAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class StaffAttendanceConfigurationParameterSerializer:
    @classmethod
...
class StaffAttendanceDocumentAttachmentSerializer:
    @classmethod
...
class StaffAttendanceAuditTrailSerializer:
    @classmethod
