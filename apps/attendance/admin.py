"""Django Admin configuration for EduFlow Student Daily Attendance Register (DailyAttendance)."""
...
if 'DailyAttendanceMaster' in globals():
    @admin.register(DailyAttendanceMaster)
    class DailyAttendanceMasterAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceItem' in globals():
    @admin.register(DailyAttendanceItem)
    class DailyAttendanceItemAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceAllocation' in globals():
    @admin.register(DailyAttendanceAllocation)
    class DailyAttendanceAllocationAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceMetricRecord' in globals():
    @admin.register(DailyAttendanceMetricRecord)
    class DailyAttendanceMetricRecordAdmin(admin.ModelAdmin):
...
if 'DailyAttendancePolicyRule' in globals():
    @admin.register(DailyAttendancePolicyRule)
    class DailyAttendancePolicyRuleAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceSchedulePeriod' in globals():
    @admin.register(DailyAttendanceSchedulePeriod)
    class DailyAttendanceSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceFeedbackReview' in globals():
    @admin.register(DailyAttendanceFeedbackReview)
    class DailyAttendanceFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceWorkflowTransition' in globals():
    @admin.register(DailyAttendanceWorkflowTransition)
    class DailyAttendanceWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceAccessRule' in globals():
    @admin.register(DailyAttendanceAccessRule)
    class DailyAttendanceAccessRuleAdmin(admin.ModelAdmin):
...
if 'DailyAttendanceConfigurationParameter' in globals():
    @admin.register(DailyAttendanceConfigurationParameter)
    class DailyAttendanceConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'DailyAttendanceDocumentAttachment' in globals():
    @admin.register(DailyAttendanceDocumentAttachment)
    class DailyAttendanceDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'DailyAttendanceAuditTrail' in globals():
    @admin.register(DailyAttendanceAuditTrail)
    class DailyAttendanceAuditTrailAdmin(admin.ModelAdmin):
