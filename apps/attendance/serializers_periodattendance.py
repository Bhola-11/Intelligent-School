"""
Serializers for EduFlow Period & Subject-Wise Attendance Tracking (PeriodAttendance).
...
class PeriodAttendanceMasterSerializer:
    """Serializes PeriodAttendanceMaster instances to and from JSON/dict structures."""
...
class PeriodAttendanceItemSerializer:
    @classmethod
...
class PeriodAttendanceAllocationSerializer:
    @classmethod
...
class PeriodAttendanceMetricSerializer:
    @classmethod
...
class PeriodAttendancePolicyRuleSerializer:
    @classmethod
...
class PeriodAttendanceSchedulePeriodSerializer:
    @classmethod
...
class PeriodAttendanceFeedbackReviewSerializer:
    @classmethod
...
class PeriodAttendanceWorkflowTransitionSerializer:
    @classmethod
...
class PeriodAttendanceAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class PeriodAttendanceConfigurationParameterSerializer:
    @classmethod
...
class PeriodAttendanceDocumentAttachmentSerializer:
    @classmethod
...
class PeriodAttendanceAuditTrailSerializer:
    @classmethod
