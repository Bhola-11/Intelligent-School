"""
Forms for EduFlow Student Daily Attendance Register (DailyAttendance).
...
class DailyAttendanceMasterForm(forms.ModelForm):
    """Primary form for creating and updating DailyAttendance master records."""
    class Meta:
        try:
            model = DailyAttendanceMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. DAIL-001'}),
...
class DailyAttendanceItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = DailyAttendanceItem
...
class DailyAttendanceAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = DailyAttendanceAllocation
...
class DailyAttendanceMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = DailyAttendanceMetricRecord
...
class DailyAttendancePolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = DailyAttendancePolicyRule
...
class DailyAttendanceSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = DailyAttendanceSchedulePeriod
...
class DailyAttendanceFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = DailyAttendanceFeedbackReview
...
class DailyAttendanceWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = DailyAttendanceWorkflowTransition
...
class DailyAttendanceAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = DailyAttendanceAccessRule
...
class DailyAttendanceConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = DailyAttendanceConfigurationParameter
...
class DailyAttendanceDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = DailyAttendanceDocumentAttachment
...
class DailyAttendanceBulkActionForm(forms.Form):
