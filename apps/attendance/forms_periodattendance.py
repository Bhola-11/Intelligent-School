"""
Forms for EduFlow Period & Subject-Wise Attendance Tracking (PeriodAttendance).
...
class PeriodAttendanceMasterForm(forms.ModelForm):
    """Primary form for creating and updating PeriodAttendance master records."""
    class Meta:
        try:
            model = PeriodAttendanceMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PERI-001'}),
...
class PeriodAttendanceItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = PeriodAttendanceItem
...
class PeriodAttendanceAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = PeriodAttendanceAllocation
...
class PeriodAttendanceMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = PeriodAttendanceMetricRecord
...
class PeriodAttendancePolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = PeriodAttendancePolicyRule
...
class PeriodAttendanceSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = PeriodAttendanceSchedulePeriod
...
class PeriodAttendanceFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = PeriodAttendanceFeedbackReview
...
class PeriodAttendanceWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = PeriodAttendanceWorkflowTransition
...
class PeriodAttendanceAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = PeriodAttendanceAccessRule
...
class PeriodAttendanceConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = PeriodAttendanceConfigurationParameter
...
class PeriodAttendanceDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = PeriodAttendanceDocumentAttachment
...
class PeriodAttendanceFilterForm(forms.Form):
...
class PeriodAttendanceBulkActionForm(forms.Form):
