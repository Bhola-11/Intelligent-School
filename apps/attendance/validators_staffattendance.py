"""
Domain Validators for EduFlow Teacher & Staff Attendance Management (StaffAttendance).
...
class StaffAttendanceValidator:
    """Domain validator implementing enterprise business rules for StaffAttendance."""
