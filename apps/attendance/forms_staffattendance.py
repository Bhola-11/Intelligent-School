"""
Forms for EduFlow Teacher & Staff Attendance Management (StaffAttendance).
...
class StaffAttendanceMasterForm(forms.ModelForm):
    """Primary form for creating and updating StaffAttendance master records."""
    class Meta:
        try:
            model = StaffAttendanceMaster
            fields = [
...
class StaffAttendanceItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = StaffAttendanceItem
...
class StaffAttendanceAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = StaffAttendanceAllocation
...
class StaffAttendanceMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = StaffAttendanceMetricRecord
...
class StaffAttendancePolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = StaffAttendancePolicyRule
...
class StaffAttendanceSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = StaffAttendanceSchedulePeriod
...
class StaffAttendanceFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = StaffAttendanceFeedbackReview
...
class StaffAttendanceWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = StaffAttendanceWorkflowTransition
...
class StaffAttendanceAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = StaffAttendanceAccessRule
...
class StaffAttendanceConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = StaffAttendanceConfigurationParameter
...
class StaffAttendanceDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = StaffAttendanceDocumentAttachment
...
class StaffAttendanceBulkActionForm(forms.Form):
