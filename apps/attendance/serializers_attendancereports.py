"""
Serializers for EduFlow Attendance Policies, Alerts & Analytics (AttendanceReports).
...
class AttendanceReportsMasterSerializer:
    """Serializes AttendanceReportsMaster instances to and from JSON/dict structures."""
...
class AttendanceReportsItemSerializer:
    @classmethod
...
class AttendanceReportsAllocationSerializer:
    @classmethod
...
class AttendanceReportsMetricSerializer:
    @classmethod
...
class AttendanceReportsPolicyRuleSerializer:
    @classmethod
...
class AttendanceReportsSchedulePeriodSerializer:
    @classmethod
...
class AttendanceReportsFeedbackReviewSerializer:
    @classmethod
...
class AttendanceReportsWorkflowTransitionSerializer:
    @classmethod
...
class AttendanceReportsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AttendanceReportsConfigurationParameterSerializer:
    @classmethod
...
class AttendanceReportsDocumentAttachmentSerializer:
    @classmethod
...
class AttendanceReportsAuditTrailSerializer:
    @classmethod
