"""
Serializers for EduFlow Student Daily Attendance Register (DailyAttendance).
...
class DailyAttendanceMasterSerializer:
    """Serializes DailyAttendanceMaster instances to and from JSON/dict structures."""
...
class DailyAttendanceItemSerializer:
    @classmethod
...
class DailyAttendanceAllocationSerializer:
    @classmethod
...
class DailyAttendanceMetricSerializer:
    @classmethod
...
class DailyAttendancePolicyRuleSerializer:
    @classmethod
...
class DailyAttendanceSchedulePeriodSerializer:
    @classmethod
...
class DailyAttendanceFeedbackReviewSerializer:
    @classmethod
...
class DailyAttendanceWorkflowTransitionSerializer:
    @classmethod
...
class DailyAttendanceAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class DailyAttendanceConfigurationParameterSerializer:
    @classmethod
...
class DailyAttendanceDocumentAttachmentSerializer:
    @classmethod
...
class DailyAttendanceAuditTrailSerializer:
    @classmethod
