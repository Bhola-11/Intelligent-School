"""
Forms for EduFlow Disciplinary Incidents & Case Management (DisciplineCases).
...
class DisciplineCasesMasterForm(forms.ModelForm):
    """Primary form for creating and updating DisciplineCases master records."""
    class Meta:
        try:
            model = DisciplineCasesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. DISC-001'}),
...
class DisciplineCasesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = DisciplineCasesItem
...
class DisciplineCasesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = DisciplineCasesAllocation
...
class DisciplineCasesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = DisciplineCasesMetricRecord
...
class DisciplineCasesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = DisciplineCasesPolicyRule
...
class DisciplineCasesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = DisciplineCasesSchedulePeriod
...
class DisciplineCasesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = DisciplineCasesFeedbackReview
...
class DisciplineCasesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = DisciplineCasesWorkflowTransition
...
class DisciplineCasesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = DisciplineCasesAccessRule
...
class DisciplineCasesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = DisciplineCasesConfigurationParameter
...
class DisciplineCasesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = DisciplineCasesDocumentAttachment
...
class DisciplineCasesFilterForm(forms.Form):
...
class DisciplineCasesBulkActionForm(forms.Form):
