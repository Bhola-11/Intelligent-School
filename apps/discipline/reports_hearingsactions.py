"""
Operational Reporting Engine for EduFlow Disciplinary Hearings, Sanctions & Appeals (HearingsActions).
...
try:
    from .models import HearingsActionsMaster, HearingsActionsItem, HearingsActionsAllocation
except ImportError:
    pass

class HearingsActionsReportGenerator:
    """Generates analytical reports and summary matrices for HearingsActions."""
