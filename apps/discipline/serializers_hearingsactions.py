"""
Serializers for EduFlow Disciplinary Hearings, Sanctions & Appeals (HearingsActions).
...
class HearingsActionsMasterSerializer:
    """Serializes HearingsActionsMaster instances to and from JSON/dict structures."""
...
class HearingsActionsItemSerializer:
    @classmethod
...
class HearingsActionsAllocationSerializer:
    @classmethod
...
class HearingsActionsMetricSerializer:
    @classmethod
...
class HearingsActionsPolicyRuleSerializer:
    @classmethod
...
class HearingsActionsSchedulePeriodSerializer:
    @classmethod
...
class HearingsActionsFeedbackReviewSerializer:
    @classmethod
...
class HearingsActionsWorkflowTransitionSerializer:
    @classmethod
...
class HearingsActionsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class HearingsActionsConfigurationParameterSerializer:
    @classmethod
...
class HearingsActionsDocumentAttachmentSerializer:
    @classmethod
...
class HearingsActionsAuditTrailSerializer:
    @classmethod
