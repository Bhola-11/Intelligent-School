"""
Forms for EduFlow Disciplinary Hearings, Sanctions & Appeals (HearingsActions).
...
class HearingsActionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating HearingsActions master records."""
    class Meta:
        try:
            model = HearingsActionsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. HEAR-001'}),
...
class HearingsActionsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = HearingsActionsItem
...
class HearingsActionsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = HearingsActionsAllocation
...
class HearingsActionsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = HearingsActionsMetricRecord
...
class HearingsActionsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = HearingsActionsPolicyRule
...
class HearingsActionsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = HearingsActionsSchedulePeriod
...
class HearingsActionsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = HearingsActionsFeedbackReview
...
class HearingsActionsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = HearingsActionsWorkflowTransition
...
class HearingsActionsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = HearingsActionsAccessRule
...
class HearingsActionsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = HearingsActionsConfigurationParameter
...
class HearingsActionsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = HearingsActionsDocumentAttachment
...
class HearingsActionsFilterForm(forms.Form):
...
class HearingsActionsBulkActionForm(forms.Form):
