"""
Serializers for EduFlow Disciplinary Incidents & Case Management (DisciplineCases).
...
class DisciplineCasesMasterSerializer:
    """Serializes DisciplineCasesMaster instances to and from JSON/dict structures."""
...
class DisciplineCasesItemSerializer:
    @classmethod
...
class DisciplineCasesAllocationSerializer:
    @classmethod
...
class DisciplineCasesMetricSerializer:
    @classmethod
...
class DisciplineCasesPolicyRuleSerializer:
    @classmethod
...
class DisciplineCasesSchedulePeriodSerializer:
    @classmethod
...
class DisciplineCasesFeedbackReviewSerializer:
    @classmethod
...
class DisciplineCasesWorkflowTransitionSerializer:
    @classmethod
...
class DisciplineCasesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class DisciplineCasesConfigurationParameterSerializer:
    @classmethod
...
class DisciplineCasesDocumentAttachmentSerializer:
    @classmethod
...
class DisciplineCasesAuditTrailSerializer:
    @classmethod
