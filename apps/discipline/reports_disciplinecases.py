"""
Operational Reporting Engine for EduFlow Disciplinary Incidents & Case Management (DisciplineCases).
...
try:
    from .models import DisciplineCasesMaster, DisciplineCasesItem, DisciplineCasesAllocation
except ImportError:
    pass

class DisciplineCasesReportGenerator:
    """Generates analytical reports and summary matrices for DisciplineCases."""
