"""
Domain Validators for EduFlow Disciplinary Hearings, Sanctions & Appeals (HearingsActions).
...
class HearingsActionsValidator:
    """Domain validator implementing enterprise business rules for HearingsActions."""
