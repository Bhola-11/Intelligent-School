"""
Forms for EduFlow Scholarships, Discounts & Late Fines (Concessions).
...
class ConcessionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Concessions master records."""
    class Meta:
        try:
            model = ConcessionsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. CONC-001'}),
...
class ConcessionsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ConcessionsItem
...
class ConcessionsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ConcessionsAllocation
...
class ConcessionsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ConcessionsMetricRecord
...
class ConcessionsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ConcessionsPolicyRule
...
class ConcessionsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ConcessionsSchedulePeriod
...
class ConcessionsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ConcessionsFeedbackReview
...
class ConcessionsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ConcessionsWorkflowTransition
...
class ConcessionsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ConcessionsAccessRule
...
class ConcessionsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ConcessionsConfigurationParameter
...
class ConcessionsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ConcessionsDocumentAttachment
...
class ConcessionsFilterForm(forms.Form):
...
class ConcessionsBulkActionForm(forms.Form):
