"""
Serializers for EduFlow Fee Payments, Receipts & Gateways (Payments).
...
class PaymentsMasterSerializer:
    """Serializes PaymentsMaster instances to and from JSON/dict structures."""
...
class PaymentsAllocationSerializer:
    @classmethod
...
class PaymentsMetricSerializer:
    @classmethod
...
class PaymentsPolicyRuleSerializer:
    @classmethod
...
class PaymentsSchedulePeriodSerializer:
    @classmethod
...
class PaymentsFeedbackReviewSerializer:
    @classmethod
...
class PaymentsWorkflowTransitionSerializer:
    @classmethod
...
class PaymentsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class PaymentsConfigurationParameterSerializer:
    @classmethod
...
class PaymentsDocumentAttachmentSerializer:
    @classmethod
...
class PaymentsAuditTrailSerializer:
    @classmethod
