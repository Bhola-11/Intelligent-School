"""
Forms for EduFlow Fee Payments, Receipts & Gateways (Payments).
...
class PaymentsMasterForm(forms.ModelForm):
    """Primary form for creating and updating Payments master records."""
    class Meta:
        try:
            model = PaymentsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. PAYM-001'}),
...
class PaymentsItemForm(forms.ModelForm):
...
class PaymentsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = PaymentsAllocation
...
class PaymentsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = PaymentsMetricRecord
...
class PaymentsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = PaymentsPolicyRule
...
class PaymentsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = PaymentsSchedulePeriod
...
class PaymentsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = PaymentsFeedbackReview
...
class PaymentsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = PaymentsWorkflowTransition
...
class PaymentsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = PaymentsAccessRule
...
class PaymentsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = PaymentsConfigurationParameter
...
class PaymentsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = PaymentsDocumentAttachment
...
class PaymentsBulkActionForm(forms.Form):
