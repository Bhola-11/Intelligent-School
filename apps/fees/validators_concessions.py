"""
Domain Validators for EduFlow Scholarships, Discounts & Late Fines (Concessions).
...
class ConcessionsValidator:
    """Domain validator implementing enterprise business rules for Concessions."""
