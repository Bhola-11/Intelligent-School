"""Django Admin configuration for EduFlow Fee Payments, Receipts & Gateways (Payments)."""
...
if 'PaymentsMaster' in globals():
    @admin.register(PaymentsMaster)
    class PaymentsMasterAdmin(admin.ModelAdmin):
...
if 'PaymentsAllocation' in globals():
    @admin.register(PaymentsAllocation)
    class PaymentsAllocationAdmin(admin.ModelAdmin):
...
if 'PaymentsMetricRecord' in globals():
    @admin.register(PaymentsMetricRecord)
    class PaymentsMetricRecordAdmin(admin.ModelAdmin):
...
if 'PaymentsPolicyRule' in globals():
    @admin.register(PaymentsPolicyRule)
    class PaymentsPolicyRuleAdmin(admin.ModelAdmin):
...
if 'PaymentsSchedulePeriod' in globals():
    @admin.register(PaymentsSchedulePeriod)
    class PaymentsSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'PaymentsFeedbackReview' in globals():
    @admin.register(PaymentsFeedbackReview)
    class PaymentsFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'PaymentsWorkflowTransition' in globals():
    @admin.register(PaymentsWorkflowTransition)
    class PaymentsWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'PaymentsAccessRule' in globals():
    @admin.register(PaymentsAccessRule)
    class PaymentsAccessRuleAdmin(admin.ModelAdmin):
...
if 'PaymentsConfigurationParameter' in globals():
    @admin.register(PaymentsConfigurationParameter)
    class PaymentsConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'PaymentsDocumentAttachment' in globals():
    @admin.register(PaymentsDocumentAttachment)
    class PaymentsDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'PaymentsAuditTrail' in globals():
    @admin.register(PaymentsAuditTrail)
    class PaymentsAuditTrailAdmin(admin.ModelAdmin):
