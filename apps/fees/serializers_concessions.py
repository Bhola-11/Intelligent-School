"""
Serializers for EduFlow Scholarships, Discounts & Late Fines (Concessions).
...
class ConcessionsMasterSerializer:
    """Serializes ConcessionsMaster instances to and from JSON/dict structures."""
...
class ConcessionsItemSerializer:
    @classmethod
...
class ConcessionsAllocationSerializer:
    @classmethod
...
class ConcessionsMetricSerializer:
    @classmethod
...
class ConcessionsPolicyRuleSerializer:
    @classmethod
...
class ConcessionsSchedulePeriodSerializer:
    @classmethod
...
class ConcessionsFeedbackReviewSerializer:
    @classmethod
...
class ConcessionsWorkflowTransitionSerializer:
    @classmethod
...
class ConcessionsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ConcessionsConfigurationParameterSerializer:
    @classmethod
...
class ConcessionsDocumentAttachmentSerializer:
    @classmethod
...
class ConcessionsAuditTrailSerializer:
    @classmethod
