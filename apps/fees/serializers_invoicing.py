"""
Serializers for EduFlow Student Fee Invoicing & Billing Engine (Invoicing).
...
class InvoicingMasterSerializer:
    """Serializes InvoicingMaster instances to and from JSON/dict structures."""
...
class InvoicingAllocationSerializer:
    @classmethod
...
class InvoicingMetricSerializer:
    @classmethod
...
class InvoicingPolicyRuleSerializer:
    @classmethod
...
class InvoicingSchedulePeriodSerializer:
    @classmethod
...
class InvoicingFeedbackReviewSerializer:
    @classmethod
...
class InvoicingWorkflowTransitionSerializer:
    @classmethod
...
class InvoicingAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class InvoicingConfigurationParameterSerializer:
    @classmethod
...
class InvoicingDocumentAttachmentSerializer:
    @classmethod
...
class InvoicingAuditTrailSerializer:
    @classmethod
