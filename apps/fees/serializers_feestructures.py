"""
Serializers for EduFlow Fee Categories & Structure Configuration (FeeStructures).
...
class FeeStructuresMasterSerializer:
    """Serializes FeeStructuresMaster instances to and from JSON/dict structures."""
...
class FeeStructuresItemSerializer:
    @classmethod
...
class FeeStructuresAllocationSerializer:
    @classmethod
...
class FeeStructuresMetricSerializer:
    @classmethod
...
class FeeStructuresPolicyRuleSerializer:
    @classmethod
...
class FeeStructuresSchedulePeriodSerializer:
    @classmethod
...
class FeeStructuresFeedbackReviewSerializer:
    @classmethod
...
class FeeStructuresWorkflowTransitionSerializer:
    @classmethod
...
class FeeStructuresAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class FeeStructuresConfigurationParameterSerializer:
    @classmethod
...
class FeeStructuresDocumentAttachmentSerializer:
    @classmethod
...
class FeeStructuresAuditTrailSerializer:
    @classmethod
