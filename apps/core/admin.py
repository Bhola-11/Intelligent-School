"""Django Admin configuration for EduFlow Project Scaffolding & Core Architecture (Architecture)."""
...
if 'ArchitectureMaster' in globals():
    @admin.register(ArchitectureMaster)
    class ArchitectureMasterAdmin(admin.ModelAdmin):
...
if 'ArchitectureItem' in globals():
    @admin.register(ArchitectureItem)
    class ArchitectureItemAdmin(admin.ModelAdmin):
...
if 'ArchitectureAllocation' in globals():
    @admin.register(ArchitectureAllocation)
    class ArchitectureAllocationAdmin(admin.ModelAdmin):
...
if 'ArchitectureMetricRecord' in globals():
    @admin.register(ArchitectureMetricRecord)
    class ArchitectureMetricRecordAdmin(admin.ModelAdmin):
...
if 'ArchitecturePolicyRule' in globals():
    @admin.register(ArchitecturePolicyRule)
    class ArchitecturePolicyRuleAdmin(admin.ModelAdmin):
...
if 'ArchitectureSchedulePeriod' in globals():
    @admin.register(ArchitectureSchedulePeriod)
    class ArchitectureSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'ArchitectureFeedbackReview' in globals():
    @admin.register(ArchitectureFeedbackReview)
    class ArchitectureFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'ArchitectureWorkflowTransition' in globals():
    @admin.register(ArchitectureWorkflowTransition)
    class ArchitectureWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'ArchitectureAccessRule' in globals():
    @admin.register(ArchitectureAccessRule)
    class ArchitectureAccessRuleAdmin(admin.ModelAdmin):
...
if 'ArchitectureConfigurationParameter' in globals():
    @admin.register(ArchitectureConfigurationParameter)
    class ArchitectureConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'ArchitectureDocumentAttachment' in globals():
    @admin.register(ArchitectureDocumentAttachment)
    class ArchitectureDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'ArchitectureAuditTrail' in globals():
    @admin.register(ArchitectureAuditTrail)
    class ArchitectureAuditTrailAdmin(admin.ModelAdmin):
