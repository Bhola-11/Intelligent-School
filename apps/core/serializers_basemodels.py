"""
Serializers for EduFlow Core Base Models & Model Mixins (BaseModels).
...
class BaseModelsMasterSerializer:
    """Serializes BaseModelsMaster instances to and from JSON/dict structures."""
...
class BaseModelsItemSerializer:
    @classmethod
...
class BaseModelsAllocationSerializer:
    @classmethod
...
class BaseModelsMetricSerializer:
    @classmethod
...
class BaseModelsPolicyRuleSerializer:
    @classmethod
...
class BaseModelsSchedulePeriodSerializer:
    @classmethod
...
class BaseModelsFeedbackReviewSerializer:
    @classmethod
...
class BaseModelsWorkflowTransitionSerializer:
    @classmethod
...
class BaseModelsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class BaseModelsConfigurationParameterSerializer:
    @classmethod
...
class BaseModelsDocumentAttachmentSerializer:
    @classmethod
...
class BaseModelsAuditTrailSerializer:
    @classmethod
