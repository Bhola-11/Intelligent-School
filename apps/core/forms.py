"""
Forms for EduFlow Project Scaffolding & Core Architecture (Architecture).
...
class ArchitectureMasterForm(forms.ModelForm):
    """Primary form for creating and updating Architecture master records."""
    class Meta:
        try:
            model = ArchitectureMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. ARCH-001'}),
...
class ArchitectureItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ArchitectureItem
...
class ArchitectureAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ArchitectureAllocation
...
class ArchitectureMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ArchitectureMetricRecord
...
class ArchitecturePolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ArchitecturePolicyRule
...
class ArchitectureSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ArchitectureSchedulePeriod
...
class ArchitectureFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ArchitectureFeedbackReview
...
class ArchitectureWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ArchitectureWorkflowTransition
...
class ArchitectureAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ArchitectureAccessRule
...
class ArchitectureConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ArchitectureConfigurationParameter
...
class ArchitectureDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ArchitectureDocumentAttachment
...
class ArchitectureFilterForm(forms.Form):
...
class ArchitectureBulkActionForm(forms.Form):
