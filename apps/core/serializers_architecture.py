"""
Serializers for EduFlow Project Scaffolding & Core Architecture (Architecture).
...
class ArchitectureMasterSerializer:
    """Serializes ArchitectureMaster instances to and from JSON/dict structures."""
...
class ArchitectureItemSerializer:
    @classmethod
...
class ArchitectureAllocationSerializer:
    @classmethod
...
class ArchitectureMetricSerializer:
    @classmethod
...
class ArchitecturePolicyRuleSerializer:
    @classmethod
...
class ArchitectureSchedulePeriodSerializer:
    @classmethod
...
class ArchitectureFeedbackReviewSerializer:
    @classmethod
...
class ArchitectureWorkflowTransitionSerializer:
    @classmethod
...
class ArchitectureAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ArchitectureConfigurationParameterSerializer:
    @classmethod
...
class ArchitectureDocumentAttachmentSerializer:
    @classmethod
...
class ArchitectureAuditTrailSerializer:
    @classmethod
