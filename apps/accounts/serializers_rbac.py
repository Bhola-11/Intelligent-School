"""
Serializers for EduFlow Role-Based Access Control & Permissions (RBAC).
...
class RBACMasterSerializer:
    """Serializes RBACMaster instances to and from JSON/dict structures."""
...
class RBACAllocationSerializer:
    @classmethod
...
class RBACPolicyRuleSerializer:
    @classmethod
...
class RBACSchedulePeriodSerializer:
    @classmethod
...
class RBACFeedbackReviewSerializer:
    @classmethod
...
class RBACWorkflowTransitionSerializer:
    @classmethod
...
class RBACAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class RBACConfigurationParameterSerializer:
    @classmethod
...
class RBACDocumentAttachmentSerializer:
    @classmethod
...
class RBACAuditTrailSerializer:
    @classmethod
