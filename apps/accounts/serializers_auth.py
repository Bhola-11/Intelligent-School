"""
Serializers for EduFlow Authentication Workflows & Profile Management (Auth).
...
class AuthMasterSerializer:
    """Serializes AuthMaster instances to and from JSON/dict structures."""
...
class AuthAllocationSerializer:
    @classmethod
...
class AuthPolicyRuleSerializer:
    @classmethod
...
class AuthSchedulePeriodSerializer:
    @classmethod
...
class AuthFeedbackReviewSerializer:
    @classmethod
...
class AuthWorkflowTransitionSerializer:
    @classmethod
...
class AuthAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class AuthConfigurationParameterSerializer:
    @classmethod
...
class AuthDocumentAttachmentSerializer:
    @classmethod
...
class AuthAuditTrailSerializer:
    @classmethod
