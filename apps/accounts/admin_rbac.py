"""Django Admin configuration for EduFlow Role-Based Access Control & Permissions (RBAC)."""
...
if 'RBACMaster' in globals():
    @admin.register(RBACMaster)
    class RBACMasterAdmin(admin.ModelAdmin):
...
if 'RBACItem' in globals():
    @admin.register(RBACItem)
    class RBACItemAdmin(admin.ModelAdmin):
...
if 'RBACAllocation' in globals():
    @admin.register(RBACAllocation)
    class RBACAllocationAdmin(admin.ModelAdmin):
...
if 'RBACMetricRecord' in globals():
    @admin.register(RBACMetricRecord)
    class RBACMetricRecordAdmin(admin.ModelAdmin):
        list_display = ['master', 'metric_name', 'target_value', 'actual_value', 'score_percentage', 'is_passing']
        list_filter = ['is_passing']

if 'RBACPolicyRule' in globals():
    @admin.register(RBACPolicyRule)
    class RBACPolicyRuleAdmin(admin.ModelAdmin):
...
if 'RBACSchedulePeriod' in globals():
    @admin.register(RBACSchedulePeriod)
    class RBACSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'RBACFeedbackReview' in globals():
    @admin.register(RBACFeedbackReview)
    class RBACFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'RBACWorkflowTransition' in globals():
    @admin.register(RBACWorkflowTransition)
    class RBACWorkflowTransitionAdmin(admin.ModelAdmin):
        list_display = ['master', 'from_stage', 'to_stage', 'actor_username', 'is_approved', 'transition_timestamp']
        list_filter = ['is_approved']

if 'RBACAccessRule' in globals():
    @admin.register(RBACAccessRule)
    class RBACAccessRuleAdmin(admin.ModelAdmin):
...
if 'RBACConfigurationParameter' in globals():
    @admin.register(RBACConfigurationParameter)
    class RBACConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'RBACDocumentAttachment' in globals():
    @admin.register(RBACDocumentAttachment)
    class RBACDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'RBACAuditTrail' in globals():
    @admin.register(RBACAuditTrail)
    class RBACAuditTrailAdmin(admin.ModelAdmin):
