"""
Serializers for EduFlow Institutional Document Vault & Access Control (DocumentVault).
...
class DocumentVaultMasterSerializer:
    """Serializes DocumentVaultMaster instances to and from JSON/dict structures."""
...
class DocumentVaultItemSerializer:
    @classmethod
...
class DocumentVaultAllocationSerializer:
    @classmethod
...
class DocumentVaultMetricSerializer:
    @classmethod
...
class DocumentVaultPolicyRuleSerializer:
    @classmethod
...
class DocumentVaultSchedulePeriodSerializer:
    @classmethod
...
class DocumentVaultFeedbackReviewSerializer:
    @classmethod
...
class DocumentVaultWorkflowTransitionSerializer:
    @classmethod
...
class DocumentVaultAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class DocumentVaultConfigurationParameterSerializer:
    @classmethod
...
class DocumentVaultDocumentAttachmentSerializer:
    @classmethod
...
class DocumentVaultAuditTrailSerializer:
    @classmethod
