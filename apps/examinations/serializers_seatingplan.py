"""
Serializers for EduFlow Exam Seating Arrangement & Desk Planner (SeatingPlan).
...
class SeatingPlanMasterSerializer:
    """Serializes SeatingPlanMaster instances to and from JSON/dict structures."""
...
class SeatingPlanItemSerializer:
    @classmethod
...
class SeatingPlanAllocationSerializer:
    @classmethod
...
class SeatingPlanMetricSerializer:
    @classmethod
...
class SeatingPlanPolicyRuleSerializer:
    @classmethod
...
class SeatingPlanSchedulePeriodSerializer:
    @classmethod
...
class SeatingPlanFeedbackReviewSerializer:
    @classmethod
...
class SeatingPlanWorkflowTransitionSerializer:
    @classmethod
...
class SeatingPlanAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class SeatingPlanConfigurationParameterSerializer:
    @classmethod
...
class SeatingPlanDocumentAttachmentSerializer:
    @classmethod
...
class SeatingPlanAuditTrailSerializer:
    @classmethod
