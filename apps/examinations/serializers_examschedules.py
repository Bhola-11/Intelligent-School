"""
Serializers for EduFlow Exam Schedules & Timetables (ExamSchedules).
...
class ExamSchedulesMasterSerializer:
    """Serializes ExamSchedulesMaster instances to and from JSON/dict structures."""
...
class ExamSchedulesItemSerializer:
    @classmethod
...
class ExamSchedulesAllocationSerializer:
    @classmethod
...
class ExamSchedulesMetricSerializer:
    @classmethod
...
class ExamSchedulesPolicyRuleSerializer:
    @classmethod
...
class ExamSchedulesSchedulePeriodSerializer:
    @classmethod
...
class ExamSchedulesFeedbackReviewSerializer:
    @classmethod
...
class ExamSchedulesWorkflowTransitionSerializer:
    @classmethod
...
class ExamSchedulesAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class ExamSchedulesConfigurationParameterSerializer:
    @classmethod
...
class ExamSchedulesDocumentAttachmentSerializer:
    @classmethod
...
class ExamSchedulesAuditTrailSerializer:
    @classmethod
