"""
Domain Validators for EduFlow Examination Sessions & Exam Types (ExamSessions).
...
class ExamSessionsValidator:
    """Domain validator implementing enterprise business rules for ExamSessions."""
