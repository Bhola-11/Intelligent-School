"""
Domain Validators for EduFlow Exam Hall Tickets & Roll Number Generation (HallTickets).
...
class HallTicketsValidator:
    """Domain validator implementing enterprise business rules for HallTickets."""
