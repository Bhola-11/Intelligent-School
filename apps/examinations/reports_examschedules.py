"""
Operational Reporting Engine for EduFlow Exam Schedules & Timetables (ExamSchedules).
...
try:
    from .models import ExamSchedulesMaster, ExamSchedulesItem, ExamSchedulesAllocation
except ImportError:
    pass

class ExamSchedulesReportGenerator:
    """Generates analytical reports and summary matrices for ExamSchedules."""
