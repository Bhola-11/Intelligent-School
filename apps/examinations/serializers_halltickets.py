"""
Serializers for EduFlow Exam Hall Tickets & Roll Number Generation (HallTickets).
...
class HallTicketsMasterSerializer:
    """Serializes HallTicketsMaster instances to and from JSON/dict structures."""
...
class HallTicketsItemSerializer:
    @classmethod
...
class HallTicketsAllocationSerializer:
    @classmethod
...
class HallTicketsMetricSerializer:
    @classmethod
...
class HallTicketsPolicyRuleSerializer:
    @classmethod
...
class HallTicketsSchedulePeriodSerializer:
    @classmethod
...
class HallTicketsFeedbackReviewSerializer:
    @classmethod
...
class HallTicketsWorkflowTransitionSerializer:
    @classmethod
...
class HallTicketsAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class HallTicketsConfigurationParameterSerializer:
    @classmethod
...
class HallTicketsDocumentAttachmentSerializer:
    @classmethod
...
class HallTicketsAuditTrailSerializer:
    @classmethod
