"""Django Admin configuration for EduFlow Exam Schedules & Timetables (ExamSchedules)."""
...
if 'ExamSchedulesMaster' in globals():
    @admin.register(ExamSchedulesMaster)
    class ExamSchedulesMasterAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesItem' in globals():
    @admin.register(ExamSchedulesItem)
    class ExamSchedulesItemAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesAllocation' in globals():
    @admin.register(ExamSchedulesAllocation)
    class ExamSchedulesAllocationAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesMetricRecord' in globals():
    @admin.register(ExamSchedulesMetricRecord)
    class ExamSchedulesMetricRecordAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesPolicyRule' in globals():
    @admin.register(ExamSchedulesPolicyRule)
    class ExamSchedulesPolicyRuleAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesSchedulePeriod' in globals():
    @admin.register(ExamSchedulesSchedulePeriod)
    class ExamSchedulesSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesFeedbackReview' in globals():
    @admin.register(ExamSchedulesFeedbackReview)
    class ExamSchedulesFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesWorkflowTransition' in globals():
    @admin.register(ExamSchedulesWorkflowTransition)
    class ExamSchedulesWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesAccessRule' in globals():
    @admin.register(ExamSchedulesAccessRule)
    class ExamSchedulesAccessRuleAdmin(admin.ModelAdmin):
...
if 'ExamSchedulesConfigurationParameter' in globals():
    @admin.register(ExamSchedulesConfigurationParameter)
    class ExamSchedulesConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'ExamSchedulesDocumentAttachment' in globals():
    @admin.register(ExamSchedulesDocumentAttachment)
    class ExamSchedulesDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'ExamSchedulesAuditTrail' in globals():
    @admin.register(ExamSchedulesAuditTrail)
    class ExamSchedulesAuditTrailAdmin(admin.ModelAdmin):
