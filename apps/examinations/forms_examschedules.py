"""
Forms for EduFlow Exam Schedules & Timetables (ExamSchedules).
...
class ExamSchedulesMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamSchedules master records."""
    class Meta:
        try:
            model = ExamSchedulesMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. EXAM-001'}),
...
class ExamSchedulesItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ExamSchedulesItem
...
class ExamSchedulesAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ExamSchedulesAllocation
...
class ExamSchedulesMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ExamSchedulesMetricRecord
...
class ExamSchedulesPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ExamSchedulesPolicyRule
...
class ExamSchedulesSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ExamSchedulesSchedulePeriod
...
class ExamSchedulesFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ExamSchedulesFeedbackReview
...
class ExamSchedulesWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ExamSchedulesWorkflowTransition
...
class ExamSchedulesAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ExamSchedulesAccessRule
...
class ExamSchedulesConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ExamSchedulesConfigurationParameter
...
class ExamSchedulesDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ExamSchedulesDocumentAttachment
...
class ExamSchedulesFilterForm(forms.Form):
...
class ExamSchedulesBulkActionForm(forms.Form):
