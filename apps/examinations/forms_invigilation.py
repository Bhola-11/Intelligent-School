"""
Forms for EduFlow Exam Rooms & Invigilator Assignments (Invigilation).
...
class InvigilationMasterForm(forms.ModelForm):
    """Primary form for creating and updating Invigilation master records."""
    class Meta:
        try:
            model = InvigilationMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. INVI-001'}),
...
class InvigilationItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = InvigilationItem
...
class InvigilationAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = InvigilationAllocation
...
class InvigilationMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = InvigilationMetricRecord
...
class InvigilationPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = InvigilationPolicyRule
...
class InvigilationSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = InvigilationSchedulePeriod
...
class InvigilationFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = InvigilationFeedbackReview
...
class InvigilationWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = InvigilationWorkflowTransition
...
class InvigilationAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = InvigilationAccessRule
...
class InvigilationConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = InvigilationConfigurationParameter
...
class InvigilationDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = InvigilationDocumentAttachment
...
class InvigilationFilterForm(forms.Form):
...
class InvigilationBulkActionForm(forms.Form):
