"""
Forms for EduFlow Examination Sessions & Exam Types (ExamSessions).
...
class ExamSessionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamSessions master records."""
    class Meta:
        try:
            model = ExamSessionsMaster
            fields = [
...
class ExamSessionsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = ExamSessionsItem
...
class ExamSessionsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = ExamSessionsAllocation
...
class ExamSessionsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = ExamSessionsMetricRecord
...
class ExamSessionsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = ExamSessionsPolicyRule
...
class ExamSessionsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = ExamSessionsSchedulePeriod
...
class ExamSessionsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = ExamSessionsFeedbackReview
...
class ExamSessionsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = ExamSessionsWorkflowTransition
...
class ExamSessionsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = ExamSessionsAccessRule
...
class ExamSessionsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = ExamSessionsConfigurationParameter
...
class ExamSessionsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = ExamSessionsDocumentAttachment
...
class ExamSessionsFilterForm(forms.Form):
...
class ExamSessionsBulkActionForm(forms.Form):
