"""
Operational Reporting Engine for EduFlow Examination Sessions & Exam Types (ExamSessions).
...
try:
    from .models import ExamSessionsMaster, ExamSessionsItem, ExamSessionsAllocation
except ImportError:
    pass

class ExamSessionsReportGenerator:
    """Generates analytical reports and summary matrices for ExamSessions."""
