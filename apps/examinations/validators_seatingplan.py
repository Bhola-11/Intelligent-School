"""
Domain Validators for EduFlow Exam Seating Arrangement & Desk Planner (SeatingPlan).
...
class SeatingPlanValidator:
    """Domain validator implementing enterprise business rules for SeatingPlan."""
