"""
Forms for EduFlow Exam Hall Tickets & Roll Number Generation (HallTickets).
...
class HallTicketsMasterForm(forms.ModelForm):
    """Primary form for creating and updating HallTickets master records."""
    class Meta:
        try:
            model = HallTicketsMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. HALL-001'}),
...
class HallTicketsItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = HallTicketsItem
...
class HallTicketsAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = HallTicketsAllocation
...
class HallTicketsMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = HallTicketsMetricRecord
...
class HallTicketsPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = HallTicketsPolicyRule
...
class HallTicketsSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = HallTicketsSchedulePeriod
...
class HallTicketsFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = HallTicketsFeedbackReview
...
class HallTicketsWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = HallTicketsWorkflowTransition
...
class HallTicketsAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = HallTicketsAccessRule
...
class HallTicketsConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = HallTicketsConfigurationParameter
...
class HallTicketsDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = HallTicketsDocumentAttachment
...
class HallTicketsFilterForm(forms.Form):
...
class HallTicketsBulkActionForm(forms.Form):
