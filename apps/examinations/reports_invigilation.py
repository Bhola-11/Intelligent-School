"""
Operational Reporting Engine for EduFlow Exam Rooms & Invigilator Assignments (Invigilation).
...
try:
    from .models import InvigilationMaster, InvigilationItem, InvigilationAllocation
except ImportError:
    pass

class InvigilationReportGenerator:
    """Generates analytical reports and summary matrices for Invigilation."""
