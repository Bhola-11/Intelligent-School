"""
Forms for EduFlow Exam Seating Arrangement & Desk Planner (SeatingPlan).
...
class SeatingPlanMasterForm(forms.ModelForm):
    """Primary form for creating and updating SeatingPlan master records."""
    class Meta:
        try:
            model = SeatingPlanMaster
            fields = [
            ...
            widgets = {
                'code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. SEAT-001'}),
...
class SeatingPlanItemForm(forms.ModelForm):
    """Form for sub-items and component line-items."""
    class Meta:
        try:
            model = SeatingPlanItem
...
class SeatingPlanAllocationForm(forms.ModelForm):
    """Form for resource and faculty allocations."""
    class Meta:
        try:
            model = SeatingPlanAllocation
...
class SeatingPlanMetricRecordForm(forms.ModelForm):
    """Form for KPI metric observations."""
    class Meta:
        try:
            model = SeatingPlanMetricRecord
...
class SeatingPlanPolicyRuleForm(forms.ModelForm):
    """Form for institutional governance rules."""
    class Meta:
        try:
            model = SeatingPlanPolicyRule
...
class SeatingPlanSchedulePeriodForm(forms.ModelForm):
    """Form for timetable and schedule periods."""
    class Meta:
        try:
            model = SeatingPlanSchedulePeriod
...
class SeatingPlanFeedbackReviewForm(forms.ModelForm):
    """Form for qualitative feedback and evaluation."""
    class Meta:
        try:
            model = SeatingPlanFeedbackReview
...
class SeatingPlanWorkflowTransitionForm(forms.ModelForm):
    """Form for submitting workflow approval transitions."""
    class Meta:
        try:
            model = SeatingPlanWorkflowTransition
...
class SeatingPlanAccessRuleForm(forms.ModelForm):
    """Form for object-level permission rules."""
    class Meta:
        try:
            model = SeatingPlanAccessRule
...
class SeatingPlanConfigurationParameterForm(forms.ModelForm):
    """Form for key-value configuration parameters."""
    class Meta:
        try:
            model = SeatingPlanConfigurationParameter
...
class SeatingPlanDocumentAttachmentForm(forms.ModelForm):
    """Form for registering official document attachments."""
    class Meta:
        try:
            model = SeatingPlanDocumentAttachment
...
class SeatingPlanBulkActionForm(forms.Form):
