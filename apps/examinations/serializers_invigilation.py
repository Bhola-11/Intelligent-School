"""
Serializers for EduFlow Exam Rooms & Invigilator Assignments (Invigilation).
...
class InvigilationMasterSerializer:
    """Serializes InvigilationMaster instances to and from JSON/dict structures."""
...
class InvigilationItemSerializer:
    @classmethod
...
class InvigilationAllocationSerializer:
    @classmethod
...
class InvigilationMetricSerializer:
    @classmethod
...
class InvigilationPolicyRuleSerializer:
    @classmethod
...
class InvigilationSchedulePeriodSerializer:
    @classmethod
...
class InvigilationFeedbackReviewSerializer:
    @classmethod
...
class InvigilationWorkflowTransitionSerializer:
    @classmethod
...
class InvigilationAccessRuleSerializer:
    @classmethod
    def serialize(cls, rule):
        return {
            'id': rule.id,
...
class InvigilationConfigurationParameterSerializer:
    @classmethod
...
class InvigilationDocumentAttachmentSerializer:
    @classmethod
...
class InvigilationAuditTrailSerializer:
    @classmethod
