"""
Domain Validators for EduFlow Exam Rooms & Invigilator Assignments (Invigilation).
...
class InvigilationValidator:
    """Domain validator implementing enterprise business rules for Invigilation."""
