"""Django Admin configuration for EduFlow Exam Seating Arrangement & Desk Planner (SeatingPlan)."""
...
if 'SeatingPlanMaster' in globals():
    @admin.register(SeatingPlanMaster)
    class SeatingPlanMasterAdmin(admin.ModelAdmin):
...
if 'SeatingPlanItem' in globals():
    @admin.register(SeatingPlanItem)
    class SeatingPlanItemAdmin(admin.ModelAdmin):
...
if 'SeatingPlanAllocation' in globals():
    @admin.register(SeatingPlanAllocation)
    class SeatingPlanAllocationAdmin(admin.ModelAdmin):
...
if 'SeatingPlanMetricRecord' in globals():
    @admin.register(SeatingPlanMetricRecord)
    class SeatingPlanMetricRecordAdmin(admin.ModelAdmin):
...
if 'SeatingPlanPolicyRule' in globals():
    @admin.register(SeatingPlanPolicyRule)
    class SeatingPlanPolicyRuleAdmin(admin.ModelAdmin):
...
if 'SeatingPlanSchedulePeriod' in globals():
    @admin.register(SeatingPlanSchedulePeriod)
    class SeatingPlanSchedulePeriodAdmin(admin.ModelAdmin):
...
if 'SeatingPlanFeedbackReview' in globals():
    @admin.register(SeatingPlanFeedbackReview)
    class SeatingPlanFeedbackReviewAdmin(admin.ModelAdmin):
...
if 'SeatingPlanWorkflowTransition' in globals():
    @admin.register(SeatingPlanWorkflowTransition)
    class SeatingPlanWorkflowTransitionAdmin(admin.ModelAdmin):
...
if 'SeatingPlanAccessRule' in globals():
    @admin.register(SeatingPlanAccessRule)
    class SeatingPlanAccessRuleAdmin(admin.ModelAdmin):
...
if 'SeatingPlanConfigurationParameter' in globals():
    @admin.register(SeatingPlanConfigurationParameter)
    class SeatingPlanConfigurationParameterAdmin(admin.ModelAdmin):
        list_display = ['master', 'param_key', 'param_value', 'data_type', 'is_editable']

if 'SeatingPlanDocumentAttachment' in globals():
    @admin.register(SeatingPlanDocumentAttachment)
    class SeatingPlanDocumentAttachmentAdmin(admin.ModelAdmin):
        list_display = ['master', 'title', 'mime_type', 'file_size_bytes', 'uploaded_by', 'uploaded_at']

if 'SeatingPlanAuditTrail' in globals():
    @admin.register(SeatingPlanAuditTrail)
    class SeatingPlanAuditTrailAdmin(admin.ModelAdmin):
